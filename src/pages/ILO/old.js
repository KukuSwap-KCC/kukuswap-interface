                            ...
                            <div className="pb-6 md:pb-9 px-3 md:px-8">
                                <div className="justify-between items-center w-full mt-6">
                                    ...
                                    <div className="my-5 text-justify">
                                        Volcano Cash is a non-custodial KCS and KRC-20 privacy solution on the Kucoin
                                        Community Chain based on zkSNARKs. It improves transaction privacy by breaking
                                        the on-chain link between the recipient and destination addresses. It uses a
                                        smart contract that accepts KCS deposits that can be withdrawn by a different
                                        address. Whenever KCS is withdrawn by the new address, there is no way to link
                                        the withdrawal to the deposit, ensuring complete privacy. To make a deposit user
                                        generates a secret and sends its hash (called a commitment) along with the
                                        deposit amount to the Volcano smart contract. The contract accepts the deposit
                                        and adds the commitment to its list of deposits. Later, the user decides to make
                                        a withdrawal. To do that, the user should provide a proof that he or she
                                        possesses a secret to an unspent commitment from the smart contract’s list of
                                        deposits. zkSnark technology allows that to happen without revealing which exact
                                        deposit corresponds to this secret. The smart contract will check the proof, and
                                        transfer deposited funds to the address specified for withdrawal. An external
                                        observer will be unable to determine which deposit this withdrawal came from.
                                        <p>
                                ...
                                <div className="flex justify-between items-center w-full mt-6">
                                    <p className="text-large md:text-h5 font-bold text-high-emphesis">Purchase KUKU</p>
                                    <div className="border-gradient-r-pink-red-light-brown-dark-pink-red border-transparent border-solid border rounded-3xl px-4 md:px-3.5 py-1.5 md:py-0.5 text-high-emphesis text-xs font-medium md:text-caption md:font-normal">
                                        Price: 1 KCS = 100 VCO
                                    </div>
                                </div>
                    ...
                    <div className="flex flex-col w-full px-4 pt-6 pb-5 md:px-8 md:pt-7 md:pb-9">
                        <div className="flex flex-wrap">
                            <div className="flex flex-col flex-grow">
                                ...
                                <p className="mb-3 text-lg text-high-emphesis">12939242 (Approx: Sun 1 Aug 16:28)</p>
                            </div>
                        </div>
                        <div className="flex flex-wrap">
                            <div className="flex flex-col flex-grow">
                                ...
                                <p className="mb-3 text-lg text-high-emphesis">13010690 (Approx: Thu 12 Aug 16:26)</p>
                            </div>
                        </div>
                        <div className="flex flex-wrap">
                            <div className="flex flex-col flex-grow">
                    ...
                    <div className="bg-dark-900 border-yellow shadow-swap-blue-glow w-full max-w-2xl rounded">
                        ...
                        <div className="pb-6 md:pb-9 px-3 md:px-8">
                            <div className="justify-between items-center w-full mt-6">
                                ...
                                <p className="text-large md:text-h5 font-bold text-high-emphesis">Project Overview</p>
                                <div className="my-5 text-justify">
                                    Volcano Cash is a non-custodial KCS and KRC-20 privacy solution on the Kucoin
                                    Community Chain based on zkSNARKs. It improves transaction privacy by breaking the
                                    on-chain link between the recipient and destination addresses. It uses a smart
                                    contract that accepts KCS deposits that can be withdrawn by a different address.
                                    Whenever KCS is withdrawn by the new address, there is no way to link the withdrawal
                    ...
                    <div className="bg-dark-900 border-yellow shadow-swap-blue-glow w-full max-w-2xl rounded mb-5">
                        ...
                        <div className="pb-6 md:pb-9 px-3 md:px-8">
                            <div className="justify-between items-center w-full mt-6">
                                ...
                                <p className="text-large md:text-h5 font-bold text-high-emphesis">Project Overview</p>
                                <div className="my-5 text-justify">
                                    KuKuswap is a next-gen DEX designed to provide access to new tokens and a simplistic
                                    trading experience. The network incorporates the most popular DeFi.
                                </div>
                            </div>
                            <div className="mt-5">
                                {
                ...
                <div className="flex justify-center">
                    <div className="flex flex-col max-w-2xl w-full">
                        ...
                        <div className="bg-dark-900 border-yellow shadow-swap-blue-glow w-full max-w-2xl rounded">
                            <div className="pb-6 md:pb-9 px-3 md:px-8">
                                <div className="justify-between items-center w-full mt-6">
                                    <p className="text-large md:text-h5 font-bold text-high-emphesis">Create presale</p>
                                    <div className="my-5">
                                        <NumericalInputPanel
                                            id="token_amount"
                                            value={''}
