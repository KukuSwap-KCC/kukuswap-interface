...
import { ChainId, CurrencyAmount, JSBI, Token, Trade } from  '@kukuswap/sdk'
...
export default function Swap() {
    ...
    return (
        <>
            <Helmet>
                <title>{i18n._(t`Swap`)} | Kuku</title>
                <meta
                    name="description"
            ...
            <div className="bg-dark-900 shadow-swap-blue-glow border-yellow w-full max-w-2xl rounded">
                ...
                <Wrapper id="swap-page">
                    ...
                    <AutoColumn gap={'md'}>
                        ...
                        <AutoColumn justify="space-between">
                            ...
                            >
                                <button
                                    className="bg-dark-900 p-3px -mt-6 -mb-6 z-10 rounded-sm border-yellow"  style={{ marginLeft: '85%'}}
                                    onClick={() => {
                                        setApprovalSubmitted(false) // reset 2 step UI for approvals
                                        onSwitchTokens()
                                    }}
                                >
                                    <div
                                        className="bg-dark-800 hover:bg-dark-700 rounded-sm p-3"
