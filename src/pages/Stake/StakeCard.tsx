...
import { BAR_ADDRESS, KUKU_ADDRESS, Token, TokenAmount, ChainId } from '@kukuswap/sdk'
...
export default function StakeCard({ kukuBalance, xKUKUBalance }: StakeCardProps) {
    ...
    let [approvalState, approve] = useApproveCallback(
        new TokenAmount(
            new Token(ChainId.KCC, KUKU_ADDRESS[ChainId.KCC], 18, 'KUKU', 'KUKU'),
