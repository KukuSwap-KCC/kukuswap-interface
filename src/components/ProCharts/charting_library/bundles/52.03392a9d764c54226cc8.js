    ...
    [52],
    {
        ...
        '5Ssy': function(e, t, n) {
            ...
            const v = Object(f.b)(
                (((r = class extends u.PureComponent {
                    ...
                    render() {
                        ...
                        let r = null
                        return (
                            this.props.label && (r = u.createElement('span', { className: t }, this.props.label)),
                            u.createElement(
                                'label',
                                { className: e },
                                u.createElement(
            ...
            var j = Object(g.a)(function(e) {
                ...
                return i.a.createElement(
                    y.b,
                    Object(o.a)({}, e, { allowEmpty: !0, value: Object(y.c)(a, n), study: n, ref: c })
                )
            })
            n.d(t, 'a', function() {
                return _
                    ...
                    return (
                        ...
                        (t.prototype.render = function() {
                            ...
                            return u.createElement(
                                p.a,
                                { reference: n },
                                u.createElement(E, { study: a, model: i, property: o.inputs, inputs: r }),
                ...
                return u.createElement(
                    ...
                    r.map(function(e) {
                        return 'symbol' === e.type && e.optional
                            ...
                            : 'bool' === e.type
                            ? u.createElement(d, { key: e.id, label: window.t(e.name, { context: 'input' }), input: e })
                            : u.createElement(c.a, {
        ...
        KJt4: function(e, t, n) {
            ...
            function u(e, t) {
                return o.createElement(a.Consumer, null, function(n) {
                    return n ? o.createElement(e, Object(r.a)({}, Object.assign({ model: n }, t))) : null
                })
            }
        },
        OL6p: function(e, t, n) {
        ...
        PjdP: function(e, t, n) {
            ...
            function A(e) {
                ...
                return a.a.createElement(
                    ...
                    a.a.createElement(B, {
                        name: e.name,
                        endSlot: a.a.createElement(j.b, { icon: !0 }, a.a.createElement(w, null)),
                        reference: u,
                        ...
                        onKeyDown: function(e) {
                            if (e.defaultPrevented) return
                            var t = Object(F.hashFromEvent)(e.nativeEvent)
                            13 === t && (e.preventDefault(), T(O), Object(g.ensureNotNull)(u.current).blur())
                            27 === t && (e.preventDefault(), Object(g.ensureNotNull)(u.current).blur())
                        }
                    }),
                    a.a.createElement(
                        M.a,
                        {
                            ...
                            onClose: function() {},
                            position: function() {
                                var e = Object(g.ensureNotNull)(n.current).getBoundingClientRect(),
                ...
                function R(e) {
                    return l && (null !== A(document.activeElement) || null !== A(e.relatedTarget))
                }
                function A(e) {
                    return (
                        (e instanceof Node &&
            ...
            function Y(e) {
                var t = e.split(':'),
                    n = t[0],
                    r = t[1],
                    o = [Object(I.clamp)(parseInt(n), 0, 23), Object(I.clamp)(parseInt(r), 0, 59)],
                    a = o[1],
            ...
            var J = (function(e) {
                ...
                ue = (function(e) {
                    ...
                    return (
                        ...
                        (t.prototype.render = function() {
                                    ...
                                    .forEach(function(e) {
                                        ...
                                        if (1 === i.length) u[n + '$0'] = t
                                            ...
                                            var s = i.reduce(function(e, o, u) {
                                                ...
                                                try {
                                                    s = Object(g.ensureDefined)(Object(g.ensureDefined)(a)[o.id]).title
                                                } catch (c) {
                                                    s = o.id
                                                }
                                                return Object(r.a)(
                            ...
                            return o.createElement(re.a, Object(r.a)({}, this.props, { input: d }))
                        }),
                ...
                ce = n('H172'),
                le = void 0,
                pe = ['1', '3', '5', '15', '30', '45', '60', '120', '180', '240', '1D', '1W', '1M'],
                de = (function(e) {
                    function t() {
                        var t = (null !== e && e.apply(this, arguments)) || this
                        return (
                ...
                return (
                    ...
                    (t.prototype.render = function() {
                        ...
                        if (
                            ...
                            return o.createElement(re.a, { input: n, disabled: r, onChange: a })
                        switch (n.type) {
                            case 'integer':
                                return o.createElement(u.a, { input: n, disabled: r, onChange: a })
                            case 'float':
                                return o.createElement(i.a, { input: n, disabled: r, onChange: a })
                            case 'bool':
                                return o.createElement(s.a, { input: n, disabled: r, onChange: a })
                            case 'text':
                                return o.createElement(m, { input: n, disabled: r, onChange: a })
                            case 'symbol':
                                return o.createElement(v.a, { input: n, disabled: r, onChange: a })
                            case 'session':
                                return o.createElement(Q, { input: n, disabled: r, onChange: a })
                            case 'source':
                                return o.createElement(ue, { input: n, disabled: r, onChange: a })
                            case 'resolution':
                                return o.createElement(fe, { input: n, disabled: r, onChange: a })
                            case 'time':
                                return null
                            case 'color':
                                return o.createElement(ve, { input: n, disabled: r, onChange: a })
                            default:
                                return null
                        }
                    }),
        ...
        UYhW: function(e, t, n) {
                ...
                p = (function() {
                    ...
                    return (
                        (e.prototype.format = function(e) {
                            ...
                            return Object(c.isRtl)() && l.isChrome ? Object(c.startWithLTR)(t) : t
                        }),
                        (e.prototype.parse = function(e) {
                            var t = Object(c.stripLTRMarks)(e)
                                    .split(this._divider)
                                    .join(''),
                                n = Number(t)
                    ...
                    function t(t) {
                        ...
                        ;(n._onFocus = function(e) {
                            ...
                            (n._onBlur = function(e) {
                                n.setState({ displayValue: C(n.props, n.props.value), focused: !1 }),
                            ...
                            (n._onValueByStepChange = function(e) {
                                ...
                                if (s.res) {
                                    var l = new f.Big(s.value),
                                        ...
                                        d = l.mod(p),
                                        h = l.plus(e * u)
                                    !d.eq(0) && o && (h = h.plus((e > 0 ? 0 : 1) * u).minus(d)), (c = Number(h))
                                }
                                n._checkValueBoundaries(c).value &&
                                    (n.setState({ displayValue: C(n.props, c) }), n.props.onValueChange(c, 'step')),
                                    n.props.errorHandler && n.props.errorHandler(!1)
                            })
                        var r = t.value
                        return (n.state = { value: r, displayValue: C(t, r), focused: !1, errorMsg: m }), n
                    }
                    return (
                        Object(r.c)(t, e),
                        (t.prototype.render = function() {
                        ...
                        (t.getDerivedStateFromProps = function(e, t) {
                            var n = e.alwaysUpdateValueFromProps,
                                r = e.value
                            return (t.focused && !n) || t.value === r ? null : { value: r, displayValue: C(e, r) }
                        }),
                        (t.prototype._checkValueBoundaries = function(e) {
                            var t = this.props,
                                ...
                                a = (function(e, t, n) {
                                    var r = e >= t,
                                        o = e <= n
                                    return { passMin: r, passMax: o, pass: r && o, clamped: Object(h.clamp)(e, t, n) }
                                })(e, r, void 0 === o ? 9e15 : o),
            ...
            function j(e, t) {
                return (
                    void 0 === t && (t = y),
                    t.parse ? t.parse(e) : { res: !1, error: 'Formatter does not support parse' }
                )
            }
            n.d(t, 'a', function() {
                return S
            ...
            var r = n('mrSG'),
                ...
                c = (function(e) {
                    ...
                    return (
                        Object(r.c)(t, e),
                        (t.prototype.render = function() {
                            return o.createElement(a.a, Object(r.a)({}, this.props, { className: s.input }))
                        }),
                        t
                    )
                })(o.PureComponent),
        ...
        fV01: function(e, t, n) {
            ...
            var C = Object(d.a)(function(e) {
                var t = Object(o.useContext)(p.b),
                    ...
                    u = e.input.defval,
                    i = e.value
                return a.a.createElement(O, Object(r.a)({}, e, { value: g(i || u || '', n), study: n }))
            })
        },
        h5Dg: function(e, t, n) {
            'use strict'
                ...
                c = (function(e) {
                    ...
                    return (
                        ...
                        (t.prototype.render = function() {
                            return o.createElement(
                                i.a,
                                Object(r.a)({}, this.props, { mode: 'integer', className: s.input })
                            )
                        }),
                        t
                    )
                    ...
                    function t() {
                        ...
                        return (
                            ...
                            (t._onPopupClose = function() {
                                t._trackEventLabel &&
                                    (Object(p.trackEvent)('GUI', 'Study settings', t._trackEventLabel),
                                    (t._trackEventLabel = null))
                            }),
                            t
                        )
