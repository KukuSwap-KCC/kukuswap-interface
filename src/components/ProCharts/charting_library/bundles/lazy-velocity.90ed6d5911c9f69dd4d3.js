                                    ...
                                    ? (!s || t.isArray(a)
                                          ? (s = t.data(
                                                ...
                                                (i = a) &&
                                                    (l(Object(i))
                                                        ? (function(e, t) {
                                                              for (var r = +t.length, a = 0, i = e.length; a < r; )
                                                                  e[i++] = t[a++]
                        ...
                        if (!(n <= 7)) {
                                    ...
                                    function o(e, r) {
                                        ...
                                        if (n <= 8) a = d.css(e, r)
                                            ...
                                            ;(l =
                                                ...
                                                ('' !==
                                                    (a = 9 === n && 'filter' === r ? l.getPropertyValue(r) : l[r]) &&
                                                    null !== a) ||
                                                    (a = e.style[r]),
                                                u()
                                        }
                                    ...
                                    if ('scroll' === r)
                                        ...
                                        if (
                                            ...
                                            try {
                                                ...
                                                g.debug &&
                                                    console.log('Browser does not support [' + a + '] for [' + s + ']')
                                            }
                                        else {
                                            var c = x(e)
                                ...
                                flushTransformCache: function(e) {
                                    ...
                                    if ((n || (g.State.isAndroid && !g.State.isChrome)) && r && r.isSVG) {
                                        ...
                                        d.each(x(e).transformCache, function(r) {
                                            if (((o = x(e).transformCache[r]), 'transformPerspective' === r))
                                                return (s = o), !0
                            ...
                            var y = function() {
                                ...
                                p.isWrapped(this)
                                    ...
                                    : ((i = !0),
                                      (o = 1),
                                      (s = m ? arguments[0].elements || arguments[0].e : arguments[0]))
                                    ...
                                    switch (l) {
                                        ...
                                        default:
                                            if (!d.isPlainObject(l) || p.isEmptyObject(l)) {
                                                        ...
                                                        d.each(s, function(t, r) {
                                                            parseFloat(e.stagger)
                                                                ...
                                                                e.drag &&
                                                                    ((e.duration =
                                                                        parseFloat(H) ||
                                                                        (/^(callout|transition)/.test(l) ? 1e3 : 400)),
                                                                    (e.duration = Math.max(
                                                                        e.duration *
                                                ...
                                                return (
                                                    v.promise ? v.rejecter(new Error(j)) : t.console && console.log(j),
                                                    a()
                                                )
                                            }
                                            b = 'start'
                                ...
                                function W(e, a) {
                                    ...
                                    function m(n) {
                                                ...
                                                : ((w = g.State.scrollAnchor[g.State['scrollProperty' + A]]),
                                                  (S =
                                                      g.State.scrollAnchor[
                                                          g.State['scrollProperty' + ('Left' === A ? 'Top' : 'Left')]
                                                      ]),
                                                    ...
                                                    if (
                                                        ...
                                                        if (b !== f && p.isString(b) && p.isString(f)) {
                                                            ...
                                                            var V = 0,
                                                                ...
                                                                N = 0
                                                            for (
                                                                b = h.Hooks.fixColors(b), f = h.Hooks.fixColors(f);
                                        ...
                                        c.element &&
                                            ...
                                            z.push(c),
                                            (m = x(e)) &&
                                                ('' === o.queue && ((m.tweensContainer = c), (m.opts = o)),
                                                (m.isAnimating = !0)),
                                            k === P - 1
                                ...
                                for (var a = 0; a < r; a++)
                                    if (g.State.calls[a]) {
                                        ...
                                        void 0 !== l.display &&
                                            ...
                                            l.progress &&
                                                l.progress.call(i[1], i[1], b, Math.max(0, u + l.duration - t), u, f),
                                            1 === b && C(a)
                                    }
                            }
