    ...
    [54],
    {
            ...
            var r = n('q1tI'),
                a = function(e, t) {
                    var n = void 0 === t ? {} : t,
                        ...
                        c = void 0 === s ? null : s
                    try {
                        return new window.CustomEvent(e, { bubbles: a, cancelable: i, detail: c })
                    } catch (l) {
        ...
        AVTG: function(e, t, n) {
            ...
            var r = n('q1tI'),
                ...
                s = n('Iivm')
            function c(e) {
                var t = e.hideIcon ? null : r.createElement(s.a, { className: o.close, icon: i, onClick: e.onClose })
                return r.createElement(
                    'div',
                    { className: a(o.header, e.className), 'data-dragg-area': !0, ref: e.reference },
                    e.children,
                    t
                )
            }
            ...
            var u = n('XYXm')
            function l(e) {
                return r.createElement('div', { className: a(u.body, e.className), ref: e.reference }, e.children)
            }
            var d = n('8Rai'),
                p = n('cJj4')
            function m(e) {
                ...
                var o = Object(d.a)({ mouseDown: !0, touchStart: !0, handler: e.onClickOutside })
                if (!n) return null
                var i = a(p.message, e.className, (((t = {})[p.error] = e.isError), t))
                return r.createElement('div', { className: i, key: '0' }, r.createElement('span', { ref: o }, n))
            }
            n.d(t, 'b', function() {
                return c
            }),
        ...
        Iivm: function(e, t, n) {
            ...
            const o = a.forwardRef((e, t) => {
                const { icon: n = '' } = e,
                    o = Object(r.e)(e, ['icon'])
                return a.createElement('span', Object.assign({}, o, { ref: t, dangerouslySetInnerHTML: { __html: n } }))
            })
            n.d(t, 'a', function() {
                return o
            })
        ...
        oj21: function(e, t, n) {
            ...
            function c(e) {
                ...
                return a.createElement(
                    'button',
                    Object(r.a)({ name: L, className: M, tabIndex: q, onClick: I ? void 0 : b, ref: y }, R),
                    a.createElement('span', { className: i.hiddenText }, u),
                    I
                        ? a.createElement('span', { className: i.loader }, a.createElement(s.a, { color: Q }))
