    ...
    ['symbolsearch'],
    {
                ...
                var k = {},
                    ...
                    R = (function() {
                        ...
                        function L(t, e) {
                            ...
                            var n,
                                o = ((n = TVSettings.getValue('symboledit.exchangefilter')), /_MINI$/.test(n) ? '' : n)
                            if ('bovespa' !== TradingView.widgetCustomer) {
                                if (0 === i.length) return !1
                                var s = $('<div id="exchange-filter" class="exchange-filter">').appendTo(e)
                        ...
                        ;(m.registerAutoFocus = function(t) {
                            ...
                            (m.prototype._moveSelection = function(t, e) {
                                if (this.$list) {
                                    ...
                                    if (
                                        r !== (i = 1 === t ? (s.get(0) === o.get(-1) ? 0 : r + t) : Math.max(-1, r + t))
                                    ) {
                                        var a = o.get(i)
                                        if (a) {
                            ...
                            (m.prototype._eventListener = function(t, i) {
                                ...
                                e.enabled('uppercase_instrument_names') && (o = o.toUpperCase())
                                var s = !1,
                                    r = !1
                                this._state.value !== o &&
                            ...
                            (m.prototype._fixIntervalCase = function() {
                                if (this._selectionInsideInterval()) {
                                    ...
                                    ;/[a-z]/.test(t.detached) &&
                                        (this._inputElement.value = t.rest + t.detached.toUpperCase())
                                }
                            }),
                            ...
                            (m.prototype._doGetSuggestList = function() {
                                ...
                                this._showLoading()
                                var a = this
                                ChartApiInstance.searchSymbols(e, i, n, r, !1, !1, t, o, s, function(t) {
                            ...
                            (m.prototype._groupContracts = function(t) {
                                for (
                                    var e = ChartApiInstance.symbolsGrouping(), i = {}, n = [], o = 0;
                                    o < t.length;
                                    ++o
                                ) {
                                    var s = t[o]
                            ...
                            (m.prototype._renderSuggestList = function(t) {
                                if (this.$list) {
                                    ...
                                    var o = c(n.contextTicker).trim(),
                                        s = new RegExp(o.replace(' ', '|'), 'i' + (o.length > 1 ? 'g' : ''))
                                    if (
                            ...
                            (m.prototype._highlightItem = function(t, e, i) {
                                ...
                                s && ($(s).addClass('symbol-edit-popup-active'), this._scrollHighlightIntoView()),
                            ...
                            (m.prototype._replaceCurrentSymbol = function(t) {
                                ...
                                if (e.highlightedItem) {
                                    ...
                                    if (this._isSpreadInInput() || (this._inputParserMixin && !0 !== t)) {
                                        ...
                                        if (!s.ok) return
                                        ;(n = s.newValue), (o = s.newCaretPos), (e.keepListFor = s.keepListFor)
                                    } else
                            ...
                            (m.prototype.splitAndAcceptUserInput = function() {
                                for (var t = this._getInputValue().split(','), e = 0; e < t.length; e++)
                            ...
                            (m.createSuggestListRow = function(t, e, i, n) {
                                ...
                                var o = document.createElement('tr'),
                                    s = 'symbol-edit-popup'
                                n.addClass && (s += ' ' + n.addClass), o.setAttribute('class', s)
                                ...
                                var l,
                                    ...
                                    p = n.nameContent || c
                                ;((l = null),
                                Boolean(l && l.metainfo().configFlags.supportDisplayBrokerNameInSymbolSearch)) &&
                                    t.broker_symbol &&
                                ...
                                u.innerHTML = e.test(t.symbol) ? h : h.replace(e, '<strong>$&</strong>')
                                ...
                                v.setAttribute('class', 'symbol-edit-popup-td flag apply-overflow-tooltip'),
                        ...
                        return (
                            (m.showDialog = function(t) {
                                ...
                                if (!d.get('Symbol Search')) {
                                    ...
                                    var i,
                                        n,
                                        o,
                                        s = e.find('._tv-dialog-content').addClass('symbol-search-dialog'),
                                        r = s.find('.results'),
                                    ...
                                    if (
                                        ...
                                        t.ignoreInterval ||
                                            ((n = m.getInputValueGetter(a)), (o = m.getInputValueSetter(a))),
                                            (i = (void 0).addSpreadActions(s.find('.spread-actions'), a, n, o))
                                    var l = new m({
                                            input: a,
                            ...
                            (m.bindToInput = function(t, i) {
                                ...
                                T &&
                                    ...
                                    y() &&
                                    (i.ignoreInterval ||
                                        ((I = m.getInputValueGetter(t.get(0))), (x = m.getInputValueSetter(t.get(0)))),
                                            ...
                                            if (!_) {
                                                var t = a.ensureWindow(s, { position: 'relative' }),
                                                    n = (function(t, e, i) {
                                                        ...
                                                        var s = $('<div class="table-wrapper">').appendTo(n),
                                                            r = $(t._inputElement),
                                                            a = r.offset()
                                                        if ('relative' === i)
                                                            var l = n.offset(),
                                                            ...
                                                            (c = Math.max(
                                                                0,
                                                                Math.min(a.left, $(window).width() - n.outerWidth())
                                                            )),
                                ...
                                if (
                                    ...
                                    t.on('blur', function(e) {
                                        ...
                                        if (
                                            ...
                                            TradingView.isMobile.iOS() && C && null === e.relatedTarget)
                                        ) {
                                            var r = function(t) {
                            ...
                            (D.prototype.append = function(t) {
                                ...
                                if (D.isRoot(t)) {
                                    ...
                                    ;(e = m.createSuggestListRow(t, this._tickerRegExp, this._translationCache, {
                                        nameContent:
                                            '<div>' + n.replace(this._tickerRegExp, '<strong>$&</strong>') + '</div>',
                                        typeContent: T(this._translationCache, t.type) + (t.exchange && ' - ' + x(t)),
                                        addClass: 'group-title'
                                    })),
                                        this._roots[o] || this.addRoot(o, e)
                                    for (var s, r, a = 0; a < t.contracts.length; ++a)
                                        (s = t.contracts[a]),
                                            (r = m.createSuggestListRow(s, this._tickerRegExp, this._translationCache)),
        ...
        w3Pp: function(t, e, i) {
            ...
            function r(t, e) {
                ...
                var a = e ? window.t('{market_type} cfd', o).format({ market_type: t }) : s[t] || t
                return n.set(i, a), a
            }
        }
    }
