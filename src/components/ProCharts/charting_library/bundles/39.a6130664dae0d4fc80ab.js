        ...
        DxCR: function(t, e, i) {
            ...
            ;(function(t) {
                ...
                function E(e, i, r, o, n, s) {
                    isNumber(i.value()) ||
                        (f.logWarn('Property cannot be binded to control, bad value (expect number): ' + i.value()),
                        (i = new t())),
                ...
                ;(_.prototype.model = function() {
                    ...
                    (_.prototype.createPrecisionEditor = function() {
                        for (
                            var t = "<select><option value='default'>" + $.t('Default') + '</option>', e = 0;
                            e <= 8;
                            e++
                        )
                    ...
                    (T.prototype.value = function() {
                        ...
                        return (
                            i <= e && (e = i - 1),
                            1e3 *
                                o(this._mainSeries.bars().valueAt(o(this._mainSeries.bars().lastIndex()) - e))[
                    ...
                    (T.prototype.setValue = function(t) {
                        if (this._disabled || null == t) this._control.attr('disabled', !0)
                            ...
                            var e = this._mainSeries
                                .data()
                                .plotValueToTimePointIndex(t / 1e3, TradingView.TIME_PLOT, u.FromRight)
                            if (null !== e) {
                            ...
                            if (r) r.closest('td').css(e)
                                ...
                                o.parent()
                                    ...
                                    .filter(function() {
                                        var t = $(this)
                                        return (
                                            !t.find('label').length && t.find(':checkbox').attr('id') !== o.attr('id')
                                        )
                                    })
                                    .each(function() {
                                        var r = $(this)
                                ...
                                _mouseCapture: function(e) {
                                    ...
                                    return (
                                        ...
                                        this.handles.each(function(e) {
                                            ...
                                            ;(o > i ||
                                                (o === i && (e === c._lastChangedValue || c.values(e) === u.min))) &&
                                                ((o = i), (n = t(this)), (s = e))
                                        }),
                                        !1 !== this._start(e, s) &&
                                ...
                                _setOption: function(e, i) {
                                    ...
                                    switch (
                                        ...
                                        case 'value':
                                            ...
                                            break
                                        case 'values':
                                            for (this._animateOff = !0, this._refreshValue(), r = o - 1; r >= 0; r--)
                                                this._change(null, r)
                                            this._animateOff = !1
                                            break
                                        case 'step':
                                ...
                                _refreshValue: function() {
                                    ...
                                    this._hasMultipleValues()
                                        ? this.handles.each(function(r) {
                                              ;(i =
                                                  ((l.values(r) - l._valueMin()) / (l._valueMax() - l._valueMin())) *
                                                  100),
                                        ...
                                        : ((r = this.value()),
                                          ...
                                          'max' === s &&
                                              ...
                                              this.range
                                                  .stop(1, 1)
                                                  [c ? 'animate' : 'css']({ height: 100 - i + '%' }, a.animate))
                                },
                                _handleEvents: {
                                    keydown: function(e) {
                                        var i,
