    ...
    ['study-template-dialog'],
    {
            ...
            var o = n('q1tI'),
                r = function(e, t) {
                    var n = void 0 === t ? {} : t,
                        ...
                        u = void 0 === a ? null : a
                    try {
                        return new window.CustomEvent(e, { bubbles: r, cancelable: i, detail: u })
                    } catch (l) {
                    ...
                    return (
                        ...
                        (t.prototype.render = function() {
                            ...
                            return (
                                ...
                                s.createPortal(r.createElement(l.Provider, { value: this }, this.props.children), e)
                            )
                        }),
        ...
        IDfV: function(e, t, n) {
                    ...
                    function t(t) {
                        ...
                        if (
                            ...
                            (n._handleOutsideClick = function() {
                                ...
                                t ? r && s !== o && r(s) : n.setState(n._valueToQuery(o)), n._close()
                            }),
                                    ...
                                    switch (e.which) {
                                        ...
                                        case o.UpArrow:
                                            ...
                                            if (void 0 === c) {
                                                ...
                                                m = 0
                                            } else m = d.indexOf(c) + (e.which === o.UpArrow ? -1 : 1)
                        ...
                        return (n.state = Object(r.a)({ isOpened: !1, active: t.value }, n._valueToQuery(t.value))), n
                    }
                    return (
                        Object(r.c)(t, e),
                        (t.prototype.componentWillReceiveProps = function(e) {
                            ...
                            if (n !== this.props.value || !this.state.isOpened) {
                                var o = t ? n : '' === n ? '' : this._source()[n] || this.state.queryValue
                        ...
                        (t.prototype.render = function() {
                            var e = this
                            return a.createElement(f.a, { handler: this._handleOutsideClick, click: !0 }, function(t) {
                                var n
                                return a.createElement(
                                    ...
                                    a.createElement(m.b, {
                                        name: e.props.name,
                                        endSlot: Object.keys(e._suggestions(e.state.queryValue)).length
                                            ? a.createElement(
                                                  d.b,
                                                  null,
                                                  a.createElement(
                                                      'span',
                                                      { className: v.caret, onClick: e._handleCaretClick },
                                                      a.createElement(h.a, {
                                                          className: v.icon,
                        ...
                        (t.prototype._renderSuggestions = function() {
                            var e = this,
                                ...
                                n = Object.keys(t).map(function(n) {
                                    var o,
                                        r = l(v.suggestion, (((o = {})[v.selected] = e.state.active === n), o))
                                    return a.createElement(
                                        'li',
                                        { id: n, key: n, className: r, onClick: e._handleItemClick },
                                        t[n]
                                    )
                                }),
                                o = a.createElement('li', { className: v.noResults }, window.t('No results found'))
                    ...
                    return (
                        ...
                        (t.prototype.render = function() {
                            ...
                            return a.createElement(y.a, {
                                ...
                                submitButtonText: a.createElement(C, { isLoading: this.state.isLoading }),
                ...
                return (
                    ...
                    u.a.createElement(
                        ...
                        u.a.createElement(
                            ...
                            u.a.createElement('div', { className: l(T.indicators, L && T.withSuggestions) }, r)
                        )
                    )
                )
            }
                    ...
                    function e(e) {
                        ...
                        ;(this._container = document.createElement('div')),
                            ...
                            (this.unmount = function() {
                                D.unsubscribe(A.CLOSE_POPUPS_AND_DIALOGS_COMMAND, t.unmount, null),
                            ...
                            D.subscribe(A.CLOSE_POPUPS_AND_DIALOGS_COMMAND, this.unmount, null)
                    }
                    return (
            ...
            var P = Object(i.t)('Save Indicator Template'),
                ...
                G = Object(i.t)("Study Template '{templateName}' already exists. Do you really want to replace it?")
            function H(e, t, n) {
                q.backend.saveStudyTemplate(e).then(function() {
                    q.backend.invalidateStudyTemplatesList(), q.backend.getStudyTemplatesList().then(t)
                })
            }
            var Q = (function() {
                function e(e) {
                ...
                return (
                    ...
                    (e.prototype._getActualTemplateList = function() {
                        return q.backend.invalidateStudyTemplatesList(), q.backend.getStudyTemplatesList()
                    }),
                    (e.prototype._showTemplateSaveRenameDialog = function(e, t, n) {
                        ...
                        ;(this._dialog = new V({
                            ...
                            saveIntervalHintText: F.format({ interval: Object(U.translatedIntervalString)(n) }),
        ...
        Iivm: function(e, t, n) {
            ...
            const s = r.forwardRef((e, t) => {
                const { icon: n = '' } = e,
                    s = Object(o.e)(e, ['icon'])
                return r.createElement('span', Object.assign({}, s, { ref: t, dangerouslySetInnerHTML: { __html: n } }))
            })
            n.d(t, 'a', function() {
                return s
            })
        ...
        'ML8+': function(e, t, n) {
            ...
            function u(e) {
                var t,
                    n = e.dropped,
                    u = e.className
                return o.createElement(s.a, { className: r(u, i.icon, ((t = {}), (t[i.dropped] = n), t)), icon: a })
            }
        },
        O7m7: function(e, t, n) {},
        'P4l+': function(e, t, n) {},
        ...
        fV0y: function(e, t, n) {
            ...
            function c(e) {
                ...
                return o.createElement(
                    ...
                    o.createElement('span', { className: t }, o.createElement(i.a, { icon: a, className: u.icon }))
                )
            }
            var l = n('qibD')
            n('E9Pn')
            class p extends o.PureComponent {
                render() {
                    const e = r(this.props.className, l.checkbox, {
                        ...
                        t = r(this.props.tooltipClassName, l.label, { [l.disabled]: this.props.disabled })
                    let n = null
                    return (
                        this.props.label &&
                            (n = o.createElement('span', { className: t, title: this.props.title }, this.props.label)),
                        o.createElement('label', { className: e }, o.createElement(c, Object.assign({}, this.props)), n)
                    )
                }
            }
