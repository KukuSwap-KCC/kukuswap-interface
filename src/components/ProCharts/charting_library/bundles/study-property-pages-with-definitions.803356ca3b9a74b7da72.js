    ...
    ['study-property-pages-with-definitions'],
    {
        WUYT: function(t, e, i) {
            ...
            var d = i('zqjM'),
                ...
                _ = window.t('Style'),
                S = window.t('Inputs'),
                v = ['1', '3', '5', '15', '30', '45', '60', '120', '180', '240', '1D', '1W', '1M'].map(function(t) {
                    return { value: t, title: Object(f.getTranslatedResolutionModel)(t).hint }
                }),
                m = (function() {
                    function t(t, e) {
                        var i = this
                        ;(this._inputSourceItems = null),
                            ...
                            (this._source = e),
                            (this._undoModel = t)
                        for (var o = 0, n = this._sortInputs(this._source.metaInfo().inputs); o < n.length; o++) {
                            var s = n[o]
                    ...
                    return (
                        ...
                        (t.prototype._inputsPropertyDefinitions = function() {
                            ...
                            return (
                                null !== this._sourceInput &&
                                    (this._inputSourceItems = new c.a(this._getInputSourceItems())),
                                (function(t, e, i, o, s) {
                                    for (var u = [], l = 0, p = e; l < p.length; l++) {
                                        ...
                                        if (a(d, o)) {
                                            ...
                                            if ('resolution' === d.type)
                                                ...
                                                for (var S = [], v = 0, m = d.options; v < m.length; v++) {
                                                    var g = m[v],
                                                ...
                                                f = Object(r.j)(
                                                    { option: Object(r.b)(t, i[d.id], 'Change ' + h) },
                                                    { id: 'StudyInput' + h, title: b, options: new c.a(S) }
                                                )
                        ...
                        (t.prototype._getInputSourceItems = function() {
                            ...
                            if (
                                ...
                                var a = new Set(Object(o.f)([this._source], this._source.getAllChildren()))
                                this._undoModel
                                    .model()
                                    .allStudies()
                                    .filter(function(t) {
                                        ...
                                        if (1 === l.length) t.push({ value: s, title: i })
                                            ...
                                            for (
                                                var c = l.reduce(function(t, e, r) {
                                                        var l, c
                                                        if (!b.a.canPlotBeSourceOfChildStudy(e.type)) return t
                                                        try {
                            ...
                            o._source
                                ...
                                .style.subscribe(o, function(t) {
                                    null !== o._stylesPropertyPage &&
                                        ...
                                        o._stylesPropertyPage.definitions.setValue(o._stylePropertyDefinitions()))
                                }),
                            o
                        )
                    }
                    return (
                        ...
                        (e.prototype._stylePropertyDefinitions = function() {
                            var t = this._source.properties().childs(),
                                e = Object(r.j)(
                                    { option: Object(r.b)(this._undoModel, t.style, 'Change study overlay style') },
                                ...
                                n = Object(r.j)(
                                    { option: Object(r.b)(this._undoModel, t.minTick, 'Change study overlay style') },
                                    { id: 'StudyOverlayMinTick', title: w, options: new c.a(Object(d.d)()) }
                                ),
                        ...
                        (e.prototype._getSeriesStylesDefinitions = function() {
                            ...
                            return Object(g.a)(
                                ...
                                t,
                                t.style.value(),
                                { seriesPriceSources: d.b, lineStyleTypes: d.c, isJapaneseChartsAvailable: !1 },
                                'mainSeries'
                            )
                        }),
                        e
