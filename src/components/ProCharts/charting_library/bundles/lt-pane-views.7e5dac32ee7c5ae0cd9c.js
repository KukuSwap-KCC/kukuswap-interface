    ...
    ['lt-pane-views'],
    {
        ...
        '2hKl': function(e, t, i) {
            ...
            function n(e, t, i, n, a) {
                for (
                    var o, s = i.subtract(e).length() + i.subtract(t).length(), l = Math.max(3 / s, 0.02), h = 0;
                    ;
                    h += l
                ) {
                    h > 1 && (h = 1)
                ...
                w = (function() {
                    function e(e, t, i) {
                        ;(this._fontSize = 0),
                            ...
                            (this._lineSpacing =
                                Object(d.isNumber)(this._data.lineSpacing) && this._data.lineSpacing
                    ...
                    return (
                        ...
                        (e.prototype.hitTest = function(e) {
                            return 0 === this._data.points.length
                                ? null
                                : (this._preRender(),
                                  this._boundingBox && Object(n.pointInBox)(e, this._boundingBox)
                                      ? this._hittest
                                      : null)
                        }),
                        (e.prototype._preRender = function() {
                            if (!this._preRendered) {
                                ...
                                if (((i += v.left), (a += v.top), !o.isIE && this._data.icons)) {
                                    var w =
                                        void 0 !== this._data.textPadding ? this._data.textPadding : Math.round(s / 2)
                                    ;(i += g + w), (y.w += g + w)
                                }
                        ...
                        (t.prototype._updateBaseData = function() {
                            if (this._source.points().length >= 3) {
                                var e = this._source.points(),
                                    ...
                                    r = e[2]
                                this._abRetracement =
                                    Math.round(1e3 * Math.abs((r.price - i.price) / (i.price - t.price))) / 1e3
                            }
                            if (this._source.points().length >= 4) {
                                var n = this._source.points(),
                                    a = ((i = n[1]), (r = n[2]), n[3])
                                this._bcRetracement =
                                    Math.round(1e3 * Math.abs((a.price - r.price) / (r.price - i.price))) / 1e3
                            }
                            if (this._source.points().length >= 5) {
                                var o = this._source.points(),
                                    s = ((t = o[0]), (i = o[1]), (r = o[2]), (a = o[3]), o[4])
                                ;(this._cdRetracement =
                                    Math.round(1e3 * Math.abs((s.price - a.price) / (a.price - r.price))) / 1e3),
                                    (this._xdRetracement =
                                        Math.round(1e3 * Math.abs((s.price - i.price) / (i.price - t.price))) / 1e3)
                            }
                        }),
                        t
                    )
                ...
                return (
                    ...
                    (t.prototype._updateImpl = function() {
                        if ((e.prototype._updateImpl.call(this), (this._renderer = null), !(this._points.length < 1))) {
                            ...
                            t.append(this.createLineAnchor({ points: [m, x, b, R], pointsCursorType: P })),
                                (this._renderer = t)
                        }
                    }),
                    t
        ...
        '8MBc': function(e, t, i) {
            ...
            inherit(h, l),
                ...
                (d.prototype._updateImpl = function() {
                    if (
                        (r.prototype._updateImpl.call(this), (this._renderer = null), !(this._floatPoints.length < 2))
                    ) {
                        var e,
                            t = new o()
                    ...
                    if (
                        ...
                        if (h && l) {
                            ;(this._targetLine4 = new c().format(h)),
                                d ||
                                    (this._targetLine4 =
                                        this._targetLine4 + '  ' + new u(v ? '%h:%m:%s' : '%h:%m').format(h))
                        ...
                        y &&
                            ...
                            d ||
                                (this._sourceLine2 =
                                    this._sourceLine2 + ' ' + new u(v ? '%h:%m:%s' : '%h:%m').format(y))),
                ...
                (_.prototype._updateImpl = function() {
                    if (
                        ...
                        var o = t.points[1],
                            l = [].concat(t.points)
                        if (
                            (l.splice(l.length - 1, 1), r.append(this.createLineAnchor({ points: l })), t.wordWrapWidth)
                        ) {
                    ...
                    return (
                        ...
                        (t.prototype._drawImpl = function(e, t) {
                            ...
                            if (null !== this._data && 0 !== this._points.length) {
                                ...
                                if (p > 1) {
                                    if (
                                        ('butt' !== n && (e.lineCap = 'butt'), this._data.leftend === h.LineEnd.Arrow)
                                    ) {
            ...
            var r = i('mrSG'),
                ...
                c = (function(e) {
                    ...
                    return (
                        ...
                        (t.prototype._updateImpl = function() {
                            if (
                                (e.prototype._updateImpl.call(this), (this._renderer = null), 0 !== this._points.length)
                            ) {
                                var t = this._source.properties().childs(),
                                    i = {
                                        x: this._points[0].x,
                                ...
                                if (1 === this._points.length) {
                                    ...
                                    ;(f.data = 0),
                                        (f.square = !0),
                                        r.append(this.createLineAnchor({ points: [f], pointsCursorType: d }))
                                }
                                this._renderer = r
                            }
                        }),
                ...
                g = (function() {
                    ...
                    return (
                        ...
                        (e.prototype.draw = function(e, t) {
                            ...
                            null !== this._data &&
                                ((null !== this._source &&
                                    Object(p.areEqualPaneRenderParams)(this._source.renderParams(), t)) ||
                        ...
                        (e.prototype._drawTooltipOn = function(e, t) {
                            ...
                            e.moveTo(m, x),
                                ...
                                g ||
                                    'bottom' !== y ||
                                    (e.lineTo(w + b, x + _), e.lineTo(w, x + _ + b), e.lineTo(w - b, x + _)),
                                e.lineTo(m, x + _),
                                e.closePath(),
                                e.fill(),
                                e.stroke(),
                            ...
                            Object(u.drawScaled)(e, t.pixelRatio, function() {
                                for (var t = 0; t < a.length; t++)
                                    e.fillText(a[t].replace(/^\s+/, ''), T, S), (S += i.fontSize + s)
                            }),
                                e.restore()
                        }),
                        e
                                    ...
                                    if (2 === this._source.points().length) {
                                        ...
                                        u.append(
                                            this.createLineAnchor({
                                                points: [
                                                    new r(this._points[0].x, this._source.priceScale().height() / 2)
                                                ],
                    ...
                    return (
                            ...
                            if (null !== this._data) {
                                ...
                                for (var l = 0, h = this._items; l < h.length; l++) {
                                    ...
                                    e.moveTo(c, Math.round(m(d) * a)),
                                        ...
                                        0 !== d.poleTailHeight &&
                                            (e.moveTo(c, Math.round(b(d) * a)), e.lineTo(c, Math.round(R(d) * a)))
                                }
                                e.stroke()
                                for (var u = 0, p = this._items; u < p.length; u++) {
                                    ...
                                    ;(e.strokeStyle = d.circleBorderColor),
                                        ...
                                        d.circleRadius > 0 &&
                                            T(e, d, n, this._data.shadowColor, this._data.outsideBorderColor, a),
                        ...
                        (e.prototype._doesPointBelongToItem = function(e, t) {
                            var i = Object(c.lastEventIsTouch)() ? 20 : 3,
                                r = e.x,
                                a =
                                    Object(h.distanceToSegment)(new n.Point(r, m(e)), new n.Point(r, x(e)), t)
                                        .distance < i,
                                o =
                                    !a &&
                                    e.circleRadius > 0 &&
                                                ...
                                                var m = f.visualDirection !== f.positionPointDirection,
                                                    ...
                                                    T = {
                                                        circleBackgroundColor:
                                                            p.backgroundPlateColor(o) || h.circleBackgroundColor,
                ...
                v = (function(e) {
                    ...
                    return (
                        ...
                        (t.prototype._drawMovePoints = function(e, t, i) {
                            ...
                            for (
                                var r = t + 4, n = r + 2, a = Math.floor((this._height() - 10) / 2) + 1, o = 0;
                                o < a;
                                ++o
                            ) {
                                var s = i + 5 + 2 * o
                ...
                u = (function(e) {
                    ...
                    return (
                        ...
                        (t.prototype._drawImpl = function(e, t) {
                            if (!(null === this._data || this._data.points.length < 2)) {
                                ...
                                var i = this._data.points,
                                    ...
                                    n = i[1]
                                if (
                                    (this._data.skipLines || this._extendAndDrawLineSegment(e, r, n, t),
                        ...
                        (t.prototype._extendAndHitTestLineSegment = function(e, t, i, r) {
                            var n = this._extendAndClipLineSegment(t, i, r)
                            if (null !== n && Object(o.distanceToSegment)(n[0], n[1], e).distance <= 3)
        ...
        Ni7V: function(e, t, i) {
            ...
            inherit(v, f),
                ...
                (g.prototype._updateImpl = function() {
                    if (
                        (s.prototype._updateImpl.call(this), (this._renderer = null), this._source.points().length > 0)
                    ) {
                    ...
                    (t.prototype.renderer = function(e, t) {
                        ...
                        return (
                            this._textRendererData.points &&
                                ...
                                n.showLabel.value() &&
                                (this._textRenderer.setData(Object(r.a)({}, this._textRendererData)),
                        ...
                        (t.prototype._updateImpl = function() {
                            ...
                            if (!(this._points.length < 2)) {
                                ...
                                if ((this._polyLineRenderer.setData(y), f.append(this._polyLineRenderer), !isNaN(t))) {
                                    ;(m = new l.TrendLineRenderer()).setData(g(this._points[1], this._points[3])),
                                        f.append(m)
                                    var w = v(
                                ...
                                if (!isNaN(i)) {
                                    var m
                                    ;(m = new l.TrendLineRenderer()).setData(g(this._points[3], this._points[5])),
                                        f.append(m)
                                    w = v(
                    ...
                    if (
                        ...
                        for (var _ = 1; _ <= 11; _++) {
                            ...
                            if (f.visible.value()) {
                                ...
                                u.showCoeffs.value() && ((w.text = v), (w.y = this._source.priceScale().height())),
                                    this._levels.push(w)
                            }
                        }
                    }
                        ...
                        if (b)
                            for (_ = 1; _ < this._levels.length; _++) {
                                var P = this._levels[_ - 1],
                                    L =
                                        ((e = new r(P.x, 0)),
                                        (t = new r(this._levels[_].x, this._source.priceScale().height())),
                                        {})
                                ;(L.points = [e, t]),
                ...
                (g.prototype._updateImpl = function() {
                    if (
                        ...
                        M &&
                            ...
                            ((this._pipFormatter = new u(M.pricescale, M.minmov, M.type, M.minmove2)),
                        ...
                        var I,
                            ...
                            k = {}
                        if (w > y)
                            ((I = a.clone()).y -= 2 * t.fontsize.value()), (I.x = 0.5 * (i.x + a.x)), (k.points = [I])
                        else
                            ((I = a.clone()).x = 0.5 * (i.x + a.x)), (I.y += 0.7 * t.fontsize.value()), (k.points = [I])
                        var B = { x: 0, y: 10 }
                        ;(k.text = D),
                ...
                (_.prototype._updateImpl = function() {
                    if (
                        ...
                        P &&
                            ...
                            ((this._pipFormatter = new c(P.pricescale, P.minmov, P.type, P.minmove2)),
                        ...
                        var L,
                            ...
                            M = {}
                        if (R > b)
                            ((L = l.clone()).y -= 2 * t.fontsize.value()), (L.x = 0.5 * (s.x + l.x)), (M.points = [L])
                        else
                            ((L = l.clone()).x = 0.5 * (s.x + l.x)), (L.y += 0.7 * t.fontsize.value()), (M.points = [L])
                        var I = { x: 0, y: 10 }
                        ;(M.text = C),
                    ...
                    if (((this._label = null), !(this._source.points().length < 2))) {
                        ...
                        if (this._source.properties().showPriceRange.value() && this._source.priceScale()) {
                            ...
                            R &&
                                ...
                                ((this._pipFormatter = new c(R.pricescale, R.minmov, R.type, R.minmove2)),
                    ...
                    return (
                        (e.prototype.draw = function(e, t) {
                            if (this._data.visible) {
                                ...
                                i.length &&
                                    ((e.strokeStyle = this._data.color), this._drawPoints(e, t.pixelRatio, i, r, v, f)),
                                    n.length &&
                                        ((e.strokeStyle = this._data.color),
                        ...
                        (e.prototype._drawPoints = function(e, t, i, r, n, a) {
                            ...
                            for (var _ = (h % 2) / 2, f = 0; f < i.length; ++f) {
                                ...
                                if (
                                    ((e.fillStyle = r[f]),
                                    !(Object(d.isInteger)(v.data) && this._data.linePointBeingEdited === v.data))
                                )
                                    if (
                                        (n(
                                            e,
                                            new p(Math.round(v.x * t) + _, Math.round(v.y * t) + _, v.data, v.square),
                                            c / 2,
                                            l
                                        ),
                    ...
                    if (
                        ...
                        if (
                            ...
                            var e = this._source.priceScale(),
                                ...
                                y = g.x,
                                w = Math.abs(
                                    (this._points[0].x - this._points[1].x) / (this._source._pattern.length - 1)
                                ),
                                m = {
                                    0: function(e) {
                                        return {
                                    ...
                                    6: function(e, t) {
                                        return new r(
                                            y + t * w,
                                            _((e[TradingView.HIGH_PLOT] + e[TradingView.LOW_PLOT]) / 2) + g.y
                                        )
                                    }
                                }
                ...
                (d.prototype._updateImpl = function() {
                    if ((n.prototype._updateImpl.call(this), (this._renderer = null), 0 !== this._points.length)) {
                        ...
                        if (
                            ...
                            this._source.properties().showLabel.value() && 1 === this._points.length)
                        ) {
                        ...
                        if (1 === this._points.length) {
                            ...
                            ;(u.data = 0),
                                (u.square = !0),
                                e.append(this.createLineAnchor({ points: [u], pointsCursorType: h }))
                        }
                        this._renderer = e
                    }
                }),
                ...
                return (
                    ...
                    (t.prototype._updateImpl = function() {
                        if ((e.prototype._updateImpl.call(this), (this._renderer = null), 1 === this._points.length)) {
                            ...
                            var l = [
                                this._anchorsOffset ? this._points[0].add(this._anchorsOffset) : this._points[0].clone()
                            ]
                            this._renderer.append(
                ...
                (g.prototype._drawImpl = function(e) {
                    if (!(null === this._data || this._data.points.length < 2)) {
                        ...
                        e.scale(1, d / (f * x)),
                            ...
                            e.stroke(),
                            this._data.fillBackground &&
                                ((e.fillStyle = _.generateColor(this._data.backcolor, this._data.transparency)),
                                e.fill())
                    }
                }),
                    ...
                    return (
                        ...
                        (t.prototype.hitTest = function(e) {
                            ...
                            if (Math.abs(i - this._data.radius) <= 4) {
                                ...
                                if (Math.max(r, n) <= this._data.p1.subtract(this._data.p2).length())
                        ...
                        (t.prototype._drawImpl = function(e) {
                            if (
                                ...
                                if (
                                    ...
                                    t.addColorStop(
                                        0,
                                        Object(a.generateColor)(this._data.color1, this._data.transparency)
                                    ),
                                        t.addColorStop(
                                            1,
                                            Object(a.generateColor)(this._data.color2, this._data.transparency)
                                        ),
                                        (e.fillStyle = t)
                                } else
                        ...
                        (t.prototype._updateBaseData = function() {
                            ...
                            if (this._source.points().length >= 4) {
                                var n = this._source.points(),
                                    a = ((t = n[0]), (i = n[1]), n[3])
                                this._bcRetracement =
                                    Math.round(1e3 * Math.abs((a.price - t.price) / (i.price - t.price))) / 1e3
                            }
                            if (this._source.points().length >= 5) {
                                var o = this._source.points(),
                                ...
                                ;(this._cdRetracement =
                                    Math.round(1e3 * Math.abs((s.price - a.price) / (a.price - r.price))) / 1e3),
                                    (this._xdRetracement =
                                        Math.round(1e3 * Math.abs((s.price - a.price) / (t.price - a.price))) / 1e3)
                            }
                        }),
                        t
                    )
                            ...
                            if (i && !i.isEmpty()) {
                                ...
                                if (
                                    ...
                                    t.isPriceDencityLog() &&
                                        ...
                                        (f =
                                            i.height() /
                                            (Object(c.toLog)(p.maxValue()) - Object(c.toLog)(p.minValue()))),
                                        !t.isPriceDencityLog() &&
                                            i.isLog() &&
                                            (f =
                                                i.height() /
                                                (Object(c.fromLog)(p.maxValue()) - Object(c.fromLog)(p.minValue())))
                                ...
                                if ((this._textRenderer.setData(l), 1 === l.points.length && !this._noSelection)) {
                                    ...
                                    if (l.wordWrapWidth) {
                                        ...
                                        ;(b.data = 0),
                                            g.append(this.createLineAnchor({ points: [b], pointsCursorType: _ }))
                                    }
            ...
            inherit(g, v),
                ...
                (g.prototype._drawImpl = function(e) {
                    if (!(null === this._data || this._data.points.length < 2)) {
                        ...
                        ;(w = h(m, w)),
                            ...
                            e.stroke(),
                            this._data.fillBackground &&
                                ((e.fillStyle = p.generateColor(this._data.backcolor, this._data.transparency)),
                                e.fill())
                    }
                }),
                ...
                (y.prototype._updateImpl = function() {
                    if ((d.prototype._updateImpl.call(this), (this._renderer = null), !(this._points.length < 2))) {
                        ...
                        t.append(this.createLineAnchor({ points: [v, g, y, w], pointsCursorType: x })),
                            (this._renderer = t)
                    }
                }),
                (t.EllipsePaneView = y)
                ...
                (T.prototype._statLabelData = function() {
                    ...
                    if (u.showPriceRange.value() && this._source.priceScale()) {
                        ...
                        g &&
                            ...
                            ((this._pipFormatter = new c(g.pricescale, g.minmov, g.type, g.minmove2)),
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    var S,
                                        P =
                                            100 -
                                            100 * (1 - (S = 0.01 * c.profitBackgroundTransparency.value()) * S * S)
                                    ;(C.transparency = P),
                                        (C.extendLeft = !1),
                                        (C.extendRight = !1),
                                ...
                                F &&
                                    ...
                                    ((this._pipFormatter = new u(F.pricescale, F.minmov, F.type, F.minmove2)),
                ...
                f = (function(e) {
                    ...
                    return (
                        ...
                        (t.prototype._visiblePolygons = function(e) {
                            ...
                            return (
                                (p = v(p, d, g, [w, w])), null !== (p = v((p = y(p, t)), w, d, [g, g])) && u.push(p), u
                            )
                        }),
                        t
                    )
                        ...
                        if (null !== this._model.timeScale().visibleBarsStrictRange()) {
                            ...
                            for (var l = y ? y.index - e.index : 1, u = 1; u <= 11; u++) {
                                ...
                                if (p.visible.value()) {
                                    ...
                                    t.showLabels.value() &&
                                        ((f.text = p.coeff.value()), (f.y = this._source.priceScale().height())),
                                        this._levels.push(f)
                                }
                            }
                            var v = new d()
                    ...
                    if (
                        ...
                        if (!(this._floatPoints.length < 2)) {
                            ...
                            for (
                                ...
                                ;(F = new s()).setData(k),
                                    F.setHitTest(
                                        new l(l.MOVEPOINT, null, { type: 'h', index: this._hlevels[f].index })
                                    ),
                                    S.append(F)
                            }
                            for (f = 0; f < this._vlevels.length; f++) {
                                ...
                                ;(F = new s()).setData(k),
                                    F.setHitTest(
                                        new l(l.MOVEPOINT, null, { type: 'v', index: this._vlevels[f].index })
                                    ),
                                    S.append(F)
                            }
