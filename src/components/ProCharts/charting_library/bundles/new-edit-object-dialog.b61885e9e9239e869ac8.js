;(window.webpackJsonp = window.webpackJsonp || []).push([
    ['new-edit-object-dialog'],
    {
        ...
        CHgb: function(e, t, n) {
            ...
            function p(e) {
                var t = e.menuItemClassName,
                    n = Object(r.e)(e, ['menuItemClassName'])
                return a.a.createElement(c.a, Object(r.a)({}, n, { menuItemClassName: i()(t, u.itemWrap) }))
            }
            function d(e) {
                return a.a.createElement(
                    'div',
                    { className: i()(u.item, u.selected) },
                    a.a.createElement(s.a, { className: u.icon, icon: e.icon })
                )
            }
            function h(e) {
                return a.a.createElement(
                    'div',
                    { className: u.item },
                    a.a.createElement(s.a, { className: i()(u.icon, e.iconClassName), icon: e.icon }),
        ...
        KacW: function(e, t, n) {
            ...
            var r = n('mrSG'),
                ...
                m = [
                    ...
                    { type: c.LINESTYLE_DASHED, icon: p, label: window.t('Dashed Line') },
                    { type: c.LINESTYLE_DOTTED, icon: d, label: window.t('Dotted Line') }
                ]
            var v = (function(e) {
                function t() {
                        ...
                        var e,
                            ...
                            v =
                                ...
                                t.map(function(e) {
                                    return {
                                        value: e.type,
                                        selectedContent: a.a.createElement(s.a, { icon: e.icon }),
                                        content: a.a.createElement(s.b, { icon: e.icon, label: e.label })
                                    }
                                }))
                        return (
                            p && (v = Object(r.f)([{ readonly: !0, content: p }], v)),
                            a.a.createElement(s.c, {
                                disabled: u,
                                className: i()(h.lineStyleSelect, o),
                                hideArrowButton: !0,
                                items: v,
                                value: l,
                                onChange: c,
        ...
        MB0Y: function(e, t, n) {
            ...
            n('4pMH')
            function s(e) {
                const { className: t = '', intent: n = 'default', size: r = 'small', disabled: l } = e
                return o(t, c.switcherWrapper, c['size-' + r], !l && c['intent-' + n])
            }
            class u extends l.PureComponent {
                render() {
                    const e = this.props,
                        { reference: t, size: n, intent: a } = e,
                        i = Object(r.e)(e, ['reference', 'size', 'intent']),
                        u = o(c.input, -1 !== this.props.tabIndex && c.focus)
                    return l.createElement(
                        'div',
                        { className: s(this.props) },
                        l.createElement('input', Object.assign({}, i, { type: 'checkbox', className: u, ref: t })),
                        l.createElement(
                            'div',
                            { className: c.switcherThumbWrapper },
            ...
            function m(e) {
                var t = e.className,
                    ...
                    w = i()(t, f.wrapper, n && f.wrapperWithOnLabel)
                return a.a.createElement(
                    'label',
                    { className: w, htmlFor: l, ref: m },
                    a.a.createElement(
                        'div',
                        { className: f.labelRow },
                        a.a.createElement('div', { className: b }, o),
                        c && a.a.createElement('div', { className: f.labelHint }, c)
                    ),
                    a.a.createElement(
                        u,
                        Object(r.a)(
        ...
        Y5hB: function(e, t, n) {
            ...
            var r = n('mrSG'),
                    ...
                    function t(t) {
                        ...
                        ;(n._renderFooterLeft = function(e) {
                            ...
                            if (Object(b.isStudy)(r))
                                return a.createElement(m.a, { model: l, source: r, mode: e ? 'compact' : 'normal' })
                        ...
                        var r = n.props,
                            l = r.pages,
                            o = r.initialActiveTab
                        return (n.state = { activeTabId: l.allIds.includes(o) ? o : l.allIds[0] }), n
                    }
                    return (
                        Object(r.c)(t, e),
                        (t.prototype.render = function() {
                        ...
                        (t.prototype._renderChildren = function(e) {
                            ...
                            return function(n) {
                                ...
                                var l = t.props,
                                    ...
                                    c = l.model,
                                    s = o.byId[e]
                                'Component' in s || s.page
                                return a.createElement(
                                    a.Fragment,
                                    null,
                                    a.createElement(h.a, { activeTabId: e, onSelect: t._handleSelect, tabs: o }),
                                    a.createElement(
                                        f.a,
                                        { className: w.scrollable, onScroll: t._handleScroll },
                                        'Component' in s && a.createElement(s.Component, { source: i, model: c })
                                    )
                                )
                            }
                        }),
                    ...
                    return (
                        ...
                        (t.prototype.render = function() {
                            var e = this.props,
                                ...
                                o = e.onBlur,
                                i = e.onKeyDown,
                                c = t.options.reduce(function(e, t) {
                                    return (e[t] = 'NONE' === t ? window.t('Default') : t), e
                                }, {}),
                                s = Object(r.a)(Object(r.a)({}, t), { optionsTitles: c })
                            return a.createElement(S.b, { input: s, value: n, onChange: l, onBlur: o, onKeyDown: i })
                        }),
                        t
                    )
                })(a.PureComponent),
                ...
                k = n('+8gn'),
                L = n('Q+1u'),
                N = (n('HbRj'), a.createContext(null)),
                T = window.t('{currency} per order'),
                M = window.t('{currency} per contract'),
                I = (function(e) {
                    function t() {
                        return (null !== e && e.apply(this, arguments)) || this
                    }
                    return (
                        ...
                        (t.prototype.render = function() {
                            var e,
                                ...
                                l =
                                    (((e = {}).percent = '%'),
                                    (e.cash_per_order = T.format({ currency: n })),
                                    (e.cash_per_contract = M.format({ currency: n })),
                                    e),
                                o = Object(r.a)(Object(r.a)({}, t), { optionsTitles: l })
                            return a.createElement(S.a, { input: o })
                        }),
                        (t.contextType = N),
                        t
                    )
                    ...
                    return (
                        ...
                        (t.prototype.render = function() {
                            var e,
                                t = this.props.input,
                                n = Object(i.ensureNotNull)(this.context),
                                l = (((e = {}).fixed = V), (e.cash_per_order = n), (e.percent_of_equity = R), e),
                                o = Object(r.a)(Object(r.a)({}, t), { optionsTitles: l })
                            return a.createElement(S.a, { input: o })
                        }),
                        (t.contextType = N),
                        ...
                        (t.prototype.render = function() {
                            ...
                            return a.createElement(
                                ...
                                a.createElement(
                                    ...
                                    a.createElement(C.a, { input: e.initial_capital })
                                ),
                                a.createElement(
                                    x.a,
                                ...
                                a.createElement(
                                    ...
                                    a.createElement(
                                        j.a,
                                        null,
                                        a.createElement(C.a, { input: e.default_qty_value }),
                                        a.createElement(z, { input: e.default_qty_type })
                                    )
                                ),
                                a.createElement(
                                    x.a,
                                    { label: window.t('Pyramiding') },
                                    a.createElement('span', null, a.createElement(C.a, { input: e.pyramiding })),
                                    a.createElement(
                                        'span',
                                ...
                                a.createElement(L.a.Separator, null),
                                a.createElement(
                                    x.a,
                                    ...
                                    a.createElement(
                                        j.a,
                                        null,
                                        a.createElement(C.a, { input: e.commission_value }),
                                ...
                                a.createElement(
                                    ...
                                    a.createElement(
                                        'span',
                                        null,
                                        a.createElement(C.a, { input: e.backtest_fill_limits_assumption })
                                    ),
                                    a.createElement(
                                        'span',
                                        { className: D.descriptionCell },
                                ...
                                a.createElement(
                                    ...
                                    a.createElement('span', null, a.createElement(C.a, { input: e.slippage })),
                                    a.createElement(
                                        'span',
                                        { className: D.descriptionCell },
                                        window.t('ticks', {
            ...
            function H(e) {
                ...
                return a.createElement(
                    k.a,
                    { property: t.inputs, model: n, study: l },
            ...
            var W,
                A = n('z61+'),
                F = n('txPx'),
                G = Object(F.getLogger)('Platform.GUI.PropertyDialog.Indicators.StrategyPage'),
                U = (function(e) {
                    function t(t) {
                        var n = e.call(this, t) || this
                        ...
                        var l = r.metaInfo(),
                            a = new A.a(l)
                        return (n._inputs = a.getStrategyProperties()), (n.state = { currency: n._getCurrency() }), n
                    }
                    return (
                        Object(r.c)(t, e),
                ...
                q = (function(e) {
                    function t(t) {
                        ...
                        return (
                            ...
                            (n._inputs = new A.a(n.props.source.metaInfo()).getUserEditableInputs()),
                            n
                        )
                    }
                    return (
                    ...
                    return (
                        ...
                        (t.prototype.render = function() {
                            var e = this.props,
                                ...
                                r = e.visible,
                                l = e.disabled,
                                o = Object(c.clean)(window.t(n, { context: 'input' }), !0)
                ...
                me = Object.values(he)
                    ...
                    .map(function(e) {
                        return {
                            value: e.type,
                            selectedContent: o.a.createElement(re.a, { icon: e.icon }),
                            content: o.a.createElement(re.b, { icon: e.icon, label: e.label })
                        }
                    }),
                ...
                ye = (function(e) {
                    ...
                    return (
                        ...
                        (t.prototype.render = function() {
                            ...
                            return o.a.createElement(re.c, {
                                disabled: c,
                                className: n,
                                hideArrowButton: !0,
                                items: Object(r.f)([s], me),
                                value: t,
                                onChange: a
                            })
                        }),
                ...
                fe = n('lkVX'),
                be = n('wwEg'),
                we = window.t('Change Plot Type'),
                ge = window.t('Change Price Line'),
                Ce = (function(e) {
                    function t() {
                        var t = (null !== e && e.apply(this, arguments)) || this
                        return (
                        ...
                        (t.prototype.render = function() {
                            ...
                            return a.createElement(
                                ...
                                a.createElement(fe.a, {
                                    ...
                                    thickness: l ? c.width : void 0,
                                    isPaletteColor: !0
                                }),
                                l && o && r.plottype && r.trackPrice
                                    ? a.createElement(ye, {
                                          disabled: !r.visible.value(),
                    ...
                    return (
                        ...
                        (t.prototype.render = function() {
                            var e = this.props,
                                ...
                                r = e.palette,
                                l = e.paletteProps,
                                o = e.hideVisibilitySwitch,
                                c = e.styleProp,
                                s = t ? t.id : Object(i.ensureDefined)(n).id,
                                u = !s.startsWith('fill') && t && Object(Q.isLinePlot)(t)
                            return a.createElement(
                                a.Fragment,
                                null,
                                !o &&
                                ...
                                (function(e, t, n, r) {
                                    var l = e.colors,
                                        o = t.colors
                                    return Object.keys(l).map(function(e, t) {
                                        return a.createElement(Ce, {
                                            key: e,
                                            grouped: !0,
                                            paletteColor: Object(i.ensureDefined)(l[e]),
                                            paletteColorProps: Object(i.ensureDefined)(o[e]),
                                            styleProp: n,
                                            isLine: r,
                                ...
                                a.createElement(L.a.GroupSeparator, null)
                            )
                        }),
                        (t.contextType = X.b),
                        t
                ...
                Pe = (function(e) {
                    ...
                    return (
                        ...
                        (t.prototype.render = function() {
                            ...
                            return a.createElement(
                                x.a,
                                { label: a.createElement(ee, { id: t, title: r.value(), visible: u }) },
                                a.createElement(fe.a, {
                                    disabled: !u.value(),
                                    color: l,
                                    transparency: c,
                    ...
                    return (
                        ...
                        (t.prototype.render = function() {
                            var e = this.props,
                                ...
                                o = n.transparency,
                                c = n.visible
                            return a.createElement(Oe.Consumer, null, function(e) {
                                return a.createElement(
                                    x.a,
                                    {
                                        label: a.createElement(ee, {
                                            id: t,
                                            title: je(Object(i.ensureNotNull)(e), t),
                                            visible: c
                                        })
                                    },
                                    a.createElement(fe.a, { disabled: !c.value(), color: r, transparency: o }),
                                    a.createElement(
                                        'span',
                                        { className: be.additionalSelect },
                                        a.createElement(fe.a, { disabled: !c.value(), color: l, transparency: o })
                                    )
                                )
                            })
                        }),
            ...
            var ke,
                ...
                ze = n('972a'),
                De =
                    (((ke = {})[ze.MarkLocation.AboveBar] = {
                        value: ze.MarkLocation.AboveBar,
                        content: window.t('Above Bar'),
                        order: 0
                    }),
                    (ke[ze.MarkLocation.BelowBar] = {
                        value: ze.MarkLocation.BelowBar,
                        content: window.t('Below Bar'),
                        order: 1
                    }),
                    (ke[ze.MarkLocation.Top] = { value: ze.MarkLocation.Top, content: window.t('Top'), order: 2 }),
                    (ke[ze.MarkLocation.Bottom] = {
                        value: ze.MarkLocation.Bottom,
                        content: window.t('Bottom'),
                        order: 3
                    }),
                    (ke[ze.MarkLocation.Absolute] = {
                        value: ze.MarkLocation.Absolute,
                        content: window.t('Absolute'),
                        order: 4
                    }),
                    ke),
                Be = Object.values(De).sort(function(e, t) {
                    return e.order - t.order
                }),
                He = (function(e) {
                    function t() {
                ...
                We = window.t('Change Char'),
                Ae = window.t('Change Location'),
                Fe = (function(e) {
                    function t() {
                        var t = (null !== e && e.apply(this, arguments)) || this
                        return (
                            (t._onCharChange = function(e) {
                                ...
                                n(t.props.property.char, a, We)
                            }),
                            (t._onLocationChange = function(e) {
                                ;(0, t.context.setValue)(t.props.property.location, e, Ae)
                            }),
                            t
                        )
                    }
                    return (
                        ...
                        (t.prototype.render = function() {
                            ...
                            return a.createElement(
                                x.a,
                                { grouped: u, label: a.createElement(ee, { id: t, title: r.value(), visible: s }) },
                                !u && a.createElement(fe.a, { disabled: !s.value(), color: l, transparency: o }),
                                ...
                                a.createElement(He, {
                                    disabled: !s.value(),
                                    className: Me(be.defaultSelect, be.additionalSelect),
            ...
            Object.keys(Ge.plotShapesData).forEach(function(e) {
                ...
                at.push({
                    value: t.id,
                    selectedContent: o.a.createElement(re.a, { icon: lt(t.icon) }),
                    content: o.a.createElement(re.b, { icon: lt(t.icon), label: t.guiName })
                })
            })
            var ot = (function(e) {
                    function t() {
                ...
                st = (function(e) {
                    function t() {
                        ...
                        return (
                            ...
                            (t._onLocationChange = function(e) {
                                ;(0, t.context.setValue)(t.props.property.location, e, ct)
                            }),
                            t
                        )
                    }
                    return (
                        ...
                        (t.prototype.render = function() {
                            ...
                            return a.createElement(
                                x.a,
                                { grouped: n, label: a.createElement(ee, { id: t, title: l.value(), visible: u }) },
                                !n && a.createElement(fe.a, { disabled: !u.value(), color: o, transparency: i }),
                                a.createElement(ot, {
                                    disabled: !u.value(),
                                    className: be.smallStyleControl,
                                    shapeStyleId: c.value(),
                ...
                ut = (function(e) {
                    ...
                    return (
                        ...
                        (t.prototype.render = function() {
                            ...
                            return a.createElement(
                                x.a,
                                { label: u ? a.createElement(ee, { id: t, title: n, visible: r }) : n },
                                a.createElement(fe.a, {
                ...
                pt = Object(F.getLogger)('Chart.Study.PropertyPage'),
                dt = (function(e) {
                    function t() {
                        return (null !== e && e.apply(this, arguments)) || this
                    }
                    return (
                        ...
                        (t.prototype.render = function() {
                            var e = this.props,
                                ...
                                l = e.study,
                                o = t.id,
                                c = l.properties().styles[o],
                                s = t.type
                            if ('line' === s || 'bar_colorer' === s || 'bg_colorer' === s)
                                return n && r
                                    ? a.createElement(Ee, { plot: t, palette: n, paletteProps: r, styleProp: c })
                                    : a.createElement(Pe, { id: o, property: c })
                            if ('arrows' === s) return a.createElement(xe, { id: o, property: c })
                            if ('chars' === s || 'shapes' === s)
                                return a.createElement(
                                    a.Fragment,
                                    null,
                                    'chars' === s
                                        ? a.createElement(Fe, { id: o, property: c, hasPalette: Boolean(n) })
                                        : a.createElement(st, { id: o, property: c, hasPalette: Boolean(n) }),
                                    n &&
                                        r &&
                                        a.createElement(Ee, {
                                            plot: t,
                            ...
                            if (Object(Q.isOhlcPlot)(t)) {
                                var u = t.target,
                                    p = Object(i.ensureDefined)(l.metaInfo().defaults.ohlcPlots)[u],
                                    d = l.properties().ohlcPlots[u],
                                    h = void 0
                                h =
                                    n && r
                                        ? a.createElement(Ee, { plot: t, palette: n, paletteProps: r, styleProp: d })
                                        : a.createElement(ut, {
                                              id: u,
                                              title: d.title.value(),
                                              color: d.color,
                                ...
                                return (
                                    void 0 !== p &&
                                        Object(Q.isOhlcPlotStyleCandles)(p) &&
                                        (m = a.createElement(
                                            a.Fragment,
                                            null,
                                            a.createElement(ut, {
                            ...
                            return pt.logError('Unknown plot type: ' + s), null
                        }),
                        t
                    )
                })(a.PureComponent),
                ...
                yt = (function(e) {
                    ...
                    return (
                        ...
                        (t.prototype.render = function() {
                            var e = this.props,
                                t = e.lineStyle,
                                n = Object(r.e)(e, ['lineStyle'])
                            return o.a.createElement(
                                mt.a,
                                Object(r.a)({}, n, { lineStyle: t.value(), lineStyleChange: this._onLineStyleChange })
                            )
                        }),
                        (t.contextType = X.b),
                        t
                        ...
                        (t.prototype.render = function() {
                            ...
                            return a.createElement(
                                ...
                                a.createElement(
                                    ...
                                    a.createElement(
                                        'div',
                                        { className: Me(be.wrapGroup, be.defaultSelect, be.additionalSelect) },
                ...
                Ct = n('kk0y'),
                Et = [
                    { value: gt.a.LeftToRight, content: window.t('Left') },
                    { value: gt.a.RightToLeft, content: window.t('Right') }
                ],
                St = window.t('Width (% of the Box)'),
                _t = window.t('Placement'),
                Pt = window.t('Show Values'),
                Ot = window.t('Text Color'),
                xt = window.t('Change Percent Width'),
                jt = window.t('Change Placement'),
                kt = window.t('Change Show Values'),
                Lt = (function(e) {
                    function t() {
                        var t = (null !== e && e.apply(this, arguments)) || this
                        return (
                            (t._onPercentWidthChange = function(e) {
                                ;(0, t.context.setValue)(t.props.property.childs().percentWidth, e, xt)
                            }),
                            (t._onPlacementChange = function(e) {
                                ;(0, t.context.setValue)(t.props.property.childs().direction, e, jt)
                            }),
                            (t._onShowValuesChange = function(e) {
                                ;(0, t.context.setValue)(t.props.property.childs().showValues, e, kt)
                            }),
                            t
                        )
                    }
                    return (
                            ...
                            return a.createElement(
                                ...
                                a.createElement(
                                    ...
                                    a.createElement(
                                        L.a.Cell,
                                        { placement: 'first', colSpan: 2, grouped: !0 },
                                        a.createElement(ee, { id: t.value(), title: t.value(), visible: i })
                                    )
                                ),
                                a.createElement(
                                    x.a,
                                    {
                                        label: a.createElement('div', { className: be.childRowContainer }, St),
                                        grouped: !0
                                    },
                                    a.createElement(Ct.b, {
                                ...
                                a.createElement(
                                    x.a,
                                    {
                                        label: a.createElement('div', { className: be.childRowContainer }, _t),
                                        grouped: !0
                                    },
                                ...
                                a.createElement(
                                    x.a,
                                    {
                                        label: a.createElement('div', { className: be.childRowContainer }, Ot),
                                        grouped: !0
                                    },
                                    a.createElement(fe.a, { disabled: i && !i.value(), color: o })
                                ),
                                this._renderColors(),
                                a.createElement(L.a.GroupSeparator, null)
                            )
                        ...
                        (t.prototype._renderColors = function() {
                            var e = this.props.property.childs(),
                                ...
                                r = e.transparencies,
                                l = e.visible
                            return t.childNames().map(function(e) {
                                return a.createElement(
                                    x.a,
                                    {
                                        key: e,
                ...
                Nt = (function(e) {
                    ...
                    return (
                        ...
                        (t.prototype.render = function() {
                            ...
                            return a.createElement(
                                x.a,
                                { label: a.createElement(ee, { id: e.value(), title: e.value(), visible: i }) },
                                a.createElement(fe.a, {
                                    disabled: !i.value(),
                                    color: n,
                                    transparency: r,
                    ...
                    return (
                        ...
                        (t.prototype.render = function() {
                            var e = this.props,
                                ...
                                l = n.properties().graphics,
                                o = Object(i.ensureDefined)(r[t])
                            return Object.keys(o).map(function(e, n) {
                                var r = l[t][e]
                                return 'horizlines' === t || 'vertlines' === t || 'lines' === t
                                    ? a.createElement(Nt, {
                                          key: e,
                                          title: 'lines' === t ? r.title : r.name,
                                          property: r
                                      })
                                    : 'hhists' === t
                                    ? a.createElement(Lt, { key: e, property: r })
                                    : null
                            })
                        }),
                        t
                ...
                Mt = window.t('Change Font'),
                It = ['Verdana', 'Courier New', 'Times New Roman', 'Arial'].map(function(e) {
                    ...
                    function t() {
                        ...
                        return (
                            (t._onFontFamilyChange = function(e) {
                                ;(0, t.context.setValue)(t.props.fontFamily, e, Mt)
                            }),
                            t
                        )
                    }
                ...
                Rt = n('UXjO'),
                zt = window.t('Change Font Size'),
                Dt = [10, 11, 12, 14, 16, 20, 24, 28, 32, 40].map(function(e) {
                    ...
                    function t() {
                        ...
                        return (
                            (t._onFontSizeChange = function(e) {
                                ;(0, t.context.setValue)(t.props.fontSize, e, zt)
                            }),
                            t
                        )
                    }
                ...
                Ht = window.t('Change Visibility'),
                Wt = window.t('Labels Font'),
                    ...
                    return (
                        ...
                        (t.prototype.render = function() {
                            ...
                            return o.a.createElement(
                                ...
                                o.a.createElement(
                                    x.a,
                                    { labelAlign: 'adaptive', label: o.a.createElement('span', null, Wt) },
                                    o.a.createElement(
                                        'div',
                                        { className: be.block },
                                        o.a.createElement(
                                            'div',
                                            { className: be.group },
                                            o.a.createElement(Vt, { fontFamily: t })
                                        ),
                                        o.a.createElement(
                                            'div',
                                            { className: Me(be.wrapGroup, be.additionalSelect) },
                                            o.a.createElement(Bt, { fontSize: n })
                                        )
                                    )
                                ),
                                o.a.createElement(
                        ...
                        (t.prototype._renderColors = function() {
                            var e = this.props.property.childs(),
                                ...
                                c = r.visibility,
                                s = n.childs().kind,
                                u = Object(i.ensureDefined)(Ft[s.value()])
                            return l
                                .childNames()
                                .filter(function(e) {
                                    return u.has(e)
            ...
            var Ut = window.t('Change Visibility'),
                Yt = window.t('Volume Profile'),
                qt = window.t('Show Values'),
                Qt = window.t('Width (% of the Box)'),
                Kt = window.t('Placement'),
                Jt = window.t('Developing VA'),
                Xt = [
                    { value: gt.a.RightToLeft, content: window.t('Right') },
                    { value: gt.a.LeftToRight, content: window.t('Left') }
                ],
                Zt = (function(e) {
                    function t() {
                        ...
                        return (
                            (t._onChange = function(e) {
                                t._setHhistsProperty('visible', e)
                            }),
                            (t._onShowValuesChange = function(e) {
                                t._setHhistsProperty('showValues', e)
                            }),
                            (t._onValueChange = function(e) {
                                t._setHhistsProperty('percentWidth', e)
                            }),
                            (t._onDirectionChange = function(e) {
                                t._setHhistsProperty('direction', e)
                            }),
                            t
                        )
                    }
                    return (
                        ...
                        (t.prototype.render = function() {
                            var e = this.props.metaInfo,
                                ...
                                c = l.horizlines,
                                s = l.polygons,
                                u = Object.keys(Object(i.ensureDefined)(e.graphics.hhists)),
                                p = a.childs()[u[0]],
                                d = p.childs().visible,
                                h = u.map(function(e) {
                                    return a.childs()[e].childs().showValues
                                }),
                                m = p.childs().percentWidth,
                                v = p.childs().direction,
                                y = u.map(function(e) {
                                    return a.childs()[e].childs().valuesColor
                                }),
                                f = c.childs().pocLines,
                                b = r.childs().developingPoc,
                                w = r.childs().developingVAHigh,
                                g = r.childs().developingVALow
                            return o.a.createElement(
                                o.a.Fragment,
                                null,
                                o.a.createElement(
                                ...
                                o.a.createElement(
                                    ...
                                    o.a.createElement(
                                        L.a.Cell,
                                        { placement: 'last' },
                                        o.a.createElement(fe.a, { disabled: !d.value() || !h[0].value(), color: y })
                                    )
                                ),
                                o.a.createElement(
                                    L.a.Row,
                                    ...
                                    o.a.createElement(
                                        L.a.Cell,
                                        { placement: 'first' },
                                        o.a.createElement('div', { className: be.childRowContainer }, Qt)
                                    ),
                                    o.a.createElement(
                                        L.a.Cell,
                                        { placement: 'last' },
                                ...
                                o.a.createElement(
                                    ...
                                    o.a.createElement(
                                        L.a.Cell,
                                        { placement: 'first' },
                                        o.a.createElement('div', { className: be.childRowContainer }, Kt)
                                    ),
                                    o.a.createElement(
                                        L.a.Cell,
                                        { placement: 'last' },
                                ...
                                w &&
                                    ...
                                    o.a.createElement(
                                        ut,
                                        {
                                            id: 'developingPoc',
                                            title: Jt,
                                            color: [w.childs().color, g.childs().color],
                                            visible: [w.childs().visible, g.childs().visible],
                                            thickness: [w.childs().linewidth, g.childs().linewidth]
                                        },
                                        o.a.createElement(yt, {
                                            disabled: !w.childs().visible.value(),
                                            className: be.smallStyleControl,
                                            lineStyle: w.childs().linestyle
                                        })
                                    ),
                                s &&
                                    o.a.createElement(
                                        ...
                                        o.a.createElement(fe.a, {
                                            color: s.childs().histBoxBg.childs().color,
                                            transparency: s.childs().histBoxBg.childs().transparency
                                        })
                                    )
                            )
                        }),
                        (t.prototype._setHhistsProperty = function(e, t) {
                            for (
                                var n = this.context.setValue,
                                    r = this.props,
                                    l = r.metaInfo,
                                    a = r.property.childs().graphics.childs().hhists,
                                    o = Object.keys(Object(i.ensureDefined)(l.graphics.hhists)),
                                    c = 0;
                                c < o.length;
                                c++
                            ) {
                                var s = a.childs()[o[c]].child(e)
                                n(Object(i.ensureDefined)(s), t, Ut)
                            }
                        }),
                        (t.contextType = X.b),
                        t
                ...
                var $t = n('KJt4'),
                    en = {
                        PivotPointsStandard: function() {
                            var e = Object(i.ensureNotNull)(Object(a.useContext)(Oe)).properties()
                            return o.a.createElement(Gt, { property: e })
                        },
                        VbPVisible: function() {
                            var e = Object(i.ensureNotNull)(Object(a.useContext)(Oe)),
                                t = e.metaInfo(),
                                n = e.properties()
                            return o.a.createElement(Zt, { metaInfo: t, property: n })
                        }
                    },
                    tn = (function(e) {
                        function t() {
                        ...
                        return (
                            ...
                            (t.prototype.render = function() {
                                ...
                                return a.createElement(Oe.Consumer, null, function(n) {
                                    return a.createElement(
                                        X.a,
                                        ...
                                        a.createElement(
                                            L.a,
                                            null,
                                            e._renderCustomContent(Object(i.ensureNotNull)(n).metaInfo().shortId)
                                        )
                                    )
                                })
                            }),
                    ...
                    on = [{ value: 'default', content: rn }],
                    cn = 0;
                cn <= 8;
                cn++
            )
                on.push({ value: cn, content: cn.toString() })
            for (
                var sn = (function(e) {
                        function t() {
                            var t = (null !== e && e.apply(this, arguments)) || this
                            return (
                                (t._onChange = function(e) {
                                    ;(0, t.context.setValue)(t.props.precision, e, an)
                                }),
                                t
                            )
                        }
                    ...
                    un = window.t('Default'),
                    pn = window.t('Override Min Tick'),
                    dn = window.t('Change Min Tick'),
                    hn = [
                ...
                var yn = hn[vn]
                mn.push({
                    value: yn.priceScale + ',' + yn.minMove + ',' + yn.frac,
                    content: yn.minMove + '/' + yn.priceScale
                })
            }
            var fn = (function(e) {
                    function t() {
                        ...
                        return (
                            (t._onChange = function(e) {
                                ;(0, t.context.setValue)(t.props.minTick, e, dn)
                            }),
                            t
                        )
                    }
                    ...
                    function t() {
                        ...
                        return (
                            (t._findPlotPalette = function(e) {
                                var n = t.props.study,
                                    r = n.metaInfo(),
                                    l = Object(i.ensureDefined)(r.palettes)
                                return Object(Q.isBarColorerPlot)(e) || Object(Q.isBgColorerPlot)(e)
                                    ? { palette: l[e.palette], paletteProps: n.properties().palettes[e.palette] }
                    ...
                    return (
                        ...
                        (t.prototype.render = function() {
                            var e = this,
                                t = this.props.study,
                                n = t.metaInfo()
                            if (Object(nn.a)(n.shortId)) return a.createElement(tn, null)
                            var l = new A.a(n).getUserEditablePlots(),
                                o = t.properties(),
                                c = o.bands,
                                s = o.bandsBackground,
                                u = o.areaBackground,
                                ...
                                v = n.graphics,
                                y = l.length > 0,
                                f = Object(bn.a)(t).canOverrideMinTick()
                            return a.createElement(
                                L.a,
                                null,
                                l.map(function(n) {
                                    var l = Object(Q.isOhlcPlot)(n)
                                            ? Object(r.a)(Object(r.a)({}, n), { id: n.target })
                                            : n,
                                        o = e._findPlotPalette(l),
                                        i = o.palette,
                                        c = o.paletteProps
                                ...
                                c &&
                                    c.childNames().map(function(e, t) {
                                        var n = c.child(e)
                                        if (!n.isHidden || !n.isHidden.value())
                                            return a.createElement(bt, { key: t, id: n.name.value(), property: n })
                                    }),
                                s &&
                                    a.createElement(ut, {
                                        id: 'bandsBackground',
                                        title: 'Background',
                                        visible: s.fillBackground,
                                    ...
                                    m.map(function(n) {
                                        if (!n.isHidden) {
                                            var r = t.properties().filledAreasStyle[n.id],
                                                l = n.title || 'Background'
                                            if (n.palette) {
                                                var o = e._findPaletteByTargetId(n.id)
                                                return a.createElement(Ee, {
                                                    key: n.id,
                                                    area: n,
                                                    palette: Object(i.ensureDefined)(o.palette),
                                                    paletteProps: Object(i.ensureDefined)(o.paletteProps),
                                                    styleProp: r
                                                })
                                            }
                                ...
                                v &&
                                    Object.keys(v).map(function(e, n) {
                                        return a.createElement(Tt, { key: e, graphicType: e, study: t })
                                    }),
                                y && a.createElement(sn, { precision: p }),
                                f && a.createElement(fn, { minTick: h }),
                                J.a.isScriptStrategy(n) && a.createElement(wt, { orders: d.orders })
                            )
                        }),
                        (t.prototype._findPaletteByTargetId = function(e) {
                            for (
                                ...
                                var c = o[a]
                                if ((Object(Q.isColorerPlot)(c) || Object(Q.isOhlcColorerPlot)(c)) && c.target === e)
                                    return { palette: l[c.palette], paletteProps: t.properties().palettes[c.palette] }
                            }
                            return {}
                        }),
                        t
            ...
            function gn(e) {
                return Object(X.c)(wn, Object(r.a)(Object(r.a)({}, e), { property: e.study.properties() }))
            }
            var Cn = (function(e) {
                    function t() {
                        return (null !== e && e.apply(this, arguments)) || this
                        ...
                        (t.prototype.render = function() {
                            return a.createElement(
                                ...
                                a.createElement(
                                    ...
                                    a.createElement(gn, { study: this.props.source })
                                )
                            )
                        }),
                        t
            ...
            var Sn = (function() {
                function e(e, t, n, r) {
                    ...
                    ;(this._container = document.createElement('div')),
                        ...
                        (this._handleClose = function() {
                            l.unmountComponentAtNode(a._container),
                                (a._isVisible = !1),
                        ...
                        (this._handleActiveTabChanged = function(e) {
                            s.setValue(a._activeTabSettingsName(), e)
                        }),
                        (this._source = e),
                        (this._model = t),
                ...
                return (
                    ...
                    (e.prototype.show = function(e) {
                        if ((void 0 === e && (e = {}), u.enabled('property_pages'))) {
                            var t = this._source.metaInfo()
                            if (
                                (Object(En.isLineTool)(this._source) &&
                            ...
                            var r = {
                                    byId: {
                                        ...
                                        style: { title: window.t('Style'), Component: Cn },
                                        properties: { title: window.t('Properties'), Component: U }
                                    },
                                    allIds: []
                                },
                                o = new A.a(t)
                            o.hasUserEditableInputs() && r.allIds.push('inputs'),
                            ...
                            var i = e.initialTab || s.getValue(this._activeTabSettingsName()) || 'inputs',
                                h = Object(c.clean)(t.shortDescription, !0)
                            0,
                                l.render(
                                    a.createElement(g, {
                                        title: h,
                                ...
                                (this._isVisible = !0),
                                p.emit('edit_object_dialog', { objectType: 'study', scriptTitle: this._source.title() })
                        }
                    }),
                    ...
                    (e.prototype._getPagesForStudyLineTool = function(e) {
                        if (this._propertyPages) {
                            ...
                            return {
                                allIds: Object(r.f)(e.allIds, n.allIds),
                                byId: Object(r.a)(Object(r.a)({}, e.byId), n.byId)
                            }
                        }
                        return e
                    }),
