    ...
    ['vendors'],
    {
                                    ...
                                    ;(l.style.cssText = 'background-color:rgba(1,1,1,.5)'),
                                        ...
                                        c(s, function(t, n) {
                                            var i = n.props,
                                                ...
                                                u = n.from
                                            ;(o.fn[t] = function(t) {
                                                if ((a && !this[s] && (this[s] = a(this._rgba)), void 0 === t))
                                                    return this[s].slice()
                                                var n,
                                                    r = e.type(t),
                                    ...
                                    e.each(
                                        ...
                                        e.fn.extend({
                                            addClass:
                                                ...
                                                function(n, r, i, o) {
                                                    return r
                                                        ? e.effects.animateClass.call(this, { add: n }, r, i, o)
                                    ...
                                    e.expr &&
                                            ...
                                            e.extend(e.effects, {
                                                ...
                                                restore: function(e, t) {
                                                    for (var n, r = 0, i = t.length; r < i; r++)
                                                        null !== t[r] &&
                                                            ((n = e.data('ui-effects-' + t[r])), e.css(t[r], n))
                                                },
                                        ...
                                        e.fn.extend({
                                            effect: function() {
                                                ...
                                                return !1 === o ? this.each(c).each(f) : this.queue(s, c).queue(s, f)
                                            },
                                            show: (function(e) {
                                                return function(t) {
        ...
        '12Jd': function(e, t, n) {
            ...
            e.exports = function(e) {
                var t = r(e),
                    n = i.f
                if (n) for (var s, a = n(e), u = o.f, l = 0; a.length > l; ) u.call(e, (s = a[l++])) && t.push(s)
                return t
            }
        },
        '12Rd': function(e, t, n) {
                ...
                ;(o.getListeners = function(e) {
                    ...
                    (o.addListener = function(e, t) {
                        ...
                        var n,
                            ...
                            i = 'object' == typeof t
                        for (n in r)
                            r.hasOwnProperty(n) && -1 === a(r[n], t) && r[n].push(i ? t : { listener: t, once: !1 })
                        return this
                    }),
                    (o.on = u('addListener')),
                    ...
                    (o.manipulateListeners = function(e, t, n) {
                        ...
                        if ('object' != typeof t || t instanceof RegExp) for (r = n.length; r--; ) o.call(this, t, n[r])
                            ...
                            for (r in t)
                                t.hasOwnProperty(r) &&
                                    (i = t[r]) &&
                                    ('function' == typeof i ? o.call(this, r, i) : s.call(this, r, i))
                        return this
                    }),
                ...
                n('u52/')(function() {
                    ...
                    ? function(e, t) {
                          for (var n = s(e), u = arguments.length, l = 1, c = i.f, f = o.f; u > l; )
                              for (
                                  var d, p = a(arguments[l++]), h = c ? r(p).concat(c(p)) : r(p), g = h.length, v = 0;
                                  g > v;
            ...
            ;((t = e.exports = function(e, t, n, f, d) {
                ...
                if (o(m)) {
                    for (p = a(e.length); p > b; b++)
                        if ((v = t ? y(s((h = e[b]))[0], h[1]) : y(e[b])) === l || v === c) return v
                } else
                    for (g = m.call(e); !(h = g.next()).done; ) if ((v = i(g, y, h.value, t)) === l || v === c) return v
            }).BREAK = l),
                (t.RETURN = c)
        },
        Blyn: function(e, t, n) {
            ...
            var r = (window.Modernizr = (function(e, t, n) {
                ...
                var l,
                    ...
                    k = function(e, n, r, i) {
                        ...
                        if (parseInt(r, 10))
                            for (; r--; ) ((a = t.createElement('div')).id = i ? i[r] : p + (r + 1)), l.appendChild(a)
                        return (
                ...
                _))
                    c(_, T) && ((l = T.toLowerCase()), (f[l] = _[T]()), w.push((f[l] ? '' : 'no-') + l))
                return (
                                                            ...
                                                            (o = function(e) {
                                                                var i = g.left - E.left,
                                                                    ...
                                                                    f = {
                                                                        ...
                                                                        horizontal:
                                                                            o < 0 ? 'left' : i > 0 ? 'right' : 'center',
                                                                        vertical:
                                                                            c < 0 ? 'top' : u > 0 ? 'bottom' : 'middle'
                                                                    }
                                                                p < a && r(i + o) < p && (f.horizontal = 'center'),
                                            ...
                                            flip: {
                                                left: function(e, t) {
                                                    var n,
                                                        ...
                                                        h = -2 * t.offset[0]
                                                    c < 0
                                                        ? ((n = e.left + d + p + h + t.collisionWidth - a - s) < 0 ||
                                                              n < r(c)) &&
                                                          (e.left += d + p + h)
                                                        : f > 0 &&
                                                          ((i =
                                                              e.left - t.collisionPosition.marginLeft + d + p + h - u) >
                                                              0 ||
                                                              r(i) < f) &&
                                                          (e.left += d + p + h)
                                                },
                                                top: function(e, t) {
                                                    var n,
                                                        ...
                                                        h = -2 * t.offset[1]
                                                    c < 0
                                                        ? ((i = e.top + d + p + h + t.collisionHeight - a - s) < 0 ||
                                                              i < r(c)) &&
                                                          (e.top += d + p + h)
                                                        : f > 0 &&
                                                          ((n = e.top - t.collisionPosition.marginTop + d + p + h - u) >
                                                              0 ||
                                                              r(n) < f) &&
                                                          (e.top += d + p + h)
                                                }
                            ...
                            u.forEach(function(i) {
                                if (void 0 !== (n = r[i])) {
                                    ...
                                    o.hasOwnProperty(e) || (o[e] = []),
                                        ((Array.isArray(t) && ~t.indexOf(e)) || e in t) && o[e].push(i)
                                }
                            })
                        }),
                        ...
                        typeof (r = function(e) {
                            ...
                            return (
                                ...
                                (e.widget = function(t, n, r) {
                                    ...
                                    return (
                                        ...
                                        (o.prototype = e.widget.extend(
                                            ...
                                            a,
                                            { constructor: o, namespace: u, widgetName: t, widgetFullName: l }
                                        )),
                                        i
                                ...
                                (e.Widget.prototype = {
                                    ...
                                    _off: function(t, n) {
                                        ;(n =
                                            (n || '').split(' ').join(this.eventNamespace + ' ') + this.eventNamespace),
                                            t.off(n).off(n),
                                    ...
                                    _trigger: function(t, n, r) {
                                        ...
                                        return (
                                            ...
                                            !(
                                                (e.isFunction(s) && !1 === s.apply(this.element[0], [n].concat(r))) ||
        ...
        P5fv: function(e, t) {
                    ...
                    return (
                        ...
                        s.extend({
                            noConflict: function(e) {
                                return (
                                    window.$ === s && (window.$ = u), e && window.jQuery === s && (window.jQuery = a), s
                                )
                            },
                            isReady: !1,
                            readyWait: 1,
                            ...
                            bindReady: function() {
                                if (!i) {
                                    if (((i = s.Callbacks('once memory')), 'complete' === n.readyState))
            ...
            o.Callbacks = function(e) {
                ...
                var t,
                    ...
                    d = function(o, s) {
                        for (
                            s = s || [], t = !e.memory || [o, s], n = !0, r = !0, u = i || 0, i = 0, a = l.length;
                            l && u < a;
                            u++
                        )
                    ...
                    p = {
                        add: function() {
                            if (l) {
                                var e = l.length
                                f(arguments), r ? (a = l.length) : t && !0 !== t && ((i = e), d(t[0], t[1]))
                            }
                            return this
                        },
                        remove: function() {
                            if (l)
                                for (var t = arguments, n = 0, i = t.length; n < i; n++)
                                    for (
                                        ...
                                        o < l.length &&
                                        (t[n] !== l[o] ||
                                            (r && o <= a && (a--, o <= u && u--), l.splice(o--, 1), !e.unique));
                                        o++
                                    );
                            return this
                        },
            ...
            o.extend({
                ...
                when: function(e) {
                    ...
                    function f(e) {
                        return function(t) {
                            ;(i[e] = arguments.length > 1 ? a.call(arguments, 0) : t), u.notifyWith(l, i)
                        }
                    }
                    if (r > 1) {
                        for (; n < r; n++)
                            ...
                            f &&
                                ...
                                window.getComputedStyle &&
                                    ...
                                    (e.reliableMarginRight =
                                        0 ===
                                        (parseInt(
                                            (window.getComputedStyle(u, null) || { marginRight: 0 }).marginRight,
                                            10
                                        ) || 0))),
                                void 0 !== p.style.zoom &&
                                    ((p.innerHTML = ''),
                                ...
                                window.getComputedStyle &&
                                    ((p.style.marginTop = '1%'),
                                    (e.pixelMargin =
                                        '1%' !== (window.getComputedStyle(p, null) || { marginTop: 0 }).marginTop)),
                    ...
                    if ('string' == typeof (n = e.getAttribute(r))) {
                        try {
                            n =
                                'true' === n ||
                                ('false' !== n &&
                                    ('null' === n ? null : o.isNumeric(n) ? +n : u.test(n) ? o.parseJSON(n) : n))
                        } catch (i) {}
                        o.data(e, t, n)
                    } else n = void 0
                }
                        ...
                        if ((d && f[d] && (p || r || f[d].data)) || !l || void 0 !== n)
                            return (
                                ...
                                ('object' != typeof t && 'function' != typeof t) ||
                                    (r ? (f[d] = o.extend(f[d], t)) : (f[d].data = o.extend(f[d].data, t))),
                                (i = s = f[d]),
                                r || (s.data || (s.data = {}), (s = s.data)),
                                void 0 !== n && (s[o.camelCase(t)] = n),
                                p && !s[t] ? i.events : (l ? null == (a = s[t]) && (a = s[o.camelCase(t)]) : (a = s), a)
                            )
                    }
                },
                ...
                o.fn.extend({
                    data: function(e, t) {
                        var n,
                            ...
                            f = null
                        if (void 0 === e) {
                            if (this.length && ((f = o.data(u)), 1 === u.nodeType && !o._data(u, 'parsedAttrs'))) {
                        ...
                        for (; s--; )
                            (n =
                                ...
                                ((o.data(i[s], l, void 0, !0) || o.data(i[s], c, void 0, !0)) &&
                                    o.data(i[s], u, o.Callbacks('once memory'), !0))) && (a++, n.add(f))
            ...
            o.fn.extend({
                ...
                toggleClass: function(e, t) {
                    ...
                    return o.isFunction(e)
                        ...
                        : this.each(function() {
                              if ('string' === n)
                                  for (var i, s = 0, a = o(this), u = t, l = e.split(m); (i = l[s++]); )
                                  ...
                                  ('undefined' !== n && 'boolean' !== n) ||
                                      ...
                                      (this.className =
                                          this.className || !1 === e ? '' : o._data(this, '__className__') || ''))
                          })
                },
                hasClass: function(e) {
                    for (var t = ' ' + e + ' ', n = 0, r = this.length; n < r; n++)
                        if (1 === this[n].nodeType && (' ' + this[n].className + ' ').replace(v, ' ').indexOf(t) > -1)
                            return !0
                    return !1
                },
                val: function(e) {
                ...
                k ||
                    ...
                    (p = o.valHooks.button = {
                        get: function(e, t) {
                            var n
                            return (n = e.getAttributeNode(t)) && (g[t] ? '' !== n.nodeValue : n.specified)
                                ? n.nodeValue
                                : void 0
                        },
                        set: function(e, t, r) {
            ...
            ;(o.event = {
                    ...
                    if (y && (p = y.events)) {
                        for (t = o.trim(P(t || '')).split(' '), s = 0; s < t.length; s++)
                            if (((u = l = (a = E.exec(t[s]) || [])[1]), (c = a[2]), u)) {
                                ...
                                0 === v.length &&
                                    f !== v.length &&
                                    ((h.teardown && !1 !== h.teardown.call(e, c)) || o.removeEvent(e, u, y.handle),
                                    delete p[u])
                            } else for (u in p) o.event.remove(e, u + t[s], n, r, !0)
                        o.isEmptyObject(p) &&
                            ((g = y.handle) && (g.elem = null), o.removeData(e, ['events', 'handle'], !0))
                    }
                },
                        ...
                        if (
                            ...
                            if (
                                ...
                                if (
                                    ...
                                    !(f = o.event.special[g] || {}).trigger || !1 !== f.trigger.apply(n, t))
                                ) {
                                    if (((p = [[n, f.bindType || g]]), !r && !f.noBubble && !o.isWindow(n))) {
                                        for (
                                            h = f.delegateType || g, u = O.test(h + g) ? n : n.parentNode, l = null;
                                            u;
                                            u = u.parentNode
                                        )
                                            p.push([u, h]), (l = u)
                                    ...
                                    for (a = 0; a < p.length && !e.isPropagationStopped(); a++)
                                        (u = p[a][0]),
                                            (e.type = p[a][1]),
                                            (d = (o._data(u, 'events') || {})[e.type] && o._data(u, 'handle')) &&
                                                d.apply(u, t),
                                            (d = c && u[c]) &&
                                                o.acceptData(u) &&
                                                !1 === d.apply(u, t) &&
                                ...
                                for (a in (i = o.cache))
                                    i[a].events && i[a].events[g] && o.event.trigger(e, t, i[a].handle.elem, !0)
                    }
                },
                dispatch: function(e) {
                            ...
                            for (
                                ...
                                (c = u.matches[n]),
                                    (g ||
                                        ...
                                        (e.handleObj = c),
                                        void 0 !==
                                            (s = ((o.event.special[c.origType] || {}).handle || c.handler).apply(
                                                u.elem,
                                                h
                                            )) &&
                ...
                (function() {
                    ...
                    var f = function(t, r, o, s) {
                        ...
                        if (x.length > 1 && h.exec(t))
                            ...
                            for (
                                l = (g = s
                                    ...
                                    : f.find(
                                          x.pop(),
                                          1 !== x.length || ('~' !== x[0] && '+' !== x[0]) || !r.parentNode
                                              ? r
                                              : r.parentNode,
                                          w
                                      )).expr
                        ...
                        if ((c || (c = l), c || f.error(v || t), '[object Array]' === i.call(c)))
                            if (b)
                                if (r && 1 === r.nodeType)
                                    for (y = 0; null != c[y]; y++)
                                        c[y] &&
                                            (!0 === c[y] || (1 === c[y].nodeType && f.contains(r, c[y]))) &&
                                            o.push(l[y])
                                else for (y = 0; null != c[y]; y++) c[y] && 1 === c[y].nodeType && o.push(l[y])
                    ...
                    ;(f.uniqueSort = function(e) {
                        ...
                        (f.filter = function(e, t, n, r) {
                            for (
                                var i, o, s, a, u, l, c, d, h, g = e, v = [], m = t, y = t && t[0] && f.isXML(t[0]);
                                e && t.length;
                    ...
                    var d = (f.getText = function(e) {
                            ...
                            } else for (t = 0; (n = e[t]); t++) 8 !== n.nodeType && (i += d(n))
                            return i
                        }),
                        p = (f.selectors = {
                            order: ['ID', 'NAME', 'TAG'],
                            ...
                            relative: {
                                ...
                                '': function(e, t, n) {
                                    var i,
                                        o = r++,
                                        s = x
                                    'string' != typeof t || c.test(t) || ((i = t = t.toLowerCase()), (s = w)),
                            ...
                            filter: {
                                PSEUDO: function(e, t, n, r) {
                                    ...
                                    if ('contains' === i)
                                        return (e.textContent || e.innerText || d([e]) || '').indexOf(t[3]) >= 0
                                    if ('not' === i) {
                    ...
                    n.documentElement.compareDocumentPosition
                        ...
                        : ((m = function(e, t) {
                              ...
                              for (var c = 0; c < n && c < r; c++) if (i[c] !== o[c]) return y(i[c], o[c])
                                    ...
                                    for (var r in ((f = function(t, r, i, o) {
                                        if (((r = r || n), !o && !f.isXML(r))) {
                                            ...
                                            if (9 === r.nodeType) {
                                                ...
                                                try {
                                                    if (!h || d)
                                                        return _(r.querySelectorAll("[id='" + c + "'] " + t), i)
                                                } catch (v) {
                                                } finally {
            ...
            o.fn.extend({
                ...
                o.extend({
                    ...
                    dir: function(e, t, n) {
                        for (
                            var r = [], i = e[t];
                            i && 9 !== i.nodeType && (void 0 === n || 1 !== i.nodeType || !o(i).is(n));
            ...
            function de(e) {
                ...
                'input' === t
                    ? fe(e)
                    : 'script' !== t && void 0 !== e.getElementsByTagName && o.grep(e.getElementsByTagName('input'), fe)
            }
            ;(oe.optgroup = oe.option),
                ...
                o.fn.extend({
                    ...
                    wrapAll: function(e) {
                        ...
                        if (this[0]) {
                            var t = o(e, this[0].ownerDocument)
                                .eq(0)
                                .clone(!0)
                            ...
                            l.length &&
                                o.each(l, function(e, t) {
                                    t.src
                                        ...
                                        : o.globalEval(
                                              (t.text || t.textContent || t.innerHTML || '').replace(ie, '/*$0*/')
                                          ),
                ...
                o.each(
                    ...
                    function(e, t) {
                        o.fn[e] = function(n) {
                            ...
                            if (s && 11 === s.nodeType && 1 === s.childNodes.length && 1 === i.length)
                ...
                o.extend({
                    clone: function(e, t, r) {
                        ...
                        if (
                            ...
                            for (le(e, u), i = ce(e), s = ce(u), a = 0; i[a]; ++a) s[a] && le(i[a], s[a])
                        if (t && (ue(e, u), r)) for (i = ce(e), s = ce(u), a = 0; i[a]; ++a) ue(i[a], s[a])
                        return (i = s = null), u
                    },
                    clean: function(e, t, r, i) {
                        ...
                        for (var c, f = 0; null != (c = e[f]); f++)
                            if (('number' == typeof c && (c += ''), c)) {
                                ...
                                if (!o.support.appendChecked)
                                    if (c[0] && 'number' == typeof (_ = c.length)) for (u = 0; u < _; u++) de(c[u])
                                    else de(c)
                        ...
                        if (r)
                            for (
                                ...
                                if (((a = l[f]), i && o.nodeName(a, 'script') && (!a.type || re.test(a.type))))
                    ...
                    cleanData: function(e) {
                        for (
                            ...
                            if ((!r.nodeName || !o.noData[r.nodeName.toLowerCase()]) && (n = r[o.expando])) {
                                if ((t = i[n]) && t.events) {
                                    for (var l in t.events) s[l] ? o.event.remove(r, l) : o.removeEvent(r, l, t.handle)
                    ...
                    style: function(e, t, n, r) {
                        if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                            ...
                            if (((t = o.cssProps[a] || a), void 0 === n))
                                return l && 'get' in l && void 0 !== (i = l.get(e, !1, r)) ? i : u[t]
                            if (
                                !('string' === (s = typeof n) &&
                                    (i = we.exec(n)) &&
            ...
            function Qe(e, t, n, r, i, o) {
                ...
                for (var s, a = e[i], u = 0, l = a ? a.length : 0, c = e === ze; u < l && (c || !s); u++)
                    'string' == typeof (s = a[u](t, n, r)) &&
                        (!c || o[s] ? (s = void 0) : (t.dataTypes.unshift(s), (s = Qe(e, t, n, r, s, o))))
            ...
            ;(Ce = qe.exec(Te.toLowerCase()) || []),
                ...
                o.extend({
                    ...
                    ajaxSetup: function(e, t) {
                        return t ? Xe(e, o.ajaxSettings) : ((t = e), (e = o.ajaxSettings)), Xe(e, t), e
                    },
                    ajaxSettings: {
                        url: Te,
                    ...
                    ajax: function(e, t) {
                        ...
                        function w(e, t, i, u) {
                            if (2 !== b) {
                                            ...
                                            ;(m = (function(e, t) {
                                                ...
                                                for (n = 1; n < p; n++) {
                                                    ...
                                                    if (((s = h), '*' === (h = f[n]))) h = s
                                                        ...
                                                        u ||
                                                            c ||
                                                            o.error('No conversion from ' + a.replace(' ', ' to ')),
                                                            !0 !== u && (t = u ? u(t) : c(l(t)))
                                                    }
                                                }
                                                return t
                                ...
                                ;(_.status = e),
                                    ...
                                    _.statusCode(v),
                                    (v = void 0),
                                    l && p.trigger('ajax' + (c ? 'Success' : 'Error'), [_, f, c ? m : y]),
                                    g.fireWith(d, [_, k]),
                                    l && (p.trigger('ajaxComplete', [_, f]), --o.active || o.event.trigger('ajaxStop'))
                            }
                        }
                        if (
                            (h.promise(_),
                            ...
                            (f.url = ((e || f.url) + '').replace(Le, '').replace(De, Ce[1] + '//')),
                            (f.dataTypes = o
                                .trim(f.dataType || '*')
                                .toLowerCase()
                                .split(He)),
                        ...
                        if (
                            ...
                            !f.hasContent &&
                                (f.data && ((f.url += (Re.test(f.url) ? '&' : '?') + f.data), delete f.data),
                                (n = f.url),
                                !1 === f.cache))
                        ) {
                            var x = o.now(),
                                k = f.url.replace(Be, '$1_=' + x)
                            f.url = k + (k === f.url ? (Re.test(f.url) ? '&' : '?') + '_=' + x : '')
                        }
                        ...
                        if (f.beforeSend && (!1 === f.beforeSend.call(d, _, f) || 2 === b)) return _.abort(), !1
                                        ...
                                        (t = function(n, s) {
                                            ...
                                            try {
                                                if (t && (s || 4 === a.readyState))
                                                    if (
                                                        ((t = void 0),
                                                        i && ((a.onreadystatechange = o.noop), et && delete Ge[i]),
                                                        s)
                                                    )
                            ...
                            if (
                                ...
                                o.isArray(n)
                                    ...
                                    : (h.animatedProperties[t] =
                                          (h.specialEasing && h.specialEasing[t]) || h.easing || 'swing'),
                                ('hide' === n && v) || ('show' === n && !v))
                            )
                ...
                (o.fx.prototype = {
                    ...
                    hide: function() {
                        ;(this.options.orig[this.prop] =
                            o._data(this.elem, 'fxshow' + this.prop) || o.style(this.elem, this.prop)),
                            (this.options.hide = !0),
                ...
                'getBoundingClientRect' in n.documentElement
                    ? function(e, t, n, r) {
                          ...
                          var i = t.body,
                              ...
                              l = s.pageYOffset || (o.support.boxModel && n.scrollTop) || i.scrollTop,
                              c = s.pageXOffset || (o.support.boxModel && n.scrollLeft) || i.scrollLeft
                ...
                (o.offset = {
                    ...
                    setOffset: function(e, t, n) {
                        ...
                        var i,
                            ...
                            f = {},
                            d = {}
                        ;('absolute' === r || 'fixed' === r) && o.inArray('auto', [l, c]) > -1
                            ...
                            function(e, r, i) {
                                ...
                                if (void 0 === i)
                                    return s
                                        ? t in s
                                            ? s[t]
                                            : (o.support.boxModel && s.document.documentElement[r]) ||
                                              s.document.body[r]
                                        : e[r]
                            ...
                            return o.access(
                                ...
                                function(e, t, s) {
                                    ...
                                    return o.isWindow(e)
                                        ...
                                        : void 0 === s
                                        ? ((l = o.css(e, t)), (c = parseFloat(l)), o.isNumeric(c) ? c : l)
                                        : void o(e).css(t, s)
                                },
                                t,
                                e,
        ...
        YFKU: function(e, t, n) {
            ...
            var p = n('cDf5'),
                ...
                g = n('JX7q')
            function v(e, t) {
                return !t || ('object' !== h()(t) && 'function' != typeof t) ? Object(g.a)(e) : t
            }
            function m(e) {
                                            ...
                                            for (var T in g)
                                                if (Object.prototype.hasOwnProperty.call(g, T)) {
                                                    var C = ''
                                                        ...
                                                        .concat(i)
                                                        .concat(T)
                                                    ;(S[T] = this.translate(C, l({}, t, { joinArrays: !1, ns: u }))),
                                                        S[T] === C && (S[T] = g[T])
                                                }
                                            g = S
                                        }
                                    ...
                                    if (this.i18nFormat && this.i18nFormat.parse)
                                        ...
                                        n.interpolation &&
                                            this.interpolator.init(
                                                l({}, n, {
                                                    interpolation: l({}, this.options.interpolation, n.interpolation)
                                                })
                                            )
                                        var s,
                                            a =
                                                        ...
                                                        p.forEach(function(n) {
                                                            if (!s.isValidLookup(t)) {
                                                                ...
                                                                if (s.i18nFormat && s.i18nFormat.addLookupKeys)
                                                                    ...
                                                                    f && (o = s.pluralResolver.getSuffix(n, a.count)),
                                                                        f && d && p.push(c + o),
                                                                        d &&
                                                                            p.push(
                                                                                (c += ''
                                        ...
                                        if (void 0 === (o = c(i[1].trim())))
                                            if ('function' == typeof f) {
                                                ...
                                                this.logger.warn(
                                                    ...
                                                    (o = '')
                                        else 'string' == typeof o || this.useRawValueToEscape || (o = S(o))
                                        if (
                                            ((e = e.replace(i[0], l(o))),
                    ...
                    d(t, [
                        {
                            ...
                            value: function(e, t, n, r) {
                                ...
                                return (
                                    ...
                                    (o.length || s.length) &&
                                        this.queue.push({ pending: s, loaded: {}, errors: [], callback: r }),
                            ...
                            value: function(e, t, n, r, i) {
                                ...
                                !this.services.utils.hasLoadedNamespace(t)
                                    ...
                                    : null != n &&
                                      ...
                                      (this.backend &&
                                          this.backend.create &&
                                          this.backend.create(e, t, n, r, null, l({}, o, { isUpdate: i })),
                ...
                J = new ((function(e) {
                    function t() {
                        ...
                        if (
                            ...
                            if (!e.options.initImmediate) return e.init(n, r), v(e, Object(g.a)(e))
                            setTimeout(function() {
                                e.init(n, r)
                            }, 0)
                        }
                        ...
                        d(t, [
                            {
                                ...
                                value: function() {
                                    ...
                                    return (
                                        this.options.resources || !this.options.initImmediate ? u() : setTimeout(u, 0),
                                        a
                                    )
                                }
                            },
                                ...
                                value: function(e, t) {
                                    var n = this,
                                        r = function e(t, r) {
                                            ...
                                            if ('object' !== a(r)) {
                                                for (
                                                    var o = arguments.length, s = new Array(o > 2 ? o - 2 : 0), u = 2;
                                                    u < o;
                                                    u++
                                                )
                                                    s[u - 2] = arguments[u]
            ...
            if (!ee.__tradingviewI18nextInited) {
                var te = window.language || null,
                    ne = se(te)
                ;(te && ne) || (console.error('No translation data'), (te = 'en'), (ne = se('en')))
                var re = (function(e) {
                    return G[e] || e
                })(te)
                if (te && ne) {
            ...
            !(function(e) {
                ...
                function _(e, t) {
                    ...
                    if (
                        ...
                        (this.method =
                            ((n = t.method || this.method || 'GET'), (r = n.toUpperCase()), l.indexOf(r) > -1 ? r : n)),
            ...
            e.exports = {
                set:
                    ...
                    ('__proto__' in {}
                        ? (function(e, t, r) {
                              try {
                                  ;(r = n('hvJ5')(Function.call, n('/Hub').f(Object.prototype, '__proto__').set, 2))(
                                      e,
                                      []
                                  ),
            ...
            ;(r = jQuery),
                ...
                (s = function(e) {
                    ...
                    t.localScroll
                        ...
                        : i.scrollTop() > o.height() - i.innerHeight() - (t.tolerance || 190) &&
                          r(this).trigger('scrolltoend')
                }),
                                        ...
                                        if (!t) {
                                            ...
                                            return !(
                                                ...
                                                ((this._mouseStarted = !1 !== this._mouseStart(n)), !this._mouseStarted)
                                                    ? (n.preventDefault(), 0)
                                                    : (!0 ===
                                                          e.data(n.target, this.widgetName + '.preventClickEvent') &&
                                                          e.removeData(
                                                              n.target,
            ...
            !(function(i) {
                ...
                function f(e, t, n, r) {
                    ...
                    if (o < i.length) {
                        if (1 === n) r = i[o] >= 5
                            ...
                            r = i[o] > 5 || (5 == i[o] && (r || o < 0 || void 0 !== i[o + 1] || 1 & i[o - 1]))
                        else if (3 === n) r = r || !!i[0]
                ...
                function d(e, t, n, r) {
                    ...
                    if (void 0 !== n) {
                        ...
                        for (
                            n = r - (e = new s(e)).e, e.c.length > ++r && f(e, n, s.RM), 2 == t && (r = e.e + n + 1);
                            e.c.length < r;
                ...
                ;(l.abs = function() {
                    ...
                    (l.div = function(e) {
                        ...
                        do {
                            ...
                            ;(_[w++] = d ? c : ++c), m[0] && d ? (m[y] = r[g] || 0) : (m = [r[g]])
                        } while ((g++ < v || void 0 !== m[0]) && o--)
                        return _[0] || 1 == w || (_.shift(), b.e--), w > x && f(b, s, n.RM, void 0 !== m[0]), b
                    }),
                    (l.eq = function(e) {
                        return !this.cmp(e)
                    }),
                    ...
                    (l.minus = l.sub = function(e) {
                        ...
                        var l = o.c.slice(),
                            ...
                            f = e.c,
                            d = e.e
                        if (!l[0] || !f[0]) return f[0] ? ((e.s = -u), e) : new s(l[0] ? o : 0)
                        if ((a = c - d)) {
                            for ((i = a < 0) ? ((a = -a), (r = l)) : ((d = c), (r = f)), r.reverse(), u = a; u--; )
                                r.push(0)
                            r.reverse()
                        } else
                            for (n = ((i = l.length < f.length) ? l : f).length, a = u = 0; u < n; u++)
                                if (l[u] != f[u]) {
                                    i = l[u] < f[u]
                                    break
                                }
                        if ((i && ((r = l), (l = f), (f = r), (e.s = -e.s)), (u = (n = f.length) - (t = l.length)) > 0))
                            for (; u--; ) l[t++] = 0
                        for (u = t; n > a; ) {
                            if (l[--n] < f[n]) {
                                for (t = n; t && !l[--t]; ) l[t] = 9
                    ...
                    (l.plus = l.add = function(e) {
                        ...
                        if (((a = a.slice()), (i = s - u))) {
                            for (i > 0 ? ((u = s), (t = l)) : ((i = -i), (t = a)), t.reverse(); i--; ) t.push(0)
                            t.reverse()
                        }
                        for (a.length - l.length < 0 && ((t = l), (l = a), (a = t)), i = l.length, o = 0; i; a[i] %= 10)
                    ...
                    (l.times = l.mul = function(e) {
                        ...
                        for (u = a; u--; ) {
                            for (a = 0, l = s + u; l > u; )
                                (a = t[l] + o[u] * i[l - u - 1] + a), (t[l--] = a % 10), (a = (a / 10) | 0)
                            t[l] = (t[l] + a) % 10
                        }
                ...
                'undefined' != typeof window
                    ...
                    (t.deepEquals = function(e, r, i) {
                        ...
                        if (Array.isArray(e) && Array.isArray(r)) {
                            ...
                            for (var a = 0; a < s; a++) {
                                if (!(l = t.deepEquals(e[a], r[a], i + '[' + a + ']'))[0]) return l
                            }
                            return [!0, i]
                        }
                        ...
                        for (var u in e) {
                            var l
                            if (!(l = t.deepEquals(e[u], r[u], i + '[' + u + ']'))[0]) return l
                        }
                        return [!0, i]
                    }),
