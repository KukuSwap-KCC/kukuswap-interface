                                    ...
                                    resize: function(e) {
                                        ...
                                        d[0] !== document && /static/.test(d.css('position')) && (p = h),
                                            l.left < (r._helper ? h.left : 0) &&
                                                ((r.size.width =
                                                    r.size.width +
                                                    (r._helper ? r.position.left - h.left : r.position.left - p.left)),
                                            ...
                                            (i = Math.abs(
                                                r.sizeDiff.width +
                                                    (r._helper ? r.offset.left - p.left : r.offset.left - h.left)
                                            )),
                                            (s = Math.abs(
                                                r.sizeDiff.height +
                                                    (r._helper ? r.offset.top - p.top : r.offset.top - h.top)
                                            )),
                                ...
                                t.extend(i.prototype, {
                                    ...
                                    _checkOffset: function(e, i, s) {
                                        ...
                                        return (
                                            ...
                                            (i.top -=
                                                s && i.top === e.input.offset().top + a ? t(document).scrollTop() : 0),
                                            (i.left -= Math.min(
                                                i.left,
                                    ...
                                    parseDate: function(e, i, s) {
                                        ...
                                        if (
                                            ...
                                            for (m = 1, _ = v; !(_ <= (o = this._getDaysInMonth(g, m - 1))); )
                                                m++, (_ -= o)
                                        if (
                                            (a = this._daylightSavingAdjust(new Date(g, m - 1, _))).getFullYear() !==
                                                g ||
                                            a.getMonth() + 1 !== m ||
                                            a.getDate() !== _
                                        )
