            ...
            ;(function(t) {
                ...
                var v = [],
                    g = {
                        ...
                        ajaxErrorTemplate:
                            '<div class="tv-dialog__error js-dialog__close">' + window.t('Error') + '</div>'
                    }
                                    ...
                                    o.opened &&
                                        ...
                                        $(document).on('click.tv-popup-' + i, function(t) {
                                            if (!o._preventClick) {
                                                ...
                                                ;(o.options.closeOnClickAtOtherDialogs || 0 === e.length) &&
                                                    o.isEventOut(t) &&
                                                    o.close()
                                            }
                                        }))
                        ...
                        },
                        {
                            ...
                            value: function() {
                                ...
                                s || this.$scrollWrapInner.css('top', 0),
                                    ...
                                    this.$actions &&
                                        this.$actions.toggleClass('tv-dialog__section--actions_with-border', s)
                            }
                        },
                        {
                            key: 'updateScroll',
                        ...
                        function o() {
                            ...
                            for (
                                n.options.addClass && n.$el.addClass(n.options.addClass),
                                    ...
                                    n.options.title &&
                                        (n.$title = $(
                                            t.render(n.options.titleTemplate, { title: n.options.title })
                                        ).appendTo(n.$el)),
                                ...
                                n.on('afterOpen', function() {
                                    n.$el.focus(),
                                        n.options.focusFirstControl &&
                                            ...
                                            (
                                                n.firstFocusControl ||
                                                n.$el.find('input:not([type="hidden"]), textarea').first()
                                            ).focus()
                                }),
                                        ...
                                        g && g !== this && g.unfocus(),
                                            ...
                                            setTimeout(function() {
                                                b.on('mousedown.tv-dialog-unfocus-' + t._id, function(e) {
                                                    t.isEventOut(e) &&
                                                        (t.unfocus(), b.off('mousedown.tv-dialog-unfocus-' + t._id))
                                                })
                                            }, 20)
                                    }
                                },
                                ...
                                },
                                {
                                    ...
                                    value: function(t) {
                                        if (!this.disabledActions.includes(t) && !this.loadingActions.includes(t)) {
                                            for (
                                                var e = arguments.length, o = Array(e > 1 ? e - 1 : 0), n = 1;
                                                n < e;
                                                n++
                                            )
                                                o[n - 1] = arguments[n]
