                ...
                o = (function() {
                    ...
                    return (
                        ...
                        (e.prototype.renderer = function() {
                            ...
                            for (var e = new n.CompositeRenderer(), t = 0, i = this._data; t < i.length; t++) {
                                var r = i[t],
                                                    ...
                                                    a.forEach(function(a) {
                                                        ...
                                                        ;(!a.extendRight && Math.max(n, h) < o) ||
                                                            ...
                                                            e._data.push({
                                                                ...
                                                                left: a.extendLeft ? void 0 : i.indexToCoordinate(n),
                                                                right: a.extendRight ? void 0 : i.indexToCoordinate(h),
                                                                color: u.color.value(),
        ...
        Gj0v: function(e, t, i) {
                        ...
                        for (
                            var i = this._data,
                                r = function(r) {
                                    ...
                                    for (var o = p(r.xRange), l = 0, u = r.bars; l < u.length; l++) {
                                        var h = u[l],
                                        ...
                                        a += h.height
                                        for (
                                            var R = Math.max((d.percentWidth * o) / 100 - h.subBarValues.length, 0),
                                                y = 0;
                                            ...
                                            var x = _.min,
                                                b = _.max,
                                                w = 0 === y ? v : v + g * ((R * h.subBarValues[y - 1]) / s),
                                            ...
                                            if (
                                                ...
                                                return { value: new n.HitTestResult(n.HitTestResult.REGULAR) }
                                        }
                                    }
                                },
                                a = 0,
                        ...
                        e.save(),
                            i.histograms.forEach(function(r) {
                                ...
                                var l,
                                    h,
                                    d = o / r.bars.length,
                                    c = ((l = d), (h = t.pixelRatio), Math.floor(l * h) >= 1 * h ? Math.floor(h) : 0),
                                    v = p(r.xRange),
                                    g = []
                                if (
                                    (r.bars.forEach(function(o) {
                                        ...
                                        if (l.visible) {
                                            ...
                                            var h = m(r.xRange, l, t.cssWidth),
                                                ...
                                                p = h.sign,
                                                y = f(n, n + o.height)
                                            if (((n += o.height), !(y.min > t.cssHeight || y.max < 0))) {
                                                var x = Math.max((l.percentWidth * v) / 100 - o.subBarValues.length, 0)
                                                for (u = 0; u < o.subBarValues.length; u++) {
                                                    var b = y.min,
                                                        w = y.max,
                                                        T = 0 === u ? d : d + p * ((x * o.subBarValues[u - 1]) / s),
            ...
            function m(e, t, i) {
                ...
                if (n && o) (r = e.min), (a = 1)
                    ...
                    if (!s || !l)
                        throw new Error('Unknown location/direction values: ' + t.location + '/' + t.direction)
                    ;(r = i), (a = -1)
                }
            ...
            function R(e, t, i, r, a) {
                var n = Math.min(Math.round((1.7 * e) / a.length), Math.round(0.6 * p(t))),
                    s = r.direction === d.a.LeftToRight ? 'left' : 'right',
                    o = i.xBasePoint + 3 * i.sign,
                    u = t.min + 0.7 * p(t)
                return { text: a, color: r.valuesColor, fontSize: n, align: s, point: new l.Point(o, u) }
            }
            function y(e, t, i) {
                var r = i.text,
                    a = i.color,
                ...
                return (
                    ...
                    (e.prototype.renderer = function() {
                        ...
                        for (var t = 0, i = this._textData; t < i.length; t++) {
                            var r = i[t]
                            e.append(new o.TextRenderer(r, new n.HitTestResult(n.HitTestResult.REGULAR)))
                        }
                        return e
                    }),
                    ...
                    (e.prototype._prepareStyles = function() {
                        var e = Object.keys(Object(a.ensureDefined)(this._provider.graphicsInfo().hhists)),
                            t = this._provider.properties().graphics.hhists
                        this._rendererData.styles = {}
                        for (var i = 0, r = e; i < r.length; i++) {
                            var n = r[i],
                                s = Object(a.ensureDefined)(t.child(n)),
                                o = Object(x.generateColor)(s.colors[0].value(), s.transparencies[0].value()),
                                l = s.colors[1]
                                    ? Object(x.generateColor)(s.colors[1].value(), s.transparencies[1].value())
                                    : o
                    ...
                    (e.prototype._updateViewInternal = function() {
                        ...
                        var t = this._provider.priceScale(),
                            i = this._model.timeScale()
                        if (t && !t.isEmpty() && !i.isEmpty() && null !== this._provider.firstValue()) {
                                    ...
                                    this._prepareStyles(),
                                        Object(a.ensureDefined)(r).forEach(function(r, a) {
                                            ...
                                            r.forEach(function(e) {
                                                ;(n = Math.min(n, e.firstBarTime)), (l = Math.max(l, e.lastBarTime))
                                            }),
                        ...
                        if (!(e.size <= 0)) {
                            ...
                            if (
                                ...
                                e.forEach(function(e) {
                                    ...
                                    u.push({ yRange: i, subBarValues: e.rate, styleId: e.styleId })
                                }),
                                    u.sort(function(e, t) {
                                        return e.yRange.min - t.yRange.min
                                    })
                                for (var h = [], d = u[0].yRange.min, c = 0, v = u; c < v.length; c++) {
                                    var p = v[c],
                                        g = p.yRange.max - d
