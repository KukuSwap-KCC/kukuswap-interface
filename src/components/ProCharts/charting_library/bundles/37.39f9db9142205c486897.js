                            ...
                            return n.createElement(
                                ...
                                S
                                    ? n.createElement(
                                          l.b,
                                          null,
                                          n.createElement(u.a, { onClose: this._handleClose, position: b }, h)
                                      )
                                    : n.createElement(
                                          a.a,
                                          {
        ...
        'ML8+': function(e, t, r) {
            ...
            function s(e) {
                var t,
                    r = e.dropped,
                    s = e.className
                return o.createElement(i.a, { className: n(s, a.icon, ((t = {}), (t[a.dropped] = r), t)), icon: c })
            }
        },
        QpNh: function(e, t, r) {
            'use strict'
            function o(e) {
                for (var t = {}, r = 0, o = Object.entries(e).filter(n); r < o.length; r++) {
                    var i = o[r],
                        a = i[0],
                        c = i[1]
                    t[a] = c
            ...
            function v(e) {
                ...
                return (
                    Object(o.useEffect)(function() {
                        var e
                        return (
                            null === (e = E.current) || void 0 === e || e.focus({ preventScroll: !0 }),
                            N.subscribe(b, r),
                            Object(s.setFixedBodyState)(!0),
                            d.CheckMobile.iOS() && Object(c.disableBodyScroll)(Object(i.ensureNotNull)(E.current)),
                            O(b.addDrawer()),
                            function() {
                                N.unsubscribe(b, r)
                                var e = b.removeDrawer()
                                d.CheckMobile.iOS() && Object(c.enableBodyScroll)(Object(i.ensureNotNull)(E.current)),
                    ...
                    n.a.createElement(
                        ...
                        n.a.createElement(
                            ...
                            g === b.currentDrawer && n.a.createElement('div', { className: h.backdrop, onClick: r }),
                            n.a.createElement(
                                'div',
                                {
                    ...
                    var r,
                        ...
                        T =
                            ...
                            ('string' == typeof s
                                ...
                                : n.cloneElement(s, { className: i(D.icon, s.props.className) }))
                    return n.createElement(
                        'div',
                        Object(o.a)({}, E, {
                            ref: t,
                        ...
                        m && f && n.createElement('div', { className: i('js-button-text', D.text) }, f),
                        T,
                        !m && f && n.createElement('div', { className: i('js-button-text', D.text) }, f)
                    )
                })
