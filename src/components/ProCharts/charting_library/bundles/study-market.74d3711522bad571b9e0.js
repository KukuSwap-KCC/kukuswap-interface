    ...
    ['study-market'],
    {
            ...
            var r = n('q1tI'),
                i = function(e, t) {
                    var n = void 0 === t ? {} : t,
                        ...
                        l = void 0 === c ? null : c
                    try {
                        return new window.CustomEvent(e, { bubbles: i, cancelable: o, detail: l })
                    } catch (u) {
                    ...
                    return (
                        ...
                        (t.prototype.render = function() {
                            ...
                            return (
                                ...
                                a.createPortal(i.createElement(u.Provider, { value: this }, this.props.children), e)
                            )
                        }),
        ...
        An2S: function(e, t, n) {
            ...
            function p(e) {
                ...
                return a.a.createElement('div', Object(r.a)({}, i, { className: p, 'data-role': 'dialog-sidebar' }))
            }
            function h(e) {
                return a.a.createElement('div', Object(r.a)({ className: u.wrapper }, e))
            }
            function f(e) {
                var t = e.mode,
                    n = e.title,
        ...
        Iivm: function(e, t, n) {
            ...
            const a = i.forwardRef((e, t) => {
                const { icon: n = '' } = e,
                    a = Object(r.e)(e, ['icon'])
                return i.createElement('span', Object.assign({}, a, { ref: t, dangerouslySetInnerHTML: { __html: n } }))
            })
            n.d(t, 'a', function() {
                return a
            })
        ...
        QHWU: function(e, t, n) {
            ...
            function p(e) {
                ...
                return a.a.createElement(
                    ...
                    i && a.a.createElement('div', { className: d.cancel, onClick: i }, Object(l.t)('Cancel'))
                )
            }
            function h(e) {
                var t = e.className,
        ...
        QpNh: function(e, t, n) {
            'use strict'
            function r(e) {
                for (var t = {}, n = 0, r = Object.entries(e).filter(i); n < r.length; n++) {
                    var a = r[n],
                        o = a[0],
                        c = a[1]
                    t[o] = c
                ...
                return a.a.createElement(
                    ...
                    a.a.createElement(
                        ...
                        a.a.createElement(
                            ...
                            n && a.a.createElement('div', { className: l()(w.ellipsis, w.subtitle) }, n)
                        ),
                        u,
                        o &&
                            !h &&
                    ...
                    return (
                        ...
                        (t.prototype.render = function() {
                            var e = this,
                                ...
                                F = 'after' !== s ? u : void 0,
                                z = 'after' === s ? u : void 0
                            return a.a.createElement(f.a, { rule: h.a.SmallHeight }, function(t) {
                                return a.a.createElement(f.a, { rule: h.a.TabletSmall }, function(s) {
                                    return a.a.createElement(
                                        d.a,
                                        {
                                            rounded: !(s || j) && D,
                                        ...
                                        a.a.createElement(
                                            'div',
                                            { className: C.wrapper, 'data-name': o, 'data-dialog-name': i },
                                            a.a.createElement(E, {
                                                draggable: S && !(s || j),
                                            ...
                                            y && a.a.createElement(p.a, { className: C.separator }),
        ...
        jPOK: function(e, t, n) {
            ...
            n('SzKR')
            function o(e) {
                var t = i('tv-spinner', 'tv-spinner--shown', 'tv-spinner--size_' + (e.size || a.a))
        ...
        mwqF: function(e, t, n) {
            ...
            function l(e) {
                const {
                    ...
                    b = o(c, { intent: n, size: l, appearance: s, disabled: u, useFullWidth: d, tabIndex: m, icon: h })
                return i.createElement(
                    'button',
                    Object.assign({ className: a(b, t), disabled: u, ref: p, tabIndex: m }, v),
        ...
        pr86: function(e, t, n) {
            ...
            function d(e) {
                ...
                return i.createElement(
                    o.a,
                    Object(r.a)({}, h, {
                        className: a(s.favorite, 'apply-common-tooltip', n && s.checked, d && s.active, t),
                        icon: n ? c : l,
                        onClick: p,
        ...
        zbLM: function(e, t, n) {
            ...
            function N(e) {
                ...
                return a.a.createElement(
                    'div',
                    Object(r.a)({ ref: t, className: _()(S.container, n) }, i, { 'data-role': 'dialog-content' })
                )
            }
            var j = n('cu5P')
            function k(e) {
                var t = e.children,
                    n = e.className,
                    r = e.disabled
                return a.a.createElement('span', { className: _()(j.title, r && j.disabled, n) }, t)
            }
                                ...
                                return e && n
                                    ? (n.forEach(function(e) {
                                          ...
                                          if (((e.fuzzyHighlight = !o), c))
                                              ...
                                              else for (var h = 0; h < c[0].length; h++) r[c.index + h] = !0
                                      }),
                                      r)
                                    : r
                            })(t, r, n)
                    ...
                    c.length
                        ? r.split('').map(function(e, t) {
                              return a.a.createElement(
                                  ...
                                  { key: t },
                                  c[t]
                                      ? a.a.createElement('span', { className: y(D.highlighted, o) }, e)
            ...
            function L(e) {
                var t = Object(i.useContext)(I),
                    ...
                    g = (null == t ? void 0 : t.toggleFavorite) ? K(t.toggleFavorite, o) : void 0,
                    y = C.CheckMobile.any() && q.isMobile,
                    w = Object(M.a)({ watchedValue: R.watchedTheme }) === F.a.Dark ? q.dark : q.light,
                    E = _()(q.container, o.isGrayed && q.disabled, s && q.selected, u && q.highlighted, u && w)
                return a.a.createElement(
                    'div',
                    {
                        ref: d,
                    ...
                    f &&
                        a.a.createElement(
                            'a',
                            { href: f.authorLink, className: q.author, target: '_blank', onClick: b },
                            f.authorName
                        ),
                    'mobile' !== r && f && a.a.createElement('span', { className: q.likes }, f.likesCount),
                    !1
                )
            }
            function K(e, t) {
            ...
            function X(e) {
                var t = e.reference,
                    ...
                    f = (function(e, t, n, r) {
                            ...
                            ),
                            {
                                ...
                                handleKeyDown: function(e) {
                                    var t = (function(e, t) {
                                        ...
                                        r = t[0],
                                        i = t[1]
                                    40 === Object(A.hashFromEvent)(e) && (e.preventDefault(), f(), b(i))
                                    38 === Object(A.hashFromEvent)(e) && (e.preventDefault(), m(), b(r))
                        ...
                        function b(e) {
                            null !== s.current && s.current.scrollTo && s.current.scrollTo(0, e)
                        }
                    })(r, h, c),
                    m = f.highlightedItem,
                    v = f.selectedItem,
                ...
                return (
                    Object(i.useEffect)(
                        function() {
                            var e
                            r || d(''), C.CheckMobile.any() || null === (e = S.current) || void 0 === e || e.focus()
                        },
                        [r]
                    ),
                                        ...
                                        I
                                            ...
                                            ? a.a.createElement(
                                                  ...
                                                  a.a.createElement(
                                                      H,
                                                      null,
                                                      a.a.createElement(B, { title: Object(l.t)('Script name') })
                                                  ),
                                                  h.map(function(e) {
                                            ...
                                            : a.a.createElement(J, {
                                                  ...
                                                  description: Object(l.t)('No indicators matched your criteria.')
                                              })
                                    )
                                )
                            )
                    ...
                    return (
                        ...
                        (e.prototype._applyStudy = function(e) {
                            var t,
                                ...
                                i = this
                            e.isGrayed
                                ? $.emit('onGrayedObjectClicked', { type: 'study', name: e.shortDescription })
                                : (C.CheckMobile.any() ||
                                      ...
                                      return Object(r.b)(this, void 0, void 0, function() {
                                          ...
                                          return Object(r.d)(this, function(r) {
                                              return 'java' === (i = t.descriptor).type &&
                                                  null !== (a = Object(u.tryFindStudyLineToolNameByStudyId)(i.studyId))
                        ...
                        return Object(r.b)(this, void 0, void 0, function() {
                            ...
                            return Object(r.d)(this, function(a) {
                                switch (a.label) {
                                    ...
                                    case 1:
                                        return (e = a.sent()), (this._studies = m(f(e.map(g)))), [3, 3]
                                    case 2:
                                        ;(t = a.sent().pineBuiltInStudies),
                                            (n = m(f(t.map(mapPineStudy), !1))),
                                            (this._studies = Object(r.a)(Object(r.a)({}, this._studies), n)),
                                            (a.label = 3)
                                    case 3:
                                        return (
                                            (i = Object(r.f)(
