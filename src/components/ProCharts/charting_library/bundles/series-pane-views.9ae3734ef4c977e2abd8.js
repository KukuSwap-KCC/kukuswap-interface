            ...
            inherit(_, h),
                ...
                (_.prototype._drawImpl = function(t) {
                    if (null !== this._data) {
                        ...
                        if (
                            ...
                            var c = _ + 8 + (i - s) / 2,
                                f = o(t, s)
                            if ((t.fillText(this._data.dateString, c + f, u + e + 8), this._data.timeString)) {
                                var T = o(t, n),
                                    v = _ + 8 + (i - n) / 2
                ...
                (u.prototype.updateImpl = function() {
                    ...
                    if (
                        ...
                        if (null != s) {
                            var o = this._series.priceScale().priceToCoordinate(i[TradingView.HIGH_PLOT], s),
                                l = this._series
                                    .model()
                                    .timeScale()
                                    .indexToCoordinate(t)
                            if (((this._point = new a(l, o)), this._gotoDateResult.eod)) this._eod = !0
                            else {
                                var d = this._series
                                    .model()
                                    .timeScale()
