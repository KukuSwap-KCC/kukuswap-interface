;(window.webpackJsonp = window.webpackJsonp || []).push([
    [4],
    {
        ...
        WXjp: function(t, e, n) {
                            ...
                            if (this._isFullscreen)
                                ...
                                ;(this._dialog.style.top = '0px'),
                                    ...
                                    (this._dialog.style.transform =
                                        'translate(' + Math.round(a) + 'px, ' + Math.round(s) + 'px)'),
            ...
            E['tooltip-offset']
            var S = { boundByScreen: !0, draggable: !0, centeredOnMount: !0 },
                x = (function(t) {
                    function e(e) {
                    ...
                    return (
                                ...
                                i.createElement(
                                    ...
                                    function(e) {
                                        return i.createElement(
                                            ...
                                            i.createElement(
                                                s.a,
                                                Object(o.a)({ style: t._applyAnimationCSSVariables() }, t.props, {
                                                    reference: t._handleDialogRef,
                                                    className: r(E.dialog, t.props.className)
                                                }),
                                                !1,
                                                t.props.children
                                            )
                        ...
                        (e.prototype.componentDidMount = function() {
                            ...
                            this.props.autofocus && !t.contains(document.activeElement) && t.focus(),
                                (this._isFullScreen() || this.props.fixedBody) && Object(y.setFixedBodyState)(!0),
                        ...
                        (e.prototype.componentDidUpdate = function() {
                            this._resize &&
                                ...
                                this._resize.setFullscreen(this._isFullScreen())),
                                this._drag &&
                                    this._drag.updateOptions({ boundByScreen: Boolean(this.props.boundByScreen) })
                        }),
                        (e.prototype.componentWillUnmount = function() {
                            this._drag && this._drag.destroy(),
                                this._resize && this._resize.destroy(),
                                (this._isFullScreen() || this.props.fixedBody) && Object(y.setFixedBodyState)(!1)
                        }),
                        ...
                        (e.prototype._applyAppearanceAnimation = function(t) {
                            if (this._resize && this._dialog) {
                                ...
                                this._dialog.style.setProperty('--animationTranslateStartX', e + 'px'),
                                    ...
                                    this._dialog.classList.add(E.dialogAnimatedAppearance)
                            }
                        }),
                    ...
                    return (
                        ...
                        (n.prototype.render = function() {
                            var e = this.props,
                                ...
                                a = e.root
                            if (!n) return null
                            var s = i.createElement(t, Object(o.a)({}, this.props, { zIndex: 150 }))
