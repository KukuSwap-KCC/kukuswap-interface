            ...
            !(function(e) {
                ...
                e.defineLocale('ru', {
                    ...
                    weekdays: function(e, t) {
                        ...
                        }[/\[ ?[Вв] ?(?:прошлую|следующую|эту)? ?\] ?dddd/.test(t) ? 'accusative' : 'nominative'][
                            e.day()
                        ]
                    },
            ...
            ;(function(e) {
                e.exports = (function() {
                    ...
                    function o(e, t) {
                        ...
                        return (
                            r(t, 'toString') && (e.toString = t.toString), r(t, 'valueOf') && (e.valueOf = t.valueOf), e
                        )
                    }
                    function d(e, t, n, i) {
                    ...
                    function S(e, t) {
                        return null !== t
                            ? ((t.abbr = e), (L[e] = L[e] || new Y()), L[e].set(t), T(e), L[e])
                            : (delete L[e], null)
                    }
                    function k(e) {
                        var t
                        ...
                        return (function(e) {
                            for (var t, n, i, a, s = 0; s < e.length; ) {
                                for (
                                    t = (a = g(e[s]).split('-')).length, n = (n = g(e[s + 1])) ? n.split('-') : null;
                                    t > 0;
                    ...
                    function We(e) {
                        if (e._f !== i.ISO_8601) {
                            ...
                            var t,
                                ...
                                d = o.length,
                                l = 0
                            for (a = I(e._f, e._locale).match(A) || [], t = 0; t < a.length; t++)
                                (s = a[t]),
                                    (n = (o.match(se(s, e)) || [])[0]) &&
                    ...
                    var ht = W('Hours', !0)
                    N('m', ['mm', 2], 0, 'minute'), O('minute', 'm'), ae('m', q), ae('mm', q, V), oe(['m', 'mm'], 4)
                    var ft = W('Minutes', !1)
                    N('s', ['ss', 2], 0, 'second'), O('second', 's'), ae('s', q), ae('ss', q, V), oe(['s', 'ss'], 5)
                    var yt,
                        Mt = W('Seconds', !1)
                    for (
                        N('S', 0, 0, function() {
                    ...
                    ;(Yt.add = et),
                        ...
                        (Yt.local = function(e) {
                            return (
                                this._isUTC &&
                                    (this.utcOffset(0, e), (this._isUTC = !1), e && this.subtract(Ve(this), 'm')),
                                this
                            )
                        }),
                    ...
                    ;(gt._calendar = {
                        ...
                        (i.lang = Me('moment.lang is deprecated. Use moment.locale instead.', T)),
                    ...
                    return (
                        ...
                        (Kt.as = function(e) {
                            ...
                            if ('month' === (e = H(e)) || 'year' === e)
                                return (
                                    (t = this._days + i / 864e5), (n = this._months + Ot(t)), 'month' === e ? n : n / 12
                                )
