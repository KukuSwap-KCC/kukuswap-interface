    ...
    ['symbol-info-dialog-impl'],
    {
        ...
        '1Z/g': function(e, t, n) {
            ...
            ;(function(e, r) {
                var o,
                    ...
                    v = n('Ialn'),
                    h = n('IWXC').getQuoteSessionInstance,
                    y = n('n5al').createSeriesFormatter,
                    w = n('w3Pp').marketType,
                ...
                function S(e) {
                    if (_(e)) return new c(e.pricescale / e.minmove2).format(e.minmove2 / e.pricescale)
                }
                function N(e) {
                    return void 0 === e.minmov || void 0 === e.pricescale ? null : y(e).format(e.minmov / e.pricescale)
                }
                function D(e) {
                ...
                function C(e) {
                    o || ((o = document.createElement('div')), document.body.appendChild(o)),
                    ...
                    b.reduce(function(e, n) {
                        ...
                        var i = r.reduce(function(e, t) {
                            var n = t.sessionStartDayOfWeek(),
                                ...
                                u = o ? g[n] : '',
                                c = i ? g[r] : '',
                                a = L(t.start()) + u + '-' + L(t.start() + t.length()) + c
                            return e.push(a), e
                        }, [])
                ...
                t.showSymbolInfoDialog = function(e, t) {
                    if ((C({ isOpened: !1 }), null == e && (e = i.symbol.value()), null != e)) {
                        e += ''
                        var n = t && t.symbolInfo,
                            u = [
                                {
                                    title: window.t('Symbol Name'),
                                    propName: r.enabled('charting_library_base') ? 'name' : 'pro_name'
                                },
                                { title: window.t('Symbol Description'), propName: 'description' },
                                { title: window.t('Symbol Type'), propName: 'type', getter: D },
                                { title: window.t('Current Contract'), propName: 'front_contract', visibility: k },
                                ...
                                { title: window.t('Pip Size'), propName: 'pip_size', getter: S, visibility: _ },
                                ...
                                { title: window.t('Timezone'), propName: 'timezone', formatter: T, visibility: E },
                                {
                        ...
                        if ((n && (c = j(n, u)), c < u.length)) {
                            ...
                            p.subscribe(s, e, function(t, n) {
                                j(n.values, u), p.unsubscribe(s, e), C(d)
                            })
                        }
                        var d = {
                            isOpened: !0,
                            onClose: function() {
                                C({ isOpened: !1 }), l.unmountComponentAtNode(o), (o = null)
                            },
                            fields: u
                        }
                        C(d)
        ...
        AVTG: function(e, t, n) {
            ...
            var r = n('q1tI'),
                ...
                c = n('Iivm')
            function a(e) {
                var t = e.hideIcon ? null : r.createElement(c.a, { className: i.close, icon: u, onClick: e.onClose })
        ...
        Iivm: function(e, t, n) {
            ...
            const i = o.forwardRef((e, t) => {
                const { icon: n = '' } = e,
                    i = Object(r.e)(e, ['icon'])
                return o.createElement('span', Object.assign({}, i, { ref: t, dangerouslySetInnerHTML: { __html: n } }))
            })
            n.d(t, 'a', function() {
                return i
            })
        ...
        QpNh: function(e, t, n) {
            'use strict'
            function r(e) {
                for (var t = {}, n = 0, r = Object.entries(e).filter(o); n < r.length; n++) {
                    var i = r[n],
                        u = i[0],
                        c = i[1]
                    t[u] = c
