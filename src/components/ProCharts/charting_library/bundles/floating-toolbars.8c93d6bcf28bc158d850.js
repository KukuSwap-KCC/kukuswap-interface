                    ...
                    return (
                        ...
                        (t.prototype._loadPosition = function() {
                            ...
                            if ('device' === this._options.positionStorageType) {
                                var e = v.TVLocalStorage.getItem(this._options.positionSettingsKey)
                                t = null !== e ? JSON.parse(e) : this._options.defaultPosition
                            } else
                                t = Object(a.getJSON)(this._options.positionSettingsKey, this._options.defaultPosition)
            ...
            var i = o('mrSG'),
                ...
                r = (function(t) {
                    function e(e, o, i) {
                        ...
                        return (n._baseProperty = e), (n._undoModel = o), (n._undoText = i), n
                    }
                    return (
                        Object(i.c)(e, t),
                                ...
                                return (
                                    ...
                                    (o.prototype._loadVisibilityState = function() {
                                        ...
                                        this._canBeShownValue.setValue(t),
                                            c.getBool('ChartFavoriteDrawingToolbarWidget.visible', !0) && t
                                                ? this.show()
                                                : this.hide()
                                    }),
                                    o
                        ...
                        return (
                            ...
                            (e.prototype.show = function() {
                                t.prototype.show.call(this),
                                    document.addEventListener('mousedown', this._onWindowClickedListener)
                            }),
                            (e.prototype.hide = function() {
                                t.prototype.hide.call(this),
                                    document.removeEventListener('mousedown', this._onWindowClickedListener)
                            }),
                            (e.prototype.destroy = function() {
                                    ...
                                    if (i.statedWidget.id === t)
                                        return (
                                            ...
                                            void 0 !== i.clickListener &&
                                                i.toolbarWidget.removeEventListener('click', i.clickListener),
                            ...
                            (e.prototype._createPopup = function(t) {
                                ...
                                t.statedWidget.states.forEach(function(n, r) {
                                    ...
                                    s.addEventListener('click', a),
                                        ...
                                        s.classList.add(
                                            'tv-grouped-floating-toolbar__sub-widget--slide-left-' + (i - r + 1)
                                        ),
        ...
        tPkB: function(t, e, o) {
            ...
            ;(function(e, i) {
                var n = o('ogJP').notNull,
                    ...
                    S = (o('2uTr').appendEllipsis, o('6+QM').CollectibleWidthPropertyUndoWrapper)
                function T(t) {
                ...
                o('m/4m'),
                    ...
                    (T.prototype.onSourceChanged = function(t) {
                        if (
                            ...
                            if (1 === t.length) {
                                var e = t[0]
                                y(e) && e.isAvailableInFloatingWidget() && this.findSourceOnWidget(e)
                                    ? (!e.userEditEnabled() ||
                                      (!_(e.toolname) &&
                                          this.activeChartWidget()
                                              .model()
                    ...
                    (T.prototype._createWidthsButton = function(t, e) {
                        ...
                        if (
                            ...
                            ;(this._lineWidthsProperty = new S(new m(r), s, 'Set Line tool(s) line width')),
                                ...
                                (o = 1 === i.length ? window.t('Line tool width') : window.t('Line tool widths'))
                        } else {
                            if (!t || !t.visible()) return !0
                            ;(this._lineWidthsProperty = new m([t])), (o = window.t('Line tool width'))
                        }
                        var a = []
                        return (
                            [
                    ...
                    (T.prototype._createColorsButton = function(t, e) {
                        if (
                            ...
                            this._lineColorsProperty = new W(new C(i), r, 'Set Line tool(s) color')
                        } else {
                            if (!t || !t.visible()) return !0
                        ...
                        return (
                            (this._$colorsButtons = this.colorPropertyControl(
                                this._lineColorsProperty,
                                { title: window.t('Line tool colors'), iconSvgCode: G, name: 'Set multiple colors' },
                                null
                            )),
                    ...
                    (T.prototype._createBackgroundsButton = function(t, e) {
                        if (
                            ...
                            var i = o
                                    ...
                                    .filter(n),
                                r = this.activeChartWidget().model()
                            this._backgroundsProperty = new W(new C(i), r, 'Set Line background(s) color')
                        } else {
                            if (!t || !t.visible()) return !0
                    ...
                    (T.prototype._createTextColorsButton = function(t, e) {
                        if (
                            ...
                            var i = o
                                    ...
                                    .filter(n),
                                r = this.activeChartWidget().model()
                            this._textColorsProperty = new W(new C(i), r, 'Set Line tool(s) text color')
                        } else {
                            if (!t || !t.visible()) return !0
                    ...
                    (T.prototype._getPossibleProperty = function(t, e) {
                        for (var o = [], i = this._defaultToolProperties(), n = 0; n < i.length; n++) {
                            var r = i[n]
                    ...
                    (T.prototype.showPropertiesOf = function(t, e, o) {
                        ...
                        if ((this._clearProperties(), (this._propertiesVisible = !1), i.length)) {
                            for (var n = {}, r = i.length - 1; r >= 0; --r) {
                                for (var s = i[r], a = e, l = s.name.split('.'), d = 0; d < l.length; ++d)
                                    a = a && a[l[d]]
                                var c = s.showIf
                                if ('function' != typeof c || c(a, e)) {
                                    ...
                                    s.simple
                                        ...
                                        s.propertyProxy && (a = s.propertyProxy(e, this.activeChartWidget().model())),
                                        (n[s.name] = a),
                                        a.subscribe(this, this._onPropertyChanged.bind(this, s.name, a)),
                                        this._floatingToolbar.addGroupedWidget(
                                            {
                                                id: s.name,
                    ...
                    (T.prototype._clearProperties = function() {
                        ;-1 !== this._floatingToolbar.findGroupedWidget('linewidth') &&
                            ...
                            this._$backgroundsButtons &&
                                (this._floatingToolbar.removeWidget(this._$backgroundsButtons[0]),
                                delete this._$backgroundsButtons),
                            this._$textColorsButtons &&
                                (this._floatingToolbar.removeWidget(this._$textColorsButtons[0]),
                ...
                ;(T.prototype._defaultToolProperties = function() {
                    ...
                    (T.prototype._riskPropertiesExceptionCases = function() {
                        return [
                            { name: 'textcolor', title: $.t('Text color'), inputType: 'colorPicker', iconSvgCode: Z },
                            {
                            ...
                            { name: 'linecolor', title: $.t('Border color'), inputType: 'colorPicker', iconSvgCode: G }
                        ]
                    }),
                    (T.prototype._rangeExceptionCases = function() {
                        return [
                            { name: 'linecolor', inputType: 'colorPicker', iconSvgCode: G, title: K },
                            {
                    ...
                    (T.prototype._textPropertiesExceptionCases = function() {
                        return [
                            { name: 'color', title: $.t('Text color'), inputType: 'colorPicker', iconSvgCode: Z },
                            {
                                name: 'backgroundColor',
                                title: $.t('Background Color'),
                                inputType: 'colorPicker',
                    ...
                    (T.prototype._trackContextAction = function(t) {
                        ...
                        const o =
                            null ===
                                this.activeChartWidget()
                                    .model()
                                    .lineBeingCreated() && l.toolIsCursor(e)
                                ? 'Context action on drawings'
                                : 'Context action before finishing drawings'
                        b('GUI', o, t)
                    }),
                    (T.prototype._createToolExceptionCases = function() {
                        return {
                            ...
                            LineToolRiskRewardLong: T.prototype._riskPropertiesExceptionCases(),
                            LineToolRiskRewardShort: T.prototype._riskPropertiesExceptionCases(),
                            LineToolBarsPattern: [
                                { name: 'color', title: K, inputType: 'colorPicker', iconSvgCode: U }
                            ],
                            LineToolProjection: [
                                {
                                    name: 'color1',
            ...
            var i = o('mrSG'),
                ...
                s = (function(t) {
                    function e(e) {
                        ...
                        return (o._listenersMappers = []), (o._isProcess = !1), (o._baseProperty = e), o
                    }
                    return (
                        Object(i.c)(e, t),
                        (e.prototype.destroy = function() {
                        ...
                        (e.prototype.subscribe = function(t, e) {
                            ...
                            this._listenersMappers.push(n), this._baseProperty.subscribe(t, i)
                        }),
