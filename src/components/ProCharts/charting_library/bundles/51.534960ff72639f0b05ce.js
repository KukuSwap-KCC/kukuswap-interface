    ...
    [51],
    {
        ...
        'MP+M': function(o, e, l) {
            ...
            var i = l('+GxX'),
                ...
                c = l('Ijvb'),
                s = l('0qMc'),
                t = { keys: ['Shift'], text: window.t('{0} — drawing a straight line at angles of 45') },
                r = { keys: ['Shift'], text: window.t('{0} — circle') },
                T = { keys: ['Shift'], text: window.t('{0} — square') },
                d = {
                    ...
                    LineToolImage: { icon: '', localizedName: s.lineToolsLocalizedNames.LineToolImage },
                    LineToolFlatBottom: {
                    ...
                    LineToolGannSquare: {
                        ...
                        hotKey: Object(n.b)({ keys: ['Shift'], text: window.t('{0} — fixed increments') })
                    },
                    ...
                    LineToolRectangle: {
                        ...
                        hotKey: Object(n.b)({ keys: ['Shift'], text: window.t('{0} — square') })
                    },
                    ...
                    arrow: { icon: c.a.arrow, localizedName: window.t('Arrow') },
                    cursor: { icon: c.a.cursor, localizedName: window.t('Cross') },
                    dot: { icon: c.a.dot, localizedName: window.t('Dot') },
                    drawginmode: {
                        icon: c.a.drawginmode,
                        iconActive: c.a.drawginmodeActive,
                        localizedName: window.t('Stay in Drawing Mode')
                    },
                    eraser: { icon: c.a.eraser, localizedName: window.t('Eraser') },
                    group: { icon: c.a.group, localizedName: window.t('Show Hidden Tools') },
                    hideAllDrawings: {
                        icon: c.a.hideAllDrawings,
                        iconActive: c.a.hideAllDrawingsActive,
                        localizedName: window.t('Hide All Drawing Tools'),
                        hotKey: Object(n.b)({ keys: ['Ctrl', 'Alt', 'H'], text: '{0} + {1} + {2}' })
                    },
                    lockAllDrawings: {
                    ...
                    magnet: {
                        ...
                        hotKey: Object(n.b)({ keys: ['Ctrl'], text: '{0}' })
                    },
                    measure: {
                        icon: c.a.measure,
                        localizedName: window.t('Measure'),
                        hotKey: Object(n.b)({ keys: ['Shift'], text: window.t('{0} + Click on the chart') })
                    },
                    removeAllDrawingTools: {
                        icon: c.a.removeAllDrawingTools,
                        localizedName: window.t('Remove Drawings')
                    },
                    showObjectsTree: { icon: c.a.showObjectTree, localizedName: window.t('Show Object Tree') },
                    zoom: { icon: c.a.zoom, localizedName: window.t('Zoom In') },
                    'zoom-out': { icon: c.a['zoom-out'], localizedName: window.t('Zoom Out') }
                }
        ...
        b2d7: function(o, e, l) {
            ...
            !(function(o) {
                function e() {
                    ;(o.favorites = []),
                        Object(s.getJSON)('chart.favoriteDrawings', []).forEach(function(e) {
                            o.favorites.push(e.tool || e)
                        }),
                        o.favoritesSynced.fire()
                }
                ;(o.favorites = []),
                    (o.favoritesSynced = new c.a()),
                    (o.favoriteIndex = function(e) {
                        return o.favorites.indexOf(e)
                    }),
                    (o.saveFavorites = function() {
                        Object(s.setJSON)('chart.favoriteDrawings', o.favorites)
                    }),
                    e(),
                    s.onSync.subscribe(null, e)
            })(i || (i = {})),
                (function(o) {
                    function e() {
                    ...
                    ;(o.favoriteAdded = new c.a()),
                        (o.favoriteRemoved = new c.a()),
                        (o.favoriteMoved = new c.a()),
                        ...
                        (o.addFavorite = function(e) {
                            return !l(e) && (i.favorites.push(e), i.saveFavorites(), o.favoriteAdded.fire(e), !0)
                        }),
                        (o.removeFavorite = function(e) {
                            var l = i.favoriteIndex(e)
                            return (
                                -1 !== l && (i.favorites.splice(l, 1), i.saveFavorites(), o.favoriteRemoved.fire(e), !0)
                            )
                        }),
                        (o.isFavorite = l),
                        (o.moveFavorite = function(l, n) {
                            if (n < 0 || n >= e()) return !1
                            var a = i.favoriteIndex(l)
                            return (
                                -1 !== a &&
                                n !== a &&
                                (i.favorites.splice(a, 1),
                                i.favorites.splice(n, 0, l),
                                i.saveFavorites(),
                                o.favoriteMoved.fire(l, a, n),
                                !0)
                            )
                        })
                })(n || (n = {}))
