    ...
    ['export-data'],
    {
        SIoL: function(e, t, i) {
            ...
            var n = i('Eyy1'),
                ...
                s = i('k9/m'),
                l = i('23IT'),
                a = { includeTime: !0, includeUserTime: !1, includeSeries: !0, includedStudies: 'all' }
            function o(e, t) {
                var i
                void 0 === t && (t = {})
                var l = Object.assign({}, a, t),
                    ...
                    v = (function(e, t, i, l) {
                        ...
                        return (
                            Object(n.assert)(c <= u, 'Range must contain at least 1 time point'), new r.BarsRange(c, u)
                        )
                ...
                if (l.includeTime) for (y = m; y <= w; ++y) o.data[y - m][0] = Object(n.ensureNotNull)(u.valueAt(y))
                if (l.includeUserTime) {
                    var I = e.timeScale()
                    for (y = m; y <= w; ++y)
                        o.data[y - m][g] = Object(n.ensureNotNull)(I.indexToUserTime(y)).getTime() / 1e3
                }
                l.includeSeries &&
                    h
                        .bars()
                        ...
                        .each(function(e, t) {
                            var i = o.data[e - m]
                            return (
                                (i[b] = f(t[1])), (i[b + 1] = f(t[2])), (i[b + 2] = f(t[3])), (i[b + 3] = f(t[4])), !1
                            )
                        })
