                ...
                e.CompareTab = (function() {
                    function e(i, o) {
                        !(function(t, e) {
                            ...
                            (this._predefines =
                                this._chartWidgetCollection.activeChartWidget.value().compareSymbols() || []),
                            this.init()
                    }
                    return (
                        a(e, [
                                        ...
                                        o &&
                                            ...
                                            o.dataSources().forEach(function(i) {
                                                if (i._metaInfo && 'Compare@tv-basicstudies' === i._metaInfo.id) {
                                                    ...
                                                    ;(a === t || (e._symbolAlias[a] && e._symbolAlias[a] === t)) &&
                                                        o.removeSource(i)
                                                }
                                            }))
                                    }
                                                ...
                                                this._predefines.forEach(function(e) {
                                                    ...
                                                    o.forEach(function(e) {
                                                        if (
                                                            ...
                                                            ;(o === i ||
                                                                (t._symbolAlias[o] && t._symbolAlias[o] === i)) &&
                            ...
                            if (!this._options.noSlider) {
                                ...
                                if (
                                    ...
                                    if (d) {
                                        ...
                                        ;(l += parseInt(u.getPropertyValue('padding-left')) + d.offsetLeft),
                                            (c -= c - g(d))
                                    }
                                            ...
                                            Object(h.isRtl)() && e.reverse(),
                                                ...
                                                a().then(function() {
                                                    $.Velocity.animate(t._elScrollWrap, 'scroll', {
                                                        ...
                                                        easing: 'easeInOutCubic',
                                                        offset: Math.ceil(
                                                            i - s + g(Object(o.ensureDefined)(t._elArrowRight))
                                                        ),
                                                        queue: !1
                                                    })
                                                })
            ...
            function y(t, e, i, o) {
                ...
                if (!a) {
                    ...
                    if (
                        ...
                        for (var n = Array.prototype.slice.call(e.childNodes), r = 0; r < n.length; r++)
                            a.appendChild(n[r])
                        e.appendChild(a)
                    }
                }
