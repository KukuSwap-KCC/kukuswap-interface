                    ...
                    (h.prototype.switchTab = function(t, e) {
                        if (this._tabs) {
                            ...
                            if (
                                ...
                                'object' == typeof t &&
                                    $.each(this._tabs, function(e, a) {
                                        if (t === a || $(a.labelObject).is(t) || $(a.wrapperObject).is(t))
                                            return (i = a), !1
                                    }),
                                i || (i = this._tabs[~~t]),
                                !i)
                        ...
                        if (t.enabled('property_pages')) {
                            ...
                            if ((y && !y.widget().is(':empty')) || g) {
                                ...
                                var w,
                                    ...
                                    k = e.ownerDocument || this._model._chartWidget.widget().ownerDocument,
                                    D = c
                                        .createDialog(S, {
                                            hideTitle: !0,
                                ...
                                if (
                                    ...
                                    this._model.readOnly() ||
                                        ...
                                        y.widget().each(function(t, e) {
                                            ...
                                            TradingView.isNaN(r) &&
                                                (r = o ? p.TabPriority.Coordinates : p.TabPriority.Inputs)
                                            var n = ~~$(e).data('layout-tab-open'),
                                                s = $(e).data('layout-tab')
                                            void 0 === s && (s = o ? p.TabNames.coordinates : p.TabNames.inputs),
                                ...
                                $('.js-dialog').each(function() {
                                    ...
                                    D.css('z-index', I),
                                    (w = $('<div class="main-properties main-properties-aftertabs"></div>').appendTo(
                                        O
                                    )),
