    ...
    [50],
    {
                ...
                Object(o.useEffect)(
                    function() {
                        if (x) {
                            ...
                            e && (e.addEventListener('mousemove', T), e.addEventListener('mouseup', P))
                        } else O && O()
                        return function() {
                            var e = Object(c.ensureNotNull)(C.current).ownerDocument
                            e && (e.removeEventListener('mousemove', T), e.removeEventListener('mouseup', P))
                        }
                    },
                    [x]
                )
                ...
                return i.a.createElement(
                    'div',
                    {
                        ...
                        onMouseDown: function(e) {
                            ...
                            var n = a - r,
                                o = R(e.nativeEvent, Object(c.ensureNotNull)(C.current)) - E.current
                            o < 0
                                ? ((o = 0), (E.current = R(e.nativeEvent, Object(c.ensureNotNull)(C.current))))
                                : o > n * j * z &&
                                  ((o = n * j * z),
                                  (E.current = R(e.nativeEvent, Object(c.ensureNotNull)(C.current)) - o))
                            m(o / j / z), _(!0)
                        }
                    },
                    i.a.createElement(
                        'div',
                        {
                            ...
                            style:
                                ...
                                (n[v ? 'width' : 'height'] = N),
                                (n.transform = 'translate' + (v ? 'X' : 'Y') + '(' + (k * j * z || 0) + 'px)'),
                                n),
                            onMouseDown: function(e) {
                                e.preventDefault(),
                                    (E.current = R(e.nativeEvent, Object(c.ensureNotNull)(I.current))),
                                    _(!0)
                            }
                        },
                        i.a.createElement('div', { className: l()(b.barInner, v && b['barInner--horizontal']) })
                    )
                )
                function T(e) {
            ...
            function o() {
                ...
                return [
                    Object(r.useCallback)(
                        function(e) {
                            ;(e.width === (null == t ? void 0 : t.width) && e.height === t.height) || n(e)
                        },
                        [t]
                    ),
                    t
                ...
                return i.a.createElement(
                    ...
                    Object(r.a)({}, P, {
                        className: a(
                            ...
                            T.item,
                            O && T.withIcon,
                            ((t = {}), (t[T.isActive] = S), (t[T.isDisabled] = w || I), (t[T.hovered] = C), t)
                        ),
                        title: v,
                        href: x,
                        target: E,
                        ...
                        onContextMenu: function(t) {
                            var n = e.trackEventObject,
                                r = e.trackRightClick
                            n && r && Object(c.trackEvent)(n.category, n.event, n.label + '_rightClick')
                        },
                        onMouseUp: function(t) {
                            ...
                            if (1 === t.button && x && n) {
                                var o = n.label
                                r && (o += '_mouseWheelClick'), Object(c.trackEvent)(n.category, n.event, o)
                            }
                        },
                        onMouseOver: z,
                        onMouseOut: N
                    ...
                    void 0 !== O &&
                        i.a.createElement('div', { className: T.icon, dangerouslySetInnerHTML: { __html: O } }),
                    i.a.createElement(
                        'div',
                    ...
                    (void 0 !== b || g) &&
                        i.a.createElement('div', { className: T.shortcut }, (d = b) && d.split('+').join(' + ')),
                    void 0 !== j &&
                        i.a.createElement(
                            'div',
                            { onClick: h, className: a(T.toolbox, ((n = {}), (n[T.showOnHover] = _), n)) },
                            j
                        )
                )
            }
                ...
                return i.a.createElement(
                    ...
                    i.a.createElement(
                        ...
                        i.a.createElement(
                            ...
                            n && i.a.createElement('div', { className: c()(w.ellipsis, w.subtitle) }, n)
                        ),
                        u,
                        a &&
                            !h &&
                                ...
                                if (!e.defaultPrevented)
                                    switch ((t.props.onKeyDown && t.props.onKeyDown(e), Object(s.hashFromEvent)(e))) {
                                        case 27:
                                            ...
                                            if (null !== n) {
                                                if ((e.preventDefault(), E(n))) return void t._handleClose()
                    ...
                    return (
                        ...
                        (t.prototype.render = function() {
                            var e = this,
                                ...
                                D = 'after' !== s ? u : void 0,
                                A = 'after' === s ? u : void 0
                            return i.a.createElement(m.a, { rule: h.a.SmallHeight }, function(t) {
                                return i.a.createElement(m.a, { rule: h.a.TabletSmall }, function(s) {
                                    return i.a.createElement(
                                        d.a,
                                        {
                                            rounded: !(s || j) && k,
                                        ...
                                        i.a.createElement(
                                            'div',
                                            { className: I.wrapper, 'data-name': a, 'data-dialog-name': o },
                                            i.a.createElement(C, {
                                                draggable: _ && !(s || j),
                                            ...
                                            O && i.a.createElement(f.a, { className: I.separator }),
        ...
        gM3K: function(e, t, n) {
            ...
            function h(e) {
                ...
                var a = Object(o.useMemo)(
                    function() {
                        return n.split(new RegExp('(' + Object(s.regExpEscape)(t) + ')', 'i'))
                    },
                    [t]
                )
                return i.a.createElement(
                    ...
                    a.map(function(e, t) {
                        return t % 2
                            ? i.a.createElement('span', { key: t, className: l()(f.highlight, r && f.active) }, e)
            ...
            function m(e) {
                ...
                return i.a.createElement(
                    'a',
                    Object(r.a)({}, y, {
                        className: l()(f.itemRow, b && !g && f.active, w && f.mobile, g && f.selected),
                    ...
                    I &&
                        ...
                        i.a.createElement(u.a, {
                            className: l()(f.favoriteButton, O && f.favorite, c.CheckMobile.any() && f.mobile),
                            isActive: b && !g,
                            isFilled: O,
                    ...
                    i.a.createElement(
                        ...
                        i.a.createElement('div', { className: l()(f.details, b && !g && f.active, w && f.mobile) }, a)
                    ),
        ...
        'i/MG': function(e, t, n) {
            ...
            function u(e) {
                var t = e.className,
                    ...
                    v = Object(r.e)(e, ['className', 'isActive', 'onClick', 'title', 'hidden', 'data-name'])
                return o.createElement(
                    a.a,
                    Object(r.a)({}, v, {
                        'data-name': m,
                        className: i(c.button, 'apply-common-tooltip', n && c.active, f && c.hidden, t),
                        icon: l,
                        onClick: u,
                        title: d || s.remove
                    })
        ...
        iR1w: function(e, t, n) {
                ...
                if ((void 0 === e && (e = !1), null === h || e)) {
                    ...
                    return (
                        ...
                        t.scrollLeft > 0
                            ...
                            : ((t.scrollLeft = 1), (h = 0 === t.scrollLeft ? 'negative' : 'positive-ascending')),
                    ...
                    (n = t = (function(e) {
                            ...
                            return (
                                ...
                                (n._getItemStyle = function(e) {
                                    ...
                                    if (c.hasOwnProperty(e)) t = c[e]
                                        ...
                                        c[e] =
                                            (((s = { position: 'absolute' })['rtl' === i ? 'right' : 'left'] = h
                                                ? d
                                                : 0),
                                            (s.top = h ? 0 : d),
                                            (s.height = h ? '100%' : f),
                        ...
                        return (
                            ...
                            (n._getRangeToRender = function() {
                                ...
                                return [Math.max(0, l - s), Math.max(0, Math.min(t - 1, c + u)), l, c]
                            }),
                            t
                        )
                    })(s.PureComponent)),
            ...
            var b = function(e, t) {
                ...
                S = function(e, t, n, r) {
                    for (var o = e.itemCount, i = 1; n < o && g(e, n, t).offset < r; ) (n += i), (i *= 2)
                ...
                C = p({
                    ...
                    getOffsetForIndexAndAlignment: function(e, t, n, r, o) {
                        ...
                        switch (('smart' === n && (n = r >= h - s && r <= f + s ? 'auto' : 'center'), n)) {
                            case 'start':
                                return f
                            case 'end':
                                return h
                    ...
                    getStartIndexForOffset: function(e, t, n) {
                        return (function(e, t, n) {
                            ...
                            return (o > 0 ? r[o].offset : 0) >= n ? O(e, t, o, 0, n) : S(e, t, Math.max(0, o), n)
                        })(e, n, t)
                    },
                ...
                I = p({
                    ...
                    getOffsetForIndexAndAlignment: function(e, t, n, r) {
                        ...
                        switch (('smart' === n && (n = r >= h - u && r <= f + u ? 'auto' : 'center'), n)) {
                            case 'start':
                                return f
                            case 'end':
                                return h
