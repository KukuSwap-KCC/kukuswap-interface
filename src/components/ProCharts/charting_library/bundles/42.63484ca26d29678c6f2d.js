        ...
        '4Cm8': function(t, e, i) {
            ...
            function f(t) {
                ...
                return r.createElement('div', {
                    className: n(p.fadeLeft, ((e = {}), (e[p.isVisible] = t.isVisible), e))
                })
            }
            function w(t) {
                var e
                return r.createElement('div', {
                    className: n(p.fadeRight, ((e = {}), (e[p.isVisible] = t.isVisible), e))
                })
            }
            function m(t) {
                return r.createElement(v, Object(s.a)({}, t, { className: p.scrollLeft }))
            }
            function b(t) {
                return r.createElement(v, Object(s.a)({}, t, { className: p.scrollRight }))
            }
            function v(t) {
                var e
                return r.createElement(
                    ...
                    r.createElement(
                        ...
                        r.createElement(l.a, { icon: h, className: p.icon })
                    )
                )
            }
            var R,
                                ...
                                return r.createElement(
                                    ...
                                    r.createElement(
                                        ...
                                        r.createElement(
                                            ...
                                            l && r.createElement(_, { isVisible: b }),
                                            l && r.createElement(V, { isVisible: m }),
                                            a && r.createElement(R, { onClick: this._handleScrollLeft, isVisible: b }),
                                            a && r.createElement(S, { onClick: this._handleScrollRight, isVisible: m })
                                        )
                                    )
                                )
                            }),
