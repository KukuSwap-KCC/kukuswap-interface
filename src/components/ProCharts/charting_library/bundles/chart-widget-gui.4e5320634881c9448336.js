    ...
    ['chart-widget-gui'],
    {
        ...
        LVLx: function(t, e, i) {
            ...
            !(function(t) {
                ...
                for (
                    var i = 0, s = [Element.prototype, Document.prototype, DocumentFragment.prototype];
                    i < s.length;
                    i++
                ) {
                    var o = s[i]
        ...
        TGRH: function(t, e, i) {
            ...
            var s = i('Eyy1'),
                ...
                y = Object(a.b)({ keys: ['Alt', 'Click', 'Alt', 'Enter'], text: '{0} + {1}, {2} + {3}' }),
                ...
                k = (function() {
                    function t(t, e, i) {
                        ;(this._widget = Object(s.ensureNotNull)(Object(l.a)(M).querySelector('.control-bar-wrapper'))),
        ...
        sAH5: function(t, e, i) {
                    ...
                    function t(t, e, i) {
                        ...
                        ;(this._withActions = i.withActions),
                            ...
                            null !== this._valuesParentEl &&
                                (this._loader = new v(this._valuesParentEl, { className: m.loader })),
                            ...
                            this._withActions &&
                                ((this._showActionsHandler = Object(b.c)(this._showActions.bind(this))),
                                (this._hideActionsHandler = Object(b.c)(this._hideActions.bind(this))),
                                ...
                                null !== this._titleParentEl &&
                                    ...
                                    this._mouseEventHandlers.push(
                                        new _.MouseEventHandler(
                                            ...
                                            { treatVertTouchDragAsPageScroll: !1, treatHorzTouchDragAsPageScroll: !1 }
                                        )
                                    )),
                    ...
                    return (
                        ...
                        (t.prototype._renderActions = function() {
                            if (this._withActions) {
                                ...
                                for (
                                    ...
                                    var n = s[i],
                                        l = Object(p.a)(n, m.button, m.buttonIcon, w.blockHidden, e)
                                    t.appendChild(l)
                                }
                            }
                        }),
                        ...
                        (t.prototype._updateTitlesHandler = function(t, e) {
                            var i = Object(o.ensureNotNull)(this._titleElements[t]),
                                s = 0 === e.length
                            i.classList.toggle(w.blockHidden, s), i.classList.toggle(m.withDot, !s), f(i, e)
                        }),
                        ...
                        (t.prototype._updateValuesHTMLElHandler = function(t, e) {
                            f(Object(o.ensure)(this._valuesElements[t].value), e), this._updateShowValues()
                        }),
                        ...
                        (t.prototype._clearDesabledTimeout = function() {
                            null !== this._disableTimeout &&
                                (clearTimeout(this._disableTimeout), (this._disableTimeout = null))
                        }),
                        ...
                        (t.prototype._updateCustomTextColor = function() {
                            for (
                                var t = this._customTextColor.value() || '', e = 0, i = this._titleElements;
                                e < i.length;
                                e++
                            ) {
                                var s = i[e]
                            ...
                            for (
                                var n = Object(o.ensureNotNull)(this._valuesParentEl).querySelectorAll(
                                        '.' + m.valueTitle
                                    ),
                                    l = 0;
                                l < n.length;
                ...
                E = (function(t) {
                    function e(e, i, s) {
                        ...
                        return (
                            ...
                            o._updateStates(),
                            s.statusWidgetEl &&
                                o._addStatusesWidget(s.statusWidgetEl, s.hideInvisibleHover, s.hideValues),
                    ...
                    return (
                        ...
                        (e.prototype._renderValues = function() {
                            ...
                            for (
                                var t = Object(o.ensureNotNull)(this._valuesAdditionalWrapperEl),
                                    e = 0,
                                ...
                                n.classList.add(m.valueItem), n.classList.toggle(w.blockHidden, !s.visible.value())
                                var l = document.createElement('div'),
                                    a = s.title.value() || ''
                        ...
                        (e.prototype._updateValuesTitleHTMLElHandler = function(t, e) {
                            ...
                            f(i, e), i.classList.toggle(w.blockHidden, 0 === e.length), this._updateShowValues()
                        }),
                ...
                k = (function(t) {
                    ...
                    return (
                        ...
                        (e.prototype.destroy = function() {
                            t.prototype.destroy.call(this),
                                ...
                                null !== this._wheelClickHandler &&
                                    null !== this._titleParentEl &&
                                    this._titleParentEl.removeEventListener(V, this._wheelClickHandler)
                        }),
                        ...
                        (e.prototype._update5ButtonsStyles = function(t) {
                            null !== this._el &&
                                (this._el.classList.toggle(m.has5Buttons, t), this._updateAllButtonsWidth())
                        }),
                ...
                O = (function() {
                    function t(t, e, i) {
                        ;(this._el = null),
                            ...
                            (this._showObjectTreeHandler = Object(b.c)(i.onShowObjectsTreeDialog)),
                            null !== this._el &&
                    ...
                    return (
                                    ...
                                    n = function(o) {
                                        var n = t[o],
                                            a = new k(n, s, {
                                                ...
                                                hideInvisibleHover: j(e[o].visibleWidgetsCount, function(t) {
                                                    return Boolean(t)
                                                }),
                        ...
                        (t.prototype._renderToggle = function(t) {
                            this._options.showToggleButton &&
                                (this._renderToggler = new O(t, this._options.themedColor, this._togglerOptions))
                        }),
                    ...
                    return (
                        ...
                        (t.prototype.onShowSettings = function() {
                            this._source.userEditEnabled() &&
                                ...
                                this._callbacks.showChartPropertiesForSource(this._source, X.TabNames.style),
                        ...
                        (t.prototype._updateTitle = function() {
                            ...
                            if (null !== t)
                                for (var e = t.getSplitTitle(), i = 0; i < this._titles.length; i++) {
                                    var s = e[i],
                                        o = Object(J.clean)(Array.isArray(s) ? s.join(' ') : s || '', !0)
                        ...
                        (t.prototype._calcNewPosition = function(t) {
                            ...
                            if (
                                ...
                                e = { clientX: Object(U.isRtl)() ? i.right : i.left, clientY: i.top + i.height + 3 }
                            } else {
                                var s = t
                ...
                at = (function(t) {
                    ...
                    return (
                        ...
                        (e.prototype._getMarkerTitle = function() {
                            return null !== this._symbolMarker ? (this._symbolMarker.isMarked() ? nt : ot) : ''
                        }),
                        (e.prototype._symbolActionHandler = function() {
                            null !== this._symbolMarker && (this._updateSymbolMarker(), ji('Change flag state'))
                        }),
                        ...
                        (e.prototype.destroy = function() {
                            t.prototype.destroy.call(this),
                                this._model
                                    .model()
                                    .properties()
                                    .paneProperties.legendProperties.showStudyTitles.unsubscribeAll(this),
                                this._model
                                    .model()
                                    .properties()
                                    .paneProperties.legendProperties.showStudyValues.unsubscribeAll(this),
                                this._onDestroy.fire()
                        }),
                            ...
                            if (!this._options.readOnlyMode) {
                                ...
                                ft &&
                                    ...
                                    (!Object(rt.isStudy)(this._source) ||
                                        new dt.a(this._source.metaInfo()).hasUserEditableOptions()) &&
                                    this._actions.push({
                                        iconMap: new Map([
                                            ['large', ct],
                                            ['small', ct]
            ...
            function Wt(t, e, i, s, o, n) {
                return (function(t, e, i, s, o) {
                    ...
                    if (void 0 !== l) {
                        var a = l.get(1)
                        void 0 !== a && a.length > 0 && (n.push.apply(n, a), n.push(new Et.Separator()))
                    }
                    ...
                    if (
                        ...
                        var u = l.get(0)
                        void 0 !== u && u.length > 0 && (n.push.apply(n, u), n.push(new Et.Separator()))
                    }
                    var d = s.get(1)
                    if (void 0 !== d) {
                        var h = d.get(1)
                        void 0 !== h && h.length > 0 && (n.push.apply(n, h), n.push(new Et.Separator()))
                    }
                    if (
                        (n.push(
                            new Et.Action({
                        ...
                        var c = d.get(0)
                        void 0 !== c && c.length > 0 && (n.push.apply(n, c), n.push(new Et.Separator()))
                    }
                    0
                    e.settings &&
                        (n.push(new Et.Separator()),
                ...
                Gt = (function() {
                    ...
                    return (
                        ...
                        (t.prototype._getTooltip = function(t) {
                            var e, i
                            return null !==
                                (i = null === (e = this._infoMaps.tooltipMap) || void 0 === e ? void 0 : e.get(t)) &&
                                void 0 !== i
                                ? i
                                : null
                        }),
                        ...
                        (t.prototype._getTitle = function(t) {
                            var e, i
                            return null !==
                                (i = null === (e = this._infoMaps.titleMap) || void 0 === e ? void 0 : e.get(t)) &&
                                void 0 !== i
                                ? i
                                : null
                        }),
                        (t.prototype._getTitleColor = function(t) {
                            var e, i
                            return null !==
                                (i = null === (e = this._infoMaps.titleColorMap) || void 0 === e ? void 0 : e.get(t)) &&
                                void 0 !== i
                                ? i
                                : null
                        }),
                                    ...
                                    return [
                                        ...
                                        null !==
                                            (o =
                                                null ===
                                                    (i =
                                                        null === (e = this._infoMaps.htmlMap) || void 0 === e
                                                            ? void 0
                                                            : e.get(t)) || void 0 === i
                                                    ? void 0
                                                    : i.map(Rt.b)) && void 0 !== o
                        ...
                        (t.prototype._getAction = function(t) {
                            var e, i
                            return null !==
                                (i = null === (e = this._infoMaps.actionMap) || void 0 === e ? void 0 : e.get(t)) &&
                                void 0 !== i
                                ? i
                                : null
                        }),
            ...
            var Yt = Jt,
                ...
                ce = Object(Rt.b)(window.t('{symbolName} data is delayed by {time} minutes.')),
                pe = Object(Rt.b)(
                    window.t('{listedExchange} real-time data is available for free to registered users.')
                ),
                _e = Object(Rt.b)(
                    window.t('To get real-time data for {description}, please buy the real-time data package.')
                ),
                be = Object(Rt.b)(
                    window.t(
                ...
                me = Object(Rt.b)(
                    window.t('Data is updated once per second, even if there are more updates on the market.')
                ),
                we = Object(Rt.b)(window.t('Paid plans feature faster data updates.')),
                ye = Object(Rt.b)(window.t('Real-time data for {symbolName} is provided by {exchange} exchange.')),
                fe = Object(Rt.b)(
                    window.t(
                ...
                Me =
                    ...
                    (function(t) {
                        function e(e, i, s) {
                            var o = t.call(this, { iconMap: oe, classNameMap: ne, titleColorMap: le, size: i }) || this
                            return (
                        ...
                        return (
                                        ...
                                        switch (s.label) {
                                            ...
                                            case 3:
                                                return (
                                                    (l = s.sent()),
                                                    se.logError(
                                                        "Can't get exchange description, reason: " + Object(qt.a)(l)
                                                    ),
                                                    [3, 4]
                                                )
                                            case 4:
                                                for (a = 0, r = t; a < r.length; a++)
                                                    (u = r[a]),
                                                        ...
                                                        'EOD' === u && (e[u] = [ge]),
                                                        'TickByTick' === u &&
                                                            (e[u].push(this._options.subscriptionFullInfo ? ve : me),
                                                            this._options.subscriptionFullInfo && e[u].push(we)),
                                                        null !== n &&
                                                            'BATSToRealtime' === u &&
                            ...
                            (e.prototype._getShortTexts = function() {
                                ...
                                for (var e = {}, i = 0, s = t; i < s.length; i++) {
                                    ...
                                    if (
                                        ...
                                        e[o] = '' !== n ? he.format({ exchange: n, originalExchange: de }) : de
                                    }
                                }
                            ...
                            (e.prototype._updateBlinkingMode = function() {
                                ...
                                if (null !== t) {
                                    for (
                                        var e = this._dataModeBlinkingStatuses.value(), i = 0, s = t;
                                        i < s.length;
                                        i++
                                    ) {
                                        var o = s[i]
                            ...
                            (e.prototype._turnOffBlinking = function() {
                                ...
                                if (null !== i)
                                    for (var s = 0, o = i; s < o.length; s++) {
                                        ...
                                        ;(t = n),
                                            (e = void 0),
                                            (e = Ut.getJSON('tv.alreadyBlinkedStatuses', Xt)).includes(t) ||
                                                (e.push(t),
                ...
                Qe = (function() {
                    function t(t, e, i, o) {
                        ...
                        h.a && l.push(Ft.touchMode),
                            (n = this.element.classList).add.apply(n, Object(s.f)(l, [Ft[t]])),
            ...
            var ki = (function() {
                    function t(t, e, i) {
                        ;(this.visibleWidgetsCount = new l.a(0)),
                            ...
                            (this._renderer = new Qe(this._size, this.visibleWidgetsCount, this._tooltips, {
                    ...
                    return (
                        ...
                        (t.prototype._isPrimaryWidgetShown = function() {
                            ...
                            return (
                                null !==
                                    (e = null === (t = this._isSymbolInvalid) || void 0 === t ? void 0 : t.value()) &&
                                void 0 !== e &&
                                e
                            )
                        }),
                        ...
                        (t.prototype._recreateWidgets = function() {
                            ...
                            if (this._options.sourceStatusesEnabled) {
                                if (
                                    ...
                                    if (
                                        ...
                                        this._symbolInvalidViewModel = new De(this._isSymbolInvalid, {
                                            tooltipMap: Xe,
                                            iconMap: Ge,
                                            classNameMap: Ue,
                                            titleMap: Ze,
                                ...
                                if (Object(rt.isStudy)(this._source) || Object(rt.isStudyStub)(this._source))
                                            ...
                                            (this._dataSourceHasErrorVisible = Object(Z.a)(
                                                function() {
                                                    return (
                                                        ...
                                                        Object(o.ensureNotNull)(e._dataSourceErrorStatusViewModel)
                                                            .visible()
                                                            .value()
                                                    )
                                                },
                            ...
                            if (this._options.marketStatusEnabled) {
                                ...
                                if (null === this._marketStatusViewModel) {
                                    this._marketStatusViewModel = new Ei(a, this._size, this._options.marketStatus)
                                    s = Object(Z.a)(
                                        function() {
                                            return (
                            ...
                            if (this._options.dataUpdateModeEnabled) {
                                ...
                                if (null === this._dataUpdatedModeViewModel) {
                                    this._dataUpdatedModeViewModel = new Me(u, this._size, this._options.dataUpdateMode)
                                    s = Object(Z.a)(
                                        function() {
                                            return (
                        ...
                        (t.prototype._addSubscriptionForSymbolInvalid = function() {
                            this._options.sourceStatusesEnabled &&
                                ...
                                this._isSymbolInvalid.subscribe(this._updateErrorWidgetIsShown.bind(this), {
                                    callWithLast: !0
                                }))
                        }),
                ...
                Ti = window.t("You're in Replay mode. You're in Replay mode. You're in Replay mode."),
                Wi =
                    (new Map([
                        [
                            !0,
                        ...
                        return (
                            ...
                            (e.prototype._isPrimaryWidgetShown = function() {
                                ...
                                return (
                                    ...
                                    (null !==
                                        (i = null === (e = this._isInReplay) || void 0 === e ? void 0 : e.value()) &&
                                        void 0 !== i &&
                                        i)
                                )
                            }),
            ...
            var Oi = {
                ...
                Pi = (d.enabled('hide_legend_by_default'), d.enabled('fundamental_widget')),
                ...
                Ni = (function() {
                    ...
                    return (
                        ...
                        (t.prototype.onShowLegendWidgetContextMenu = function(t, e) {
                            if (this._options.readOnlyMode || !zi) return Promise.resolve(null)
                            ji('Show legend context menu')
                            for (
                                var i = new Map(), s = 0, n = Array.from(this._customLegendWidgetsMap.keys());
                                s < n.length;
                                s++
                            ) {
                                for (
                                ...
                                if (0 === r)
                                    for (var u = i.length - 1; u >= 0; u--)
                                        l.push(
                                            ...
                                            a.push(new ki(i[u], this._model.model(), this._options.statusesWidgets))
                                else {
                                    var d = 0
                        ...
                        (t.prototype.addMargin = function(t) {
                            this._margin !== t &&
                                ...
                                (this._renderer.getElement().style.maxWidth =
                                    0 === this._margin ? '' : 'calc(100% - ' + (this._margin + Di) + 'px)'),
                        ...
                        (t.prototype._updateCustomWidgetModeBySize = function() {
                            if (null !== this._size)
                                for (
                                    ...
                                    for (var s = i[e], o = 0, n = Array.from(s.values()); o < n.length; o++)
                        ...
                        (t.prototype._getCustomWidgetsHeight = function() {
                            for (
                                var t = 0, e = 0, i = Array.from(this._customLegendWidgetsMap.values());
                                e < i.length;
                                e++
                            )
                                for (var s = i[e], o = 0, n = Array.from(s.values()); o < n.length; o++)
                        ...
                        (t.prototype._addCustomWidgetForLayerBlock = function(t) {
                            ...
                            if (void 0 !== e) {
                                for (
                                    ...
                                    for (
                                        var l = n[o], a = i.get(l) || [], r = e.get(l) || [], u = a.length;
                                        u < r.length;
                                        u++
                                    ) {
                                        ...
                                        0 === t &&
                                            0 === l &&
                                            d.setGlobalVisibility(this._hideNotMainSources.opposite()),
                                            a.push(d),
                                            this._renderer.addCustomWidget(d, { block: t, position: l }),
                                            (s = !0)
                                    }
                                    s && i.set(l, a)
                                }
