    ...
    ['ds-property-pages'],
    {
                    ...
                    return (
                        ...
                        (t.prototype._close = function() {
                            this._jqItems.addClass('js-hidden'),
                                ...
                                (this.opened = !1),
                                this._closeCb &&
                                    (this._closeCb.host.removeEventListener('mousedown', this._closeCb.cb, !1),
                                    (this._closeCb = null))
                        }),
                        t
                    )
        ...
        A3Hk: function(t, e, i) {
            ...
            function n() {
                var t = $('<select />')
                return (
                    $('<option value="' + o.a.LeftToRight + '">' + $.t('Left') + '</option>').appendTo(t),
                    $('<option value="' + o.a.RightToLeft + '">' + $.t('Right') + '</option>').appendTo(t),
                    t
                )
            }
        },
                ...
                inherit(T, p),
                    ...
                    (T.prototype.prepareControl = function(e, i, o) {
                        ...
                        if ('resolution' === e.type)
                                ...
                                ;(s = (function(t) {
                                    return function(e) {
                                        ...
                                        if (0 === e.indexOf('#')) {
                                            ...
                                            var s = a.sourceId()
                                            if (!s)
                                                return void m.logError('Can not get source id for ' + a.metaInfo().id)
                                            i = e.replace(/^[^$]+/, s)
                                        }
                                        ;(!~e.indexOf('$') && !~e.indexOf('#')) ||
                                            n._study.isStarted() ||
                            ...
                            (a = $('<input/>')), 'bool' === e.type ? a.attr('type', 'checkbox') : a.attr('type', 'text')
                        return (
                    ...
                    (T.prototype.prepareLayoutImpl = function(t, e) {
                        ...
                        for (var o = this._sortInputs(t.inputs), r = 0; r < o.length; r++) {
                            ...
                            if (
                                ...
                                if (p.options)
                                    this.bindControl(
                                        new y(k, this._property.inputs[C], null, !0, this.model(), m, P, x)
                                    )
                                    ...
                                    ;(0 === p.min || p.min) && L.push(l(p.min)),
                                        ...
                                        this.bindControl(new b(k, this._property.inputs[C], L, !1, this.model(), m)),
                                        k.addClass('ticker'),
                                    ...
                                    ;(0 === p.min || p.min) && L.push(l(p.min)),
                                        (0 === p.max || p.max) && L.push(d(p.max))
                                    var S = new b(k, this._property.inputs[C], L, !1, this.model(), m)
                                    S.addFormatter(i),
                                        this.bindControl(S),
                                        k.addClass('ticker'),
                                        isFinite(p.step) && p.step > 0 && k.attr('data-step', p.step)
                                    ...
                                    this.bindControl(
                                        new y(k, this._property.inputs[C], n, !0, this.model(), 'Change Interval')
                                    )
                        ...
                        if (this._property.offset) {
                            ...
                            ;(k = this.addOffsetEditorRow(e, F)),
                                (L = [h(this._property.offset.val)]).push(l(this._property.offset.min)),
                                L.push(d(this._property.offset.max)),
                                this.bindControl(new b(k, this._property.offset.val, L, !1, this.model(), 'Undo ' + F))
                        }
                ...
                (l.prototype.prepareLayout = function() {
                    ...
                    if (r.enabled('seconds_resolution')) {
                        ...
                        $('<td>')
                            ...
                            .appendTo(e),
                            this.bindControl(
                                new a(o, t.seconds, !0, this.model(), 'Change Line Tool Visibility On Seconds')
                            ),
                            this.bindControl(
                                new s(
                                    l,
                    ...
                    $('<td>')
                        ...
                        .appendTo(e),
                        this.bindControl(
                            new a(h, t.minutes, !0, this.model(), 'Change Line Tool Visibility On Minutes')
                        ),
                        this.bindControl(
                            new s(
                                l,
        ...
        a0Rg: function(t, e, i) {
            ...
            function n() {
                ...
                return (
                    ...
                    $(
                        '<option value="' + o.LineStudyPlotStyle.StepLine + '">' + $.t('Step Line') + '</option>'
                    ).appendTo(t),
                    $(
                        '<option value="' + o.LineStudyPlotStyle.Histogram + '">' + $.t('Histogram') + '</option>'
                    ).appendTo(t),
                    $(
                        '<option value="' +
                    ...
                    $('<option value="' + o.LineStudyPlotStyle.Columns + '">' + $.t('Columns') + '</option>').appendTo(
                        t
                    ),
                    $('<option value="' + o.LineStudyPlotStyle.Circles + '">' + $.t('Circles') + '</option>').appendTo(
                        t
                    ),
                    t
                )
        ...
        o6hY: function(t, e, i) {
            ...
            inherit(x, n),
                ...
                (x.prototype._prepareOrdersSwitches = function() {
                    ...
                    return (
                        this.bindControl(
                            new d(o, c.strategy.orders.visible, !0, this.model(), 'Trades on chart visibility')
                        ),
                        this.bindControl(
                            new d(s, c.strategy.orders.showLabels, !0, this.model(), 'Signal labels visibility')
                        ),
                        this.bindControl(
                            new h(s, c.strategy.orders.visible, !0, this.model(), 'Signal labels visibility', !0)
                        ),
                        this.bindControl(new d(l, c.strategy.orders.showQty, !0, this.model(), 'Quantity visibility')),
                        this.bindControl(
                            new h(l, c.strategy.orders.visible, !0, this.model(), 'Quantity visibility', !0)
                        ),
                        t
                    )
                }),
                (x.prototype._prepareLayoutForPlot = function(t, e) {
                    ...
                    if (a) {
                        ...
                        P.on('change', this._trackPriceLine.bind(this)).appendTo(k),
                            ...
                            this.bindControl(
                                new u(_, o.linewidth, !0, this.model(), r, this._study.metaInfo().isTVScript)
                            ),
                            this.bindControl(new l(g, o.plottype, parseInt, !0, this.model(), r)),
                ...
                (x.prototype._prepareLayoutForShapesPlot = function(t, e) {
                    ...
                    if ((_.appendTo(m), this.bindControl(new l(_, o.location, null, !0, this.model(), r)), a))
                        ...
                        var g = v(w)
                        this.bindControl(new c(g, o.color, !0, this.model(), r, o.transparency))
                    }
                }),
                ...
                (x.prototype._prepareLayoutForPalette = function(t, e, i, o, n, a) {
                    ...
                    for (var b in i.colors) {
                        ...
                        var w = v(_)
                        if (
                            (this.bindControl(new c(w, f.color, !0, this.model(), n, p.transparency)),
                            ...
                            k.appendTo(g),
                                this.bindControl(
                                    new u(k, f.width, !0, this.model(), n, this._study.metaInfo().isTVScript)
                                )
                            var P = $('<td>')
                            if ((P.appendTo(C), 0 === y)) {
                                var x = T()
                                x.appendTo(P), this.bindControl(new l(x, p.plottype, parseInt, !0, this.model(), n))
                                var L = $('<td>')
                                L.appendTo(C)
                ...
                (x.prototype._findPlotPalette = function(t, e) {
                    ...
                    if (this._study.isBarColorerPlot(i) || this._study.isBgColorerPlot(i))
                        ...
                        for (var r = 0; r < s.length; r++)
                            if (
                                s[r].target === o &&
                                (this._study.isSelfColorerPlot(r) || this._study.isOHLCColorerPlot(r))
                            ) {
                ...
                (x.prototype._prepareStudyPropertiesLayout = function() {
                    ...
                    if (
                        ...
                        $('<td>')
                            ...
                            .appendTo(i),
                        this.bindControl(
                            new l(e, this._study.properties().precision, null, !0, this.model(), 'Change Precision')
                        ),
                        ...
                        ;(i = $('<tr>')).appendTo(t),
                            ...
                            $('<td>')
                                ...
                                .appendTo(i),
                            this.bindControl(
                                new l(e, this._study.properties().minTick, null, !0, this.model(), 'Change MinTick')
                            )
                    }
                ...
                (x._createRow_hlines = function(t, e) {
                    ...
                    if (
                        ...
                        $('<td>')
                            ...
                            .appendTo(i),
                            this.bindControl(
                                new l(y, e.textPos, parseInt, !0, this.model(), 'Change ' + o + ' text position')
                            )
                        ...
                        $('<td colspan="2">')
                            ...
                            .appendTo(i),
                            this.bindControl(
                                new l(v, e.fontSize, parseInt, !0, this.model(), 'Change ' + o + ' font size')
                            )
                    }
                }),
                        ...
                        if (isNumber(parseInt(T, 10))) {
                            ...
                            ;(o[T] = e.titles[T].value()),
                                ...
                                $('<td>')
                                    ...
                                    .appendTo(p),
                                this.bindControl(
                                    new c(n[T], e.colors[T], !0, this.model(), 'Change ' + o[T] + ' color')
                                )
                        }
                }),
                ...
                (x._createRow_textmarks = function(t, e) {
                    ...
                    $('<td>')
                        ...
                        this.bindControl(new c(n, e.color, !0, this.model(), 'Change ' + o + ' color', e.transparency)),
                        this.bindControl(
                            new c(a, e.fontColor, !0, this.model(), 'Change ' + o + ' text color', e.transparency)
                        ),
                        this.bindControl(
                            new l(r, e.fontSize, parseInt, !0, this.model(), 'Change ' + o + ' font size')
                        ),
                ...
                (x._createRow_shapemarks = function(t, e) {
                    ...
                    s.attr('type', 'text'),
                        ...
                        this.bindControl(new d(o, e.visible, !0, this.model(), 'Change ' + n + ' visibility')),
                        this.bindControl(
                            new c(a, e.color, !0, this.model(), 'Change ' + n + ' back color', e.transparency)
                        ),
