                                            ...
                                            ? void ('function' == typeof c.destroy
                                                  ? (n(c, 'destroy', l),
                                                    $(this)
                                                        ...
                                                        .removeData(t))
                                                  : i.logError(
                                                        '[Block Plugin] ' + t + ' does not support destroy command'
                                                    ))
                                            : void console.warn(
            ...
            ;(function() {
                ...
                ;(g.each = g.forEach = function(t, e, n) {
                    ...
                    (g.contains = g.includes = g.include = function(t, e, n, r) {
                        return (
                            C(t) || (t = g.values(t)), ('number' != typeof n || r) && (n = 0), g.indexOf(t, e, n) >= 0
                        )
                    }),
                ...
                ;(g.flatten = function(t, e) {
                    ...
                    (g.unzip = function(t) {
                        for (var e = (t && g.max(t, k).length) || 0, n = Array(e), r = 0; r < e; r++)
                            n[r] = g.pluck(t, r)
                        return n
                    }),
                        ...
                        return (
                            i(t, [
                                ...
                                },
                                {
                                    ...
                                    value: function(t, e) {
                                        void 0 !== e &&
                                            (e ? t.setAttribute('disabled', 'disabled') : t.removeAttr('disabled'))
                                    }
                                },
                                {
                                    key: 'render',
