    ...
    ['simple-dialog'],
    {
            ...
            var a = n('q1tI'),
                r = function(e, t) {
                    var n = void 0 === t ? {} : t,
                        ...
                        c = void 0 === l ? null : l
                    try {
                        return new window.CustomEvent(e, { bubbles: r, cancelable: i, detail: c })
                    } catch (s) {
                    ...
                    return (
                        ...
                        (t.prototype.render = function() {
                            ...
                            return (
                                ...
                                o.createPortal(r.createElement(s.Provider, { value: this }, this.props.children), e)
                            )
                        }),
                        ...
                        (t.prototype._manager = function() {
                            return null === this.context ? Object(l.getRootOverlapManager)() : this.context
                        }),
                        (t.contextType = c.b),
                        t
                    )
        ...
        EcUf: function(e, t, n) {
            ...
            var a = n('mrSG'),
                ...
                b = n('0sCh'),
                g = n('+EG+'),
                y = o.a.createContext({ isSmallTablet: !1, dialogCloseHandler: function() {} }),
                w = n('G4Ee')
            function E(e) {
                var t = e.disabled,
                    n = e.name,
                        ...
                        o.a.createElement(
                            ...
                            o.a.createElement(
                                ...
                                o.a.createElement(
                                    ...
                                    o.a.createElement('div', { className: l(C.title, r && C.small) }, t),
                                    (function(t) {
                                        if ('html' in e)
                                    ...
                                    i &&
                                        ...
                                        o.a.createElement(
                                            ...
                                            i.map(function(e, t) {
                                                return o.a.createElement(
                                                    E,
                                                    Object(a.a)({}, e, { key: e.name, reference: 0 === t ? S : void 0 })
                                                )
                                            })
                                        )
                                ),
            ...
            function k(e) {
                ...
                return (
                    ...
                    o.a.createElement(
                        ...
                        null,
                        (function() {
                            if ('content' in e) return o.a.createElement('div', { className: T.label }, e.content)
                            if ('html' in e)
            ...
            var L = function(e) {
                    ...
                    return o.a.createElement(
                        ...
                        Object(a.a)({}, m, {
                            ...
                            onClose: r,
                            actions: [
                                { name: 'yes', title: l || Object(i.t)('Yes'), intent: c || 'success', handler: s },
                                {
                                    name: 'no',
                        ...
                        actions: [
                            {
                                ...
                                handler: function(e) {
                                    var t = e.dialogClose,
                                        n = e.innerManager
                                    return h({ newValue: g, focusInput: x, dialogClose: t, innerManager: n })
                                }
                            },
                            {
                                name: 'cancel',
                ...
                B = function(e, t, n) {
                    ...
                    if (D.isOpened(r)) return Object(v.ensureDefined)(D.getDialogPayload(r)).closeHandler
        ...
        QpNh: function(e, t, n) {
            'use strict'
            function a(e) {
                for (var t = {}, n = 0, a = Object.entries(e).filter(r); n < a.length; n++) {
                    var o = a[n],
                        i = o[0],
                        l = o[1]
                    t[i] = l
        ...
        R5JZ: function(e, t, n) {
            ...
            function a(e, t, n, a, r) {
                function o(r) {
                    if (!(e > r.timeStamp)) {
                        var o = r.target
                        void 0 !== n && null !== t && null !== o && o.ownerDocument === a && (t.contains(o) || n(r))
                    }
                }
                return (
        ...
        mwqF: function(e, t, n) {
            ...
            function c(e) {
                const {
                    ...
                    b = i(l, { intent: n, size: c, appearance: u, disabled: s, useFullWidth: d, tabIndex: h, icon: p })
                return r.createElement(
                    'button',
                    Object.assign({ className: o(b, t), disabled: s, ref: m, tabIndex: h }, v),
                        ...
                        function(e) {
                            t && (t.current = e),
                                c.CheckMobile.iOS() &&
                                    ...
                                    (u.current = e),
                                    null !== u.current &&
                                        Object(i.disableBodyScroll)(u.current, { allowTouchMove: s(u) }))
                        },
                        [t]
                    )
