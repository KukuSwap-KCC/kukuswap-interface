                ...
                var d = {
                    ...
                    _addMessageCloseButton: function(t) {
                        ...
                        t.append(o),
                            $(o).on('click', function() {
                                t.animate(
                                    { marginTop: d.NOTIFICATION_ANIMATION_START_OFFSET, opacity: 0 },
                                    'fast',
                                    function() {
                                        t.hide()
                                    }
                    ...
                    createDialog: function(t, o) {
                        if (d.isOpen(t))
                            return (c = d.get(t)).find('._tv-dialog-content').html(''), c.data('new', !1), c
                ...
                a = (function() {
                    ...
                    return (
                        ...
                        (t.prototype.unregisterWindow = function(t) {
                            ...
                            void 0 !== o &&
                                (null !== o.parentElement && o.parentElement.removeChild(o), this._windows.delete(t))
                        }),
