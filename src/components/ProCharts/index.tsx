...
export class TVChartContainer extends React.PureComponent<Partial<ChartContainerProps>, ChartContainerState> {
    ...
    componentDidUpdate(prevProps: ChartContainerProps) {
        ...
        if (
            this.props.baseCurrencyId !== prevProps.baseCurrencyId ||
            this.props.otherCurrencyId !== prevProps.otherCurrencyId
        ) {
            this.refreshWidget()
        }
    }
    ...
    public render(): JSX.Element {
        return <div id={this.props.container} className={'TVChartContainer mb-5  border-yellow'} />
    }
}
